...
module OpenapiClient
  class SupplierPerformance < ApiModelBase
    ...
    # Percentage
    attr_accessor :on_time_delivery_rate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SupplierPerformance` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SupplierPerformance`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_spend')
        self.total_spend = attributes[:'total_spend']
      end

      if attributes.key?(:'on_time_delivery_rate')
        self.on_time_delivery_rate = attributes[:'on_time_delivery_rate']
      end
    ...
    def list_invalid_properties
      ...
      if !@quality_rating.nil? && @quality_rating > 5
        invalid_properties.push('invalid value for "quality_rating", must be smaller than or equal to 5.')
      end

      if !@quality_rating.nil? && @quality_rating < 1
        invalid_properties.push('invalid value for "quality_rating", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@quality_rating.nil? && @quality_rating > 5
      return false if !@quality_rating.nil? && @quality_rating < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] quality_rating Value to be assigned
    def quality_rating=(quality_rating)
      if quality_rating.nil?
        fail ArgumentError, 'quality_rating cannot be nil'
      end

      if quality_rating > 5
        fail ArgumentError, 'invalid value for "quality_rating", must be smaller than or equal to 5.'
      end

      if quality_rating < 1
        fail ArgumentError, 'invalid value for "quality_rating", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_spend == o.total_spend &&
          on_time_delivery_rate == o.on_time_delivery_rate &&
    ...
    def hash
      [supplier_id, start_date, end_date, total_orders, total_spend, on_time_delivery_rate, quality_rating, average_lead_time].hash
    end
