...
module OpenapiClient
  class UpdateAvailabilityCalendarRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'property_id' => :'String',
        :'unit_type_id' => :'String',
        :'updates' => :'Array<UpdateAvailabilityCalendarRequestUpdatesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UpdateAvailabilityCalendarRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UpdateAvailabilityCalendarRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [property_id, unit_type_id, updates].hash
    end
