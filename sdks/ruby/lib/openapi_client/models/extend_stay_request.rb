...
module OpenapiClient
  class ExtendStayRequest < ApiModelBase
    attr_accessor :new_check_out_date
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ExtendStayRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ExtendStayRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'new_check_out_date')
        self.new_check_out_date = attributes[:'new_check_out_date']
      else
        self.new_check_out_date = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @new_check_out_date.nil?
        invalid_properties.push('invalid value for "new_check_out_date", new_check_out_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @new_check_out_date.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] new_check_out_date Value to be assigned
    def new_check_out_date=(new_check_out_date)
      if new_check_out_date.nil?
        fail ArgumentError, 'new_check_out_date cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          new_check_out_date == o.new_check_out_date
    end
