...
module OpenapiClient
  class PricingModel < ApiModelBase
    # Base rates per unit type
    attr_accessor :base_rates

    attr_accessor :occupancy_pricing

    attr_accessor :seasonal_adjustments

    attr_accessor :length_of_stay_discounts
    ...
    def self.openapi_types
      {
        :'base_rates' => :'Array<PricingModelAllOfBaseRates>',
        :'occupancy_pricing' => :'PricingModelAllOfOccupancyPricing',
        :'seasonal_adjustments' => :'Array<PricingModelAllOfSeasonalAdjustments>',
        :'length_of_stay_discounts' => :'Array<PricingModelAllOfLengthOfStayDiscounts>',
        :'taxes' => :'Array<PricingModelAllOfTaxes>',
        :'fees' => :'Array<PricingModelAllOfFees>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PricingModel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PricingModel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'base_rates')
        if (value = attributes[:'base_rates']).is_a?(Array)
          self.base_rates = value
        end
      else
        self.base_rates = nil
      end
      ...
      if attributes.key?(:'occupancy_pricing')
        self.occupancy_pricing = attributes[:'occupancy_pricing']
      end

      if attributes.key?(:'seasonal_adjustments')
        if (value = attributes[:'seasonal_adjustments']).is_a?(Array)
          self.seasonal_adjustments = value
        end
      end

      if attributes.key?(:'length_of_stay_discounts')
        if (value = attributes[:'length_of_stay_discounts']).is_a?(Array)
          self.length_of_stay_discounts = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @base_rates.nil?
        invalid_properties.push('invalid value for "base_rates", base_rates cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @base_rates.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] base_rates Value to be assigned
    def base_rates=(base_rates)
      if base_rates.nil?
        fail ArgumentError, 'base_rates cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          base_rates == o.base_rates &&
          occupancy_pricing == o.occupancy_pricing &&
          seasonal_adjustments == o.seasonal_adjustments &&
          length_of_stay_discounts == o.length_of_stay_discounts &&
          taxes == o.taxes &&
          fees == o.fees
    end
    ...
    def hash
      [base_rates, occupancy_pricing, seasonal_adjustments, length_of_stay_discounts, taxes, fees].hash
    end
