...
module OpenapiClient
  class InventoryUnitAllOfLinks < ApiModelBase
    attr_accessor :_self
    ...
    attr_accessor :current_reservation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InventoryUnitAllOfLinks` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InventoryUnitAllOfLinks`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'current_reservation')
        self.current_reservation = attributes[:'current_reservation']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          current_reservation == o.current_reservation
    end
    ...
    def hash
      [_self, property, availability, current_reservation].hash
    end
