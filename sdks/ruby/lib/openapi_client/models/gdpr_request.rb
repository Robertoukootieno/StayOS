...
module OpenapiClient
  class GDPRRequest < ApiModelBase
    ...
    attr_accessor :data_package_url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GDPRRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GDPRRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_package_url')
        self.data_package_url = attributes[:'data_package_url']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["DATA_EXPORT", "DATA_DELETION", "DATA_CORRECTION"])
      return false unless type_validator.valid?(@type)
      status_validator = EnumAttributeValidator.new('String', ["SUBMITTED", "PROCESSING", "COMPLETED", "REJECTED"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["DATA_EXPORT", "DATA_DELETION", "DATA_CORRECTION"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["SUBMITTED", "PROCESSING", "COMPLETED", "REJECTED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_package_url == o.data_package_url &&
          notes == o.notes
    end
    ...
    def hash
      [request_id, guest_id, type, status, requested_at, completed_at, data_package_url, notes].hash
    end
