...
module OpenapiClient
  class ChannelMapping < ApiModelBase
    attr_accessor :channel_id

    attr_accessor :property_id

    attr_accessor :unit_type_mappings

    attr_accessor :rate_strategy_mappings
    ...
    def self.openapi_types
      {
        :'channel_id' => :'String',
        :'property_id' => :'String',
        :'unit_type_mappings' => :'Array<ChannelMappingAllOfUnitTypeMappings>',
        :'rate_strategy_mappings' => :'Array<ChannelMappingAllOfRateStrategyMappings>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ChannelMapping` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ChannelMapping`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unit_type_mappings')
        if (value = attributes[:'unit_type_mappings']).is_a?(Array)
          self.unit_type_mappings = value
        end
      end

      if attributes.key?(:'rate_strategy_mappings')
        if (value = attributes[:'rate_strategy_mappings']).is_a?(Array)
          self.rate_strategy_mappings = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unit_type_mappings == o.unit_type_mappings &&
          rate_strategy_mappings == o.rate_strategy_mappings
    end
    ...
    def hash
      [channel_id, property_id, unit_type_mappings, rate_strategy_mappings].hash
    end
