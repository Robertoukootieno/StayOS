...
module OpenapiClient
  class AvailabilitySlot < ApiModelBase
    attr_accessor :date
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AvailabilitySlot`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["AVAILABLE", "RESERVED", "BLOCKED", "SOLD_OUT"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["AVAILABLE", "RESERVED", "BLOCKED", "SOLD_OUT"])
    ...
    def hash
      [date, status, restrictions, allocations, rate, notes].hash
    end
