...
module OpenapiClient
  class GetReservationQuoteRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'check_in_date' => :'Date',
        :'check_out_date' => :'Date',
        :'guest_count' => :'GetReservationQuoteRequestGuestCount',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetReservationQuoteRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetReservationQuoteRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [property_id, unit_type_id, check_in_date, check_out_date, guest_count, rate_strategy_id, promo_code].hash
    end
