...
module OpenapiClient
  class PropertyPoliciesAllOfChildPolicy < ApiModelBase
    attr_accessor :children_allowed

    # Maximum age for free child stay
    attr_accessor :free_child_age
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PropertyPoliciesAllOfChildPolicy` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PropertyPoliciesAllOfChildPolicy`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'children_allowed')
        self.children_allowed = attributes[:'children_allowed']
      else
        self.children_allowed = true
      end

      if attributes.key?(:'free_child_age')
        self.free_child_age = attributes[:'free_child_age']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          children_allowed == o.children_allowed &&
          free_child_age == o.free_child_age
    end
    ...
    def hash
      [children_allowed, free_child_age].hash
    end
