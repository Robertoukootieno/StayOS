...
module OpenapiClient
  # HATEOAS links
  class PropertyAllOfLinks < ApiModelBase
    attr_accessor :_self

    attr_accessor :inventory_units

    attr_accessor :rate_strategies
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PropertyAllOfLinks` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PropertyAllOfLinks`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inventory_units')
        self.inventory_units = attributes[:'inventory_units']
      end

      if attributes.key?(:'rate_strategies')
        self.rate_strategies = attributes[:'rate_strategies']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          _self == o._self &&
          inventory_units == o.inventory_units &&
          rate_strategies == o.rate_strategies &&
    ...
    def hash
      [_self, inventory_units, rate_strategies, reservations].hash
    end
