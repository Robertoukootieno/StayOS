...
module OpenapiClient
  class ChannelMappingAllOfUnitTypeMappings < ApiModelBase
    attr_accessor :internal_unit_type_id

    attr_accessor :channel_room_type_id

    attr_accessor :channel_room_type_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ChannelMappingAllOfUnitTypeMappings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ChannelMappingAllOfUnitTypeMappings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'internal_unit_type_id')
        self.internal_unit_type_id = attributes[:'internal_unit_type_id']
      end

      if attributes.key?(:'channel_room_type_id')
        self.channel_room_type_id = attributes[:'channel_room_type_id']
      end

      if attributes.key?(:'channel_room_type_name')
        self.channel_room_type_name = attributes[:'channel_room_type_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          internal_unit_type_id == o.internal_unit_type_id &&
          channel_room_type_id == o.channel_room_type_id &&
          channel_room_type_name == o.channel_room_type_name
    end
    ...
    def hash
      [internal_unit_type_id, channel_room_type_id, channel_room_type_name].hash
    end
