...
module OpenapiClient
  ...
  class PricingModelAllOfOccupancyPricing < ApiModelBase
    attr_accessor :enabled

    attr_accessor :base_occupancy

    attr_accessor :additional_guest_charge
    ...
    def self.openapi_types
      {
        ...
        :'additional_guest_charge' => :'Model0'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PricingModelAllOfOccupancyPricing` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PricingModelAllOfOccupancyPricing`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'additional_guest_charge')
        self.additional_guest_charge = attributes[:'additional_guest_charge']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          additional_guest_charge == o.additional_guest_charge
    end
    ...
    def hash
      [enabled, base_occupancy, additional_guest_charge].hash
    end
