...
module OpenapiClient
  class ChannelDistribution < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'channel_name' => :'String',
        :'is_enabled' => :'Boolean',
        :'markup' => :'ChannelDistributionAllOfMarkup',
        :'commission' => :'ChannelDistributionAllOfCommission'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ChannelDistribution` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ChannelDistribution`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [channel_id, channel_name, is_enabled, markup, commission].hash
    end
