...
module OpenapiClient
  class MergeGuestsRequest < ApiModelBase
    attr_accessor :primary_guest_id

    attr_accessor :secondary_guest_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MergeGuestsRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MergeGuestsRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'primary_guest_id')
        self.primary_guest_id = attributes[:'primary_guest_id']
      else
        self.primary_guest_id = nil
      end

      if attributes.key?(:'secondary_guest_id')
        self.secondary_guest_id = attributes[:'secondary_guest_id']
      else
        self.secondary_guest_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @primary_guest_id.nil?
        invalid_properties.push('invalid value for "primary_guest_id", primary_guest_id cannot be nil.')
      end

      if @secondary_guest_id.nil?
        invalid_properties.push('invalid value for "secondary_guest_id", secondary_guest_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @primary_guest_id.nil?
      return false if @secondary_guest_id.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] primary_guest_id Value to be assigned
    def primary_guest_id=(primary_guest_id)
      if primary_guest_id.nil?
        fail ArgumentError, 'primary_guest_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] secondary_guest_id Value to be assigned
    def secondary_guest_id=(secondary_guest_id)
      if secondary_guest_id.nil?
        fail ArgumentError, 'secondary_guest_id cannot be nil'
      end

      @secondary_guest_id = secondary_guest_id
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          primary_guest_id == o.primary_guest_id &&
          secondary_guest_id == o.secondary_guest_id
    end
    ...
    def hash
      [primary_guest_id, secondary_guest_id].hash
    end
