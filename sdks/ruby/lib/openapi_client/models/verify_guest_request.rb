...
module OpenapiClient
  class VerifyGuestRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::VerifyGuestRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::VerifyGuestRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'verification_data')
        self.verification_data = attributes[:'verification_data']
      end
    end
    ...
    def valid?
      ...
      verification_type_validator = EnumAttributeValidator.new('String', ["ID_DOCUMENT", "EMAIL", "PHONE", "BIOMETRIC"])
    ...
    def verification_type=(verification_type)
      validator = EnumAttributeValidator.new('String', ["ID_DOCUMENT", "EMAIL", "PHONE", "BIOMETRIC"])
    ...
    def hash
      [verification_type, verification_data].hash
    end
