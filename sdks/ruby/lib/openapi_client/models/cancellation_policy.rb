...
module OpenapiClient
  class CancellationPolicy < ApiModelBase
    attr_accessor :refundability

    # Hours before check-in for free cancellation
    attr_accessor :free_cancellation_hours

    attr_accessor :penalty_schedule
    ...
    def self.openapi_types
      {
        ...
        :'penalty_schedule' => :'Array<CancellationPolicyAllOfPenaltySchedule>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CancellationPolicy` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CancellationPolicy`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'refundability')
        self.refundability = attributes[:'refundability']
      else
        self.refundability = nil
      end

      if attributes.key?(:'free_cancellation_hours')
        self.free_cancellation_hours = attributes[:'free_cancellation_hours']
      end

      if attributes.key?(:'penalty_schedule')
        if (value = attributes[:'penalty_schedule']).is_a?(Array)
          self.penalty_schedule = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @refundability.nil?
        invalid_properties.push('invalid value for "refundability", refundability cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @refundability.nil?
      refundability_validator = EnumAttributeValidator.new('String', ["FULLY_REFUNDABLE", "PARTIALLY_REFUNDABLE", "NON_REFUNDABLE"])
      return false unless refundability_validator.valid?(@refundability)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] refundability Object to be assigned
    def refundability=(refundability)
      validator = EnumAttributeValidator.new('String', ["FULLY_REFUNDABLE", "PARTIALLY_REFUNDABLE", "NON_REFUNDABLE"])
      unless validator.valid?(refundability)
        fail ArgumentError, "invalid value for \"refundability\", must be one of #{validator.allowable_values}."
      end
      @refundability = refundability
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          refundability == o.refundability &&
          free_cancellation_hours == o.free_cancellation_hours &&
          penalty_schedule == o.penalty_schedule
    end
    ...
    def hash
      [refundability, free_cancellation_hours, penalty_schedule].hash
    end
