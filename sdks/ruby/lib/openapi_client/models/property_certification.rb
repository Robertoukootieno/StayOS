...
module OpenapiClient
  class PropertyCertification < ApiModelBase
    attr_accessor :certification_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PropertyCertification` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PropertyCertification`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'certification_id')
        self.certification_id = attributes[:'certification_id']
      else
    ...
    def list_invalid_properties
      ...
      if @certification_id.nil?
        invalid_properties.push('invalid value for "certification_id", certification_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @certification_id.nil?
      return false if @property_id.nil?
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["BUSINESS_LICENSE", "HEALTH_PERMIT", "FIRE_SAFETY", "LIQUOR_LICENSE", "TOURISM_CERTIFICATION", "ENVIRONMENTAL", "ACCESSIBILITY", "OTHER"])
      return false unless type_validator.valid?(@type)
      return false if @issued_date.nil?
      return false if @expiry_date.nil?
      status_validator = EnumAttributeValidator.new('String', ["ACTIVE", "EXPIRED", "SUSPENDED", "REVOKED"])
      return false unless status_validator.valid?(@status)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] certification_id Value to be assigned
    def certification_id=(certification_id)
      if certification_id.nil?
        fail ArgumentError, 'certification_id cannot be nil'
      end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["BUSINESS_LICENSE", "HEALTH_PERMIT", "FIRE_SAFETY", "LIQUOR_LICENSE", "TOURISM_CERTIFICATION", "ENVIRONMENTAL", "ACCESSIBILITY", "OTHER"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["ACTIVE", "EXPIRED", "SUSPENDED", "REVOKED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          certification_id == o.certification_id &&
    ...
    def hash
      [certification_id, property_id, type, name, certificate_number, issuing_authority, issued_date, expiry_date, status, document_url, notes, metadata].hash
    end
