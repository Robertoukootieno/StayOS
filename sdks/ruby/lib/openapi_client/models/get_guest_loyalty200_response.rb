...
module OpenapiClient
  class GetGuestLoyalty200Response < ApiModelBase
    attr_accessor :tier

    attr_accessor :points

    attr_accessor :lifetime_points

    attr_accessor :next_tier_points
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetGuestLoyalty200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetGuestLoyalty200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lifetime_points')
        self.lifetime_points = attributes[:'lifetime_points']
      end

      if attributes.key?(:'next_tier_points')
        self.next_tier_points = attributes[:'next_tier_points']
      end
    end
    ...
    def valid?
      ...
      tier_validator = EnumAttributeValidator.new('String', ["NONE", "SILVER", "GOLD", "PLATINUM"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tier == o.tier &&
          points == o.points &&
          lifetime_points == o.lifetime_points &&
          next_tier_points == o.next_tier_points
    end
    ...
    def hash
      [tier, points, lifetime_points, next_tier_points].hash
    end
