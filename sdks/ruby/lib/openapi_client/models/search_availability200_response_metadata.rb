...
module OpenapiClient
  class SearchAvailability200ResponseMetadata < ApiModelBase
    attr_accessor :total_results

    # Search duration in milliseconds
    attr_accessor :search_duration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SearchAvailability200ResponseMetadata` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SearchAvailability200ResponseMetadata`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'search_duration')
        self.search_duration = attributes[:'search_duration']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          search_duration == o.search_duration &&
    ...
    def hash
      [total_results, search_duration, cache_hit].hash
    end
