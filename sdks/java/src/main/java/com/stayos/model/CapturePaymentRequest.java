...
public class CapturePaymentRequest {
  ...
  public CapturePaymentRequest amount(@javax.annotation.Nullable Money amount) {
    this.amount = amount;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CapturePaymentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapturePaymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CapturePaymentRequest is not found in the empty JSON string", CapturePaymentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CapturePaymentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CapturePaymentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CapturePaymentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CapturePaymentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CapturePaymentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CapturePaymentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CapturePaymentRequest>() {
           @Override
           public void write(JsonWriter out, CapturePaymentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CapturePaymentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CapturePaymentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CapturePaymentRequest
   * @throws IOException if the JSON string is invalid with respect to CapturePaymentRequest
   */
  public static CapturePaymentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CapturePaymentRequest.class);
  }

  /**
   * Convert an instance of CapturePaymentRequest to an JSON string
   *
   * @return JSON string
   */
