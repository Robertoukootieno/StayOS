...
public class SyncChannelRequest {
  ...
  public SyncChannelRequest() {
  }

  public SyncChannelRequest syncType(@javax.annotation.Nullable SyncTypeEnum syncType) {
  ...
  public void setSyncType(@javax.annotation.Nullable SyncTypeEnum syncType) {
    this.syncType = syncType;
  }
  ...
  public boolean equals(Object o) {
    ...
    SyncChannelRequest syncChannelRequest = (SyncChannelRequest) o;
    return Objects.equals(this.syncType, syncChannelRequest.syncType);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("syncType"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SyncChannelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SyncChannelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SyncChannelRequest is not found in the empty JSON string", SyncChannelRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SyncChannelRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SyncChannelRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("syncType") != null && !jsonObj.get("syncType").isJsonNull()) && !jsonObj.get("syncType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `syncType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("syncType").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncChannelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncChannelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncChannelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncChannelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncChannelRequest>() {
           @Override
           public void write(JsonWriter out, SyncChannelRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SyncChannelRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SyncChannelRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SyncChannelRequest
   * @throws IOException if the JSON string is invalid with respect to SyncChannelRequest
   */
  public static SyncChannelRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncChannelRequest.class);
  }

  /**
   * Convert an instance of SyncChannelRequest to an JSON string
   *
   * @return JSON string
   */
