...
public class Model0 {
  ...
  public Model0 amount(@javax.annotation.Nonnull String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Model0 currency(@javax.annotation.Nonnull String currency) {
  ...
  public boolean equals(Object o) {
    ...
    Model0 _0 = (Model0) o;
    return Objects.equals(this.amount, _0.amount) &&
        Objects.equals(this.currency, _0.currency);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Model0.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Model0 is not found in the empty JSON string", Model0.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Model0.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Model0` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
