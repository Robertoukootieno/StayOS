...
public class RefundPaymentRequest {
  ...
  public RefundPaymentRequest amount(@javax.annotation.Nonnull Money amount) {
    this.amount = amount;
    return this;
  }
  ...
  public RefundPaymentRequest reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, refundPaymentRequest.amount) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefundPaymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RefundPaymentRequest is not found in the empty JSON string", RefundPaymentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefundPaymentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RefundPaymentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
