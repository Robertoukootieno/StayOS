...
public class FolioAllOfFees {
  ...
  public FolioAllOfFees() {
  }

  public FolioAllOfFees amount(@javax.annotation.Nonnull String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public FolioAllOfFees currency(@javax.annotation.Nonnull String currency) {
  ...
  public boolean equals(Object o) {
    ...
    FolioAllOfFees folioAllOfFees = (FolioAllOfFees) o;
    return Objects.equals(this.amount, folioAllOfFees.amount) &&
        Objects.equals(this.currency, folioAllOfFees.currency);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FolioAllOfFees
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FolioAllOfFees.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FolioAllOfFees is not found in the empty JSON string", FolioAllOfFees.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FolioAllOfFees.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FolioAllOfFees` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FolioAllOfFees.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FolioAllOfFees.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FolioAllOfFees' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FolioAllOfFees> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FolioAllOfFees.class));

       return (TypeAdapter<T>) new TypeAdapter<FolioAllOfFees>() {
           @Override
           public void write(JsonWriter out, FolioAllOfFees value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FolioAllOfFees read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FolioAllOfFees given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FolioAllOfFees
   * @throws IOException if the JSON string is invalid with respect to FolioAllOfFees
   */
  public static FolioAllOfFees fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FolioAllOfFees.class);
  }

  /**
   * Convert an instance of FolioAllOfFees to an JSON string
   *
   * @return JSON string
   */
