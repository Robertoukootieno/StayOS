...
public class Address {
  ...
  public Address street2(@javax.annotation.Nullable String street2) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("street", "street2", "city", "state", "postalCode", "country"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("street2") != null && !jsonObj.get("street2").isJsonNull()) && !jsonObj.get("street2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `street2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("street2").toString()));
      }
