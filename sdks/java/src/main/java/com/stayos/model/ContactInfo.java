...
public class ContactInfo {
  ...
  public static final String SERIALIZED_NAME_ALTERNATE_PHONE = "alternatePhone";
  @SerializedName(SERIALIZED_NAME_ALTERNATE_PHONE)
  @javax.annotation.Nullable
  ...
  @javax.annotation.Nullable
  private PreferredContactMethodEnum preferredContactMethod = PreferredContactMethodEnum.EMAIL;

  public ContactInfo() {
  }

  public ContactInfo email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public ContactInfo phone(@javax.annotation.Nullable String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public ContactInfo alternatePhone(@javax.annotation.Nullable String alternatePhone) {
  ...
  public ContactInfo preferredContactMethod(@javax.annotation.Nullable PreferredContactMethodEnum preferredContactMethod) {
  ...
  public void setPreferredContactMethod(@javax.annotation.Nullable PreferredContactMethodEnum preferredContactMethod) {
    this.preferredContactMethod = preferredContactMethod;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, contactInfo.email) &&
        ...
        Objects.equals(this.alternatePhone, contactInfo.alternatePhone) &&
        Objects.equals(this.preferredContactMethod, contactInfo.preferredContactMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, phone, alternatePhone, preferredContactMethod);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "phone", "alternatePhone", "preferredContactMethod"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("alternatePhone") != null && !jsonObj.get("alternatePhone").isJsonNull()) && !jsonObj.get("alternatePhone").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `alternatePhone` to be a primitive type in the JSON string but got `%s`", jsonObj.get("alternatePhone").toString()));
      }
      if ((jsonObj.get("preferredContactMethod") != null && !jsonObj.get("preferredContactMethod").isJsonNull()) && !jsonObj.get("preferredContactMethod").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `preferredContactMethod` to be a primitive type in the JSON string but got `%s`", jsonObj.get("preferredContactMethod").toString()));
      }
