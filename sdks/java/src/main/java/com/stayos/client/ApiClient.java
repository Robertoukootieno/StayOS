...
import com.stayos.client.auth.Authentication;
import com.stayos.client.auth.HttpBasicAuth;
import com.stayos.client.auth.HttpBearerAuth;
import com.stayos.client.auth.ApiKeyAuth;
import com.stayos.client.auth.OAuth;
import com.stayos.client.auth.RetryingOAuth;
import com.stayos.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.stayos.com/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.stayos.com/v1",
      "Production",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api-staging.stayos.com/v1",
      "Staging",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api-sandbox.stayos.com/v1",
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://auth.stayos.com/oauth/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.stayos.com/v1)
     ...
     * @return a {@link com.stayos.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.stayos.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.stayos.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.stayos.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.stayos.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.stayos.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.stayos.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.stayos.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.stayos.client.ApiException If fail to serialize the request body object into a string
     */
