...
class SearchAvailability200ResponseMetadata(BaseModel):
    """
    SearchAvailability200ResponseMetadata
    """ # noqa: E501
    total_results: Optional[StrictInt] = Field(default=None, alias="totalResults")
    search_duration: Optional[StrictInt] = Field(default=None, description="Search duration in milliseconds", alias="searchDuration")
    cache_hit: Optional[StrictBool] = Field(default=None, alias="cacheHit")
    __properties: ClassVar[List[str]] = ["totalResults", "searchDuration", "cacheHit"]
