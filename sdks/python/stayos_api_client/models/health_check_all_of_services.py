...
class HealthCheckAllOfServices(BaseModel):
    """
    HealthCheckAllOfServices
    """ # noqa: E501
    database: Optional[StrictStr] = None
    cache: Optional[StrictStr] = None
    message_queue: Optional[StrictStr] = Field(default=None, alias="messageQueue")
    __properties: ClassVar[List[str]] = ["database", "cache", "messageQueue"]
    ...
    @field_validator('message_queue')
    def message_queue_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cache": obj.get("cache"),
            "messageQueue": obj.get("messageQueue")
        })
        return _obj
