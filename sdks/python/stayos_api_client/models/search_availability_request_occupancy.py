...
class SearchAvailabilityRequestOccupancy(BaseModel):
    """
    SearchAvailabilityRequestOccupancy
    """ # noqa: E501
    adults: Annotated[int, Field(strict=True, ge=1)]
    children: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    child_ages: Optional[List[StrictInt]] = Field(default=None, alias="childAges")
    __properties: ClassVar[List[str]] = ["adults", "children", "childAges"]
