...
class MergeGuestsRequest(BaseModel):
    """
    MergeGuestsRequest
    """ # noqa: E501
    primary_guest_id: UUID = Field(alias="primaryGuestId")
    secondary_guest_id: UUID = Field(alias="secondaryGuestId")
    __properties: ClassVar[List[str]] = ["primaryGuestId", "secondaryGuestId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "primaryGuestId": obj.get("primaryGuestId"),
            "secondaryGuestId": obj.get("secondaryGuestId")
        })
        return _obj
