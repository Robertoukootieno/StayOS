...
class CancelReservationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reason", "notes"]
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['GUEST_REQUEST', 'NO_SHOW', 'PROPERTY_ISSUE', 'OTHER']):
            raise ValueError("must be one of enum values ('GUEST_REQUEST', 'NO_SHOW', 'PROPERTY_ISSUE', 'OTHER')")
        return value
