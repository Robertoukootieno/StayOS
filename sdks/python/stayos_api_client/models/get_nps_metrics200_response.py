...
class GetNPSMetrics200Response(BaseModel):
    """
    GetNPSMetrics200Response
    """ # noqa: E501
    nps_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="npsScore")
    promoters: Optional[StrictInt] = None
    passives: Optional[StrictInt] = None
    detractors: Optional[StrictInt] = None
    total_responses: Optional[StrictInt] = Field(default=None, alias="totalResponses")
    trend: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["npsScore", "promoters", "passives", "detractors", "totalResponses", "trend"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "promoters": obj.get("promoters"),
            "passives": obj.get("passives"),
            "detractors": obj.get("detractors"),
