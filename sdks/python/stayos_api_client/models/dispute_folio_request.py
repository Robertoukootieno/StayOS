...
class DisputeFolioRequest(BaseModel):
    """
    DisputeFolioRequest
    """ # noqa: E501
    reason: StrictStr
    amount: Optional[Money] = None
    line_item_ids: Optional[List[UUID]] = Field(default=None, alias="lineItemIds")
    __properties: ClassVar[List[str]] = ["reason", "amount", "lineItemIds"]
