...
class SurveyAllOfRatings(BaseModel):
    """
    SurveyAllOfRatings
    """ # noqa: E501
    cleanliness: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None
    comfort: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None
    staff: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None
    amenities: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None
    value_for_money: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = Field(default=None, alias="valueForMoney")
    __properties: ClassVar[List[str]] = ["cleanliness", "comfort", "staff", "amenities", "valueForMoney"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cleanliness": obj.get("cleanliness"),
            "comfort": obj.get("comfort"),
            "staff": obj.get("staff"),
            "amenities": obj.get("amenities"),
            "valueForMoney": obj.get("valueForMoney")
        })
        return _obj
