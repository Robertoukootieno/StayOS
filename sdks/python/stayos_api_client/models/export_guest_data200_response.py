...
class ExportGuestData200Response(BaseModel):
    """
    ExportGuestData200Response
    """ # noqa: E501
    export_id: Optional[UUID] = Field(default=None, alias="exportId")
    download_url: Optional[StrictStr] = Field(default=None, alias="downloadUrl")
    __properties: ClassVar[List[str]] = ["exportId", "downloadUrl"]
