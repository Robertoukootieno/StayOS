...
class PricingModelAllOfOccupancyPricing(BaseModel):
    """
    Per-person pricing adjustments
    """ # noqa: E501
    enabled: Optional[StrictBool] = False
    base_occupancy: Optional[StrictInt] = Field(default=None, alias="baseOccupancy")
    additional_guest_charge: Optional[Model0] = Field(default=None, alias="additionalGuestCharge")
    __properties: ClassVar[List[str]] = ["enabled", "baseOccupancy", "additionalGuestCharge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of additional_guest_charge
        if self.additional_guest_charge:
            _dict['additionalGuestCharge'] = self.additional_guest_charge.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "baseOccupancy": obj.get("baseOccupancy"),
            "additionalGuestCharge": Model0.from_dict(obj["additionalGuestCharge"]) if obj.get("additionalGuestCharge") is not None else None
        })
        return _obj
