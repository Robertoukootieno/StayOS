...
class GetAuditLogs200Response(BaseModel):
    ...
    """ # noqa: E501
    data: List[GetAuditLogs200ResponseAllOfDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetAuditLogs200ResponseAllOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
