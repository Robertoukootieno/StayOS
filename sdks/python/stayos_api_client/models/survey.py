...
class Survey(BaseModel):
    ...
    Survey
    """ # noqa: E501
    survey_id: UUID = Field(alias="surveyId")
    stay_id: UUID = Field(alias="stayId")
    guest_id: UUID = Field(alias="guestId")
    overall_rating: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = Field(default=None, alias="overallRating")
    nps_score: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = Field(default=None, description="Net Promoter Score (0-10)", alias="npsScore")
    ratings: Optional[SurveyAllOfRatings] = None
    comments: Optional[StrictStr] = None
    would_recommend: Optional[StrictBool] = Field(default=None, alias="wouldRecommend")
    completed_at: Optional[datetime] = Field(default=None, alias="completedAt")
    __properties: ClassVar[List[str]] = ["surveyId", "stayId", "guestId", "overallRating", "npsScore", "ratings", "comments", "wouldRecommend", "completedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "npsScore": obj.get("npsScore"),
            "ratings": SurveyAllOfRatings.from_dict(obj["ratings"]) if obj.get("ratings") is not None else None,
            "comments": obj.get("comments"),
            "wouldRecommend": obj.get("wouldRecommend"),
