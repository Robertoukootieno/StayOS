...
class CreateInventoryBlockRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "unitTypeId", "startDate", "endDate", "quantity", "reason", "notes"]

    @field_validator('reason')
    def reason_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['MAINTENANCE', 'GROUP_BLOCK', 'OWNER_USE', 'OTHER']):
            raise ValueError("must be one of enum values ('MAINTENANCE', 'GROUP_BLOCK', 'OWNER_USE', 'OTHER')")
        return value
