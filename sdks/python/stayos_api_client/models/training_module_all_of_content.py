...
class TrainingModuleAllOfContent(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['VIDEO', 'DOCUMENT', 'INTERACTIVE', 'IN_PERSON']):
            raise ValueError("must be one of enum values ('VIDEO', 'DOCUMENT', 'INTERACTIVE', 'IN_PERSON')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrainingModuleAllOfContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrainingModuleAllOfContent from a dict"""
        if obj is None:
            return None
