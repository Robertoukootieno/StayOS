...
class GetRevenueReconciliation200Response(BaseModel):
    """
    GetRevenueReconciliation200Response
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    total_revenue: Optional[Money] = Field(default=None, alias="totalRevenue")
    total_payments: Optional[Money] = Field(default=None, alias="totalPayments")
    variance: Optional[Money] = None
    __properties: ClassVar[List[str]] = ["date", "totalRevenue", "totalPayments", "variance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of total_payments
        if self.total_payments:
            _dict['totalPayments'] = self.total_payments.to_dict()
        # override the default output from pydantic by calling `to_dict()` of variance
        if self.variance:
            _dict['variance'] = self.variance.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "totalRevenue": Money.from_dict(obj["totalRevenue"]) if obj.get("totalRevenue") is not None else None,
            "totalPayments": Money.from_dict(obj["totalPayments"]) if obj.get("totalPayments") is not None else None,
            "variance": Money.from_dict(obj["variance"]) if obj.get("variance") is not None else None
        })
        return _obj
