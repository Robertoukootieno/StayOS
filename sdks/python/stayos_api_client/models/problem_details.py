...
class ProblemDetails(BaseModel):
    ...
    ProblemDetails
    """ # noqa: E501
    type: StrictStr = Field(description="URI reference identifying the problem type")
    title: StrictStr = Field(description="Short, human-readable summary")
    status: StrictInt = Field(description="HTTP status code")
    detail: Optional[StrictStr] = Field(default=None, description="Human-readable explanation")
    instance: Optional[StrictStr] = Field(default=None, description="URI reference identifying the specific occurrence")
    trace_id: Optional[UUID] = Field(default=None, description="Unique identifier for tracing", alias="traceId")
    errors: Optional[List[ProblemDetailsAllOfErrors]] = Field(default=None, description="Detailed validation errors")
    __properties: ClassVar[List[str]] = ["type", "title", "status", "detail", "instance", "traceId", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [ProblemDetailsAllOfErrors.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
