...
class GetMaintenanceHistory200ResponseHistoryInner(BaseModel):
    """
    GetMaintenanceHistory200ResponseHistoryInner
    """ # noqa: E501
    timestamp: Optional[datetime] = None
    action: Optional[StrictStr] = None
    performed_by: Optional[UUID] = Field(default=None, alias="performedBy")
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["timestamp", "action", "performedBy", "notes"]
