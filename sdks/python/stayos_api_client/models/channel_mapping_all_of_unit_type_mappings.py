...
class ChannelMappingAllOfUnitTypeMappings(BaseModel):
    """
    ChannelMappingAllOfUnitTypeMappings
    """ # noqa: E501
    internal_unit_type_id: Optional[UUID] = Field(default=None, alias="internalUnitTypeId")
    channel_room_type_id: Optional[StrictStr] = Field(default=None, alias="channelRoomTypeId")
    channel_room_type_name: Optional[StrictStr] = Field(default=None, alias="channelRoomTypeName")
    __properties: ClassVar[List[str]] = ["internalUnitTypeId", "channelRoomTypeId", "channelRoomTypeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "internalUnitTypeId": obj.get("internalUnitTypeId"),
            "channelRoomTypeId": obj.get("channelRoomTypeId"),
            "channelRoomTypeName": obj.get("channelRoomTypeName")
        })
        return _obj
