...
class CheckoutStayRequest(BaseModel):
    """
    CheckoutStayRequest
    """ # noqa: E501
    checkout_time: Optional[datetime] = Field(default=None, alias="checkoutTime")
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["checkoutTime", "notes"]
