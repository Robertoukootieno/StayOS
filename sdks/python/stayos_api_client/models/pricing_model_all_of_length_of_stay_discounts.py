...
class PricingModelAllOfLengthOfStayDiscounts(BaseModel):
    """
    PricingModelAllOfLengthOfStayDiscounts
    """ # noqa: E501
    minimum_nights: Optional[StrictInt] = Field(default=None, alias="minimumNights")
    ...
    __properties: ClassVar[List[str]] = ["minimumNights", "discountType", "discountValue", "description"]
    ...
    def discount_type_validate_enum(cls, value):
        ...
        if value not in set(['PERCENTAGE', 'FIXED_AMOUNT', 'FREE_NIGHTS']):
            raise ValueError("must be one of enum values ('PERCENTAGE', 'FIXED_AMOUNT', 'FREE_NIGHTS')")
        return value
