...
class SyncChannelRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["syncType"]
    ...
    def sync_type_validate_enum(cls, value):
        ...
        if value not in set(['FULL', 'INCREMENTAL', 'RATES_ONLY', 'AVAILABILITY_ONLY']):
            raise ValueError("must be one of enum values ('FULL', 'INCREMENTAL', 'RATES_ONLY', 'AVAILABILITY_ONLY')")
        return value
