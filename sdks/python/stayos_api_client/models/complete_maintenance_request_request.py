...
class CompleteMaintenanceRequestRequest(BaseModel):
    """
    CompleteMaintenanceRequestRequest
    """ # noqa: E501
    notes: Optional[StrictStr] = None
    parts_used: Optional[List[CompleteMaintenanceRequestRequestPartsUsedInner]] = Field(default=None, alias="partsUsed")
    __properties: ClassVar[List[str]] = ["notes", "partsUsed"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in parts_used (list)
        _items = []
        if self.parts_used:
            for _item_parts_used in self.parts_used:
                if _item_parts_used:
                    _items.append(_item_parts_used.to_dict())
            _dict['partsUsed'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notes": obj.get("notes"),
            "partsUsed": [CompleteMaintenanceRequestRequestPartsUsedInner.from_dict(_item) for _item in obj["partsUsed"]] if obj.get("partsUsed") is not None else None
        })
        return _obj
