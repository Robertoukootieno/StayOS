...
class UnitTypeAllOfPhotos(BaseModel):
    """
    UnitTypeAllOfPhotos
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["url", "caption", "isPrimary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnitTypeAllOfPhotos from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnitTypeAllOfPhotos from a dict"""
        if obj is None:
            return None
