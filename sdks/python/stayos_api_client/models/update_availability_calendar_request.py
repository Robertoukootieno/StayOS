...
class UpdateAvailabilityCalendarRequest(BaseModel):
    """
    ...
    updates: Optional[List[UpdateAvailabilityCalendarRequestUpdatesInner]] = None
    __properties: ClassVar[List[str]] = ["propertyId", "unitTypeId", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [UpdateAvailabilityCalendarRequestUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
