...
class ListFBInventory200Response(BaseModel):
    """
    ListFBInventory200Response
    """ # noqa: E501
    data: List[FBInventoryItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FBInventoryItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
