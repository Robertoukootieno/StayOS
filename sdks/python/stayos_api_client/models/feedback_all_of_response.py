...
class FeedbackAllOfResponse(BaseModel):
    """
    FeedbackAllOfResponse
    """ # noqa: E501
    responded_by: Optional[UUID] = Field(default=None, alias="respondedBy")
    responded_at: Optional[datetime] = Field(default=None, alias="respondedAt")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["respondedBy", "respondedAt", "message"]
