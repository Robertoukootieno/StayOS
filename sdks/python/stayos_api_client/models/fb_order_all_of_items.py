...
class FBOrderAllOfItems(BaseModel):
    """
    FBOrderAllOfItems
    """ # noqa: E501
    menu_item_id: Optional[UUID] = Field(default=None, alias="menuItemId")
    ...
    __properties: ClassVar[List[str]] = ["menuItemId", "name", "quantity", "unitPrice", "specialInstructions", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['PENDING', 'PREPARING', 'READY', 'SERVED']):
            raise ValueError("must be one of enum values ('PENDING', 'PREPARING', 'READY', 'SERVED')")
        return value
