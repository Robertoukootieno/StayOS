...
class IncidentAllOfPersonsInvolved(BaseModel):
    """
    IncidentAllOfPersonsInvolved
    """ # noqa: E501
    name: Optional[StrictStr] = None
    role: Optional[StrictStr] = None
    contact_info: Optional[StrictStr] = Field(default=None, alias="contactInfo")
    __properties: ClassVar[List[str]] = ["name", "role", "contactInfo"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['GUEST', 'STAFF', 'VISITOR', 'CONTRACTOR']):
            raise ValueError("must be one of enum values ('GUEST', 'STAFF', 'VISITOR', 'CONTRACTOR')")
        return value
