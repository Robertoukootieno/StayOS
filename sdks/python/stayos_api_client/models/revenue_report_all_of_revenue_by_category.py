...
class RevenueReportAllOfRevenueByCategory(BaseModel):
    """
    RevenueReportAllOfRevenueByCategory
    """ # noqa: E501
    room: Optional[Model0] = None
    food_beverage: Optional[Model0] = Field(default=None, alias="foodBeverage")
    other: Optional[Model0] = None
    __properties: ClassVar[List[str]] = ["room", "foodBeverage", "other"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RevenueReportAllOfRevenueByCategory from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of food_beverage
        if self.food_beverage:
            _dict['foodBeverage'] = self.food_beverage.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RevenueReportAllOfRevenueByCategory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "room": Model0.from_dict(obj["room"]) if obj.get("room") is not None else None,
            "foodBeverage": Model0.from_dict(obj["foodBeverage"]) if obj.get("foodBeverage") is not None else None,
            "other": Model0.from_dict(obj["other"]) if obj.get("other") is not None else None
        })
        return _obj
