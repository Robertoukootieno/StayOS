...
class BatchProcessPayments200Response(BaseModel):
    """
    BatchProcessPayments200Response
    """ # noqa: E501
    successful: Optional[List[Payment]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "successful": [Payment.from_dict(_item) for _item in obj["successful"]] if obj.get("successful") is not None else None,
