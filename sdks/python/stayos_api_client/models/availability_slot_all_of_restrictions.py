...
class AvailabilitySlotAllOfRestrictions(BaseModel):
    """
    AvailabilitySlotAllOfRestrictions
    """ # noqa: E501
    closed_to_arrival: Optional[StrictBool] = Field(default=False, alias="closedToArrival")
    closed_to_departure: Optional[StrictBool] = Field(default=False, alias="closedToDeparture")
    minimum_stay: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="minimumStay")
    maximum_stay: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="maximumStay")
    __properties: ClassVar[List[str]] = ["closedToArrival", "closedToDeparture", "minimumStay", "maximumStay"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "closedToArrival": obj.get("closedToArrival") if obj.get("closedToArrival") is not None else False,
            "closedToDeparture": obj.get("closedToDeparture") if obj.get("closedToDeparture") is not None else False,
            "minimumStay": obj.get("minimumStay"),
            "maximumStay": obj.get("maximumStay")
        })
        return _obj
