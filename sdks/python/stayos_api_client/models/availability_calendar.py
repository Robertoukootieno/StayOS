...
class AvailabilityCalendar(BaseModel):
    ...
    """ # noqa: E501
    inventory_unit_id: UUID = Field(alias="inventoryUnitId")
    date_range: AvailabilityCalendarAllOfDateRange = Field(alias="dateRange")
    slots: Optional[List[Model0]] = None
    __properties: ClassVar[List[str]] = ["inventoryUnitId", "dateRange", "slots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dateRange": AvailabilityCalendarAllOfDateRange.from_dict(obj["dateRange"]) if obj.get("dateRange") is not None else None,
            "slots": [Model0.from_dict(_item) for _item in obj["slots"]] if obj.get("slots") is not None else None
        })
        return _obj
