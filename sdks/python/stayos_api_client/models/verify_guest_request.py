...
class VerifyGuestRequest(BaseModel):
    """
    VerifyGuestRequest
    """ # noqa: E501
    verification_type: Optional[StrictStr] = Field(default=None, alias="verificationType")
    verification_data: Optional[Dict[str, Any]] = Field(default=None, alias="verificationData")
    __properties: ClassVar[List[str]] = ["verificationType", "verificationData"]
    ...
    def verification_type_validate_enum(cls, value):
        ...
        if value not in set(['ID_DOCUMENT', 'EMAIL', 'PHONE', 'BIOMETRIC']):
            raise ValueError("must be one of enum values ('ID_DOCUMENT', 'EMAIL', 'PHONE', 'BIOMETRIC')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verificationData": obj.get("verificationData")
        })
        return _obj
