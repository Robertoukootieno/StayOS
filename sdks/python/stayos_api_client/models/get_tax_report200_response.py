...
class GetTaxReport200Response(BaseModel):
    """
    GetTaxReport200Response
    """ # noqa: E501
    total_tax: Optional[Money] = Field(default=None, alias="totalTax")
    breakdown: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["totalTax", "breakdown"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of total_tax
        if self.total_tax:
            _dict['totalTax'] = self.total_tax.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalTax": Money.from_dict(obj["totalTax"]) if obj.get("totalTax") is not None else None,
