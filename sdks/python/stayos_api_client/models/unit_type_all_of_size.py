...
class UnitTypeAllOfSize(BaseModel):
    """
    UnitTypeAllOfSize
    """ # noqa: E501
    ...
    def unit_validate_enum(cls, value):
        ...
        if value not in set(['SQM', 'SQFT']):
            raise ValueError("must be one of enum values ('SQM', 'SQFT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnitTypeAllOfSize from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnitTypeAllOfSize from a dict"""
        if obj is None:
            return None
