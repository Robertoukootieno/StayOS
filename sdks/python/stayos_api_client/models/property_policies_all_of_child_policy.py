...
class PropertyPoliciesAllOfChildPolicy(BaseModel):
    """
    PropertyPoliciesAllOfChildPolicy
    """ # noqa: E501
    children_allowed: Optional[StrictBool] = Field(default=True, alias="childrenAllowed")
    free_child_age: Optional[StrictInt] = Field(default=None, description="Maximum age for free child stay", alias="freeChildAge")
    __properties: ClassVar[List[str]] = ["childrenAllowed", "freeChildAge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "childrenAllowed": obj.get("childrenAllowed") if obj.get("childrenAllowed") is not None else True,
            "freeChildAge": obj.get("freeChildAge")
        })
        return _obj
