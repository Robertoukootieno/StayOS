...
class PurchaseOrderAllOfItems(BaseModel):
    """
    ...
    total_price: Optional[Model0] = Field(default=None, alias="totalPrice")
    received_quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="receivedQuantity")
    __properties: ClassVar[List[str]] = ["itemId", "description", "quantity", "unit", "unitPrice", "totalPrice", "receivedQuantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalPrice": Model0.from_dict(obj["totalPrice"]) if obj.get("totalPrice") is not None else None,
            "receivedQuantity": obj.get("receivedQuantity") if obj.get("receivedQuantity") is not None else 0
        })
        return _obj
