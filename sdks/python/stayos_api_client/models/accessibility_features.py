...
class AccessibilityFeatures(BaseModel):
    ...
    """ # noqa: E501
    wheelchair_accessible: Optional[StrictBool] = Field(default=False, alias="wheelchairAccessible")
    hearing_accessible: Optional[StrictBool] = Field(default=False, alias="hearingAccessible")
    visual_accessible: Optional[StrictBool] = Field(default=False, alias="visualAccessible")
    features: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["wheelchairAccessible", "hearingAccessible", "visualAccessible", "features"]
    ...
    def features_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['ROLL_IN_SHOWER', 'GRAB_BARS', 'LOWERED_SINK', 'VISUAL_ALARM', 'HEARING_LOOP', 'BRAILLE_SIGNAGE', 'ACCESSIBLE_PARKING']):
                raise ValueError("each list item must be one of ('ROLL_IN_SHOWER', 'GRAB_BARS', 'LOWERED_SINK', 'VISUAL_ALARM', 'HEARING_LOOP', 'BRAILLE_SIGNAGE', 'ACCESSIBLE_PARKING')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wheelchairAccessible": obj.get("wheelchairAccessible") if obj.get("wheelchairAccessible") is not None else False,
            "hearingAccessible": obj.get("hearingAccessible") if obj.get("hearingAccessible") is not None else False,
            "visualAccessible": obj.get("visualAccessible") if obj.get("visualAccessible") is not None else False,
