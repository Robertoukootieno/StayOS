...
class BatchProcessPaymentsRequest(BaseModel):
    """
    BatchProcessPaymentsRequest
    """ # noqa: E501
    payments: List[BatchProcessPaymentsRequestPaymentsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payments": [BatchProcessPaymentsRequestPaymentsInner.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None
        })
        return _obj
