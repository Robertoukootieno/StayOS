...
class InitiateServiceRecoveryRequest(BaseModel):
    """
    InitiateServiceRecoveryRequest
    """ # noqa: E501
    actions: Optional[List[StrictStr]] = None
    compensation: Optional[Money] = None
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["actions", "compensation", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compensation": Money.from_dict(obj["compensation"]) if obj.get("compensation") is not None else None,
            "notes": obj.get("notes")
        })
        return _obj
