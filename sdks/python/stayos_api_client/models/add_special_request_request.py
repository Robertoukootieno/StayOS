...
class AddSpecialRequestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["request", "category"]
    ...
    def category_validate_enum(cls, value):
        ...
        if value not in set(['ROOM_PREFERENCE', 'DIETARY', 'ACCESSIBILITY', 'CELEBRATION', 'OTHER']):
            raise ValueError("must be one of enum values ('ROOM_PREFERENCE', 'DIETARY', 'ACCESSIBILITY', 'CELEBRATION', 'OTHER')")
        return value
