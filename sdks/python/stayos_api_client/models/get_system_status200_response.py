...
class GetSystemStatus200Response(BaseModel):
    """
    GetSystemStatus200Response
    """ # noqa: E501
    status: Optional[StrictStr] = None
    components: Optional[Dict[str, GetSystemStatus200ResponseComponentsValue]] = None
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['OPERATIONAL', 'DEGRADED', 'OUTAGE']):
            raise ValueError("must be one of enum values ('OPERATIONAL', 'DEGRADED', 'OUTAGE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": dict(
                (_k, GetSystemStatus200ResponseComponentsValue.from_dict(_v))
