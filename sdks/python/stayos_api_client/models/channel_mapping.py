...
class ChannelMapping(BaseModel):
    ...
    unit_type_mappings: Optional[List[ChannelMappingAllOfUnitTypeMappings]] = Field(default=None, alias="unitTypeMappings")
    rate_strategy_mappings: Optional[List[ChannelMappingAllOfRateStrategyMappings]] = Field(default=None, alias="rateStrategyMappings")
    __properties: ClassVar[List[str]] = ["channelId", "propertyId", "unitTypeMappings", "rateStrategyMappings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in unit_type_mappings (list)
        _items = []
        if self.unit_type_mappings:
            for _item_unit_type_mappings in self.unit_type_mappings:
                if _item_unit_type_mappings:
                    _items.append(_item_unit_type_mappings.to_dict())
            _dict['unitTypeMappings'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in rate_strategy_mappings (list)
        _items = []
        if self.rate_strategy_mappings:
            for _item_rate_strategy_mappings in self.rate_strategy_mappings:
                if _item_rate_strategy_mappings:
                    _items.append(_item_rate_strategy_mappings.to_dict())
            _dict['rateStrategyMappings'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitTypeMappings": [ChannelMappingAllOfUnitTypeMappings.from_dict(_item) for _item in obj["unitTypeMappings"]] if obj.get("unitTypeMappings") is not None else None,
            "rateStrategyMappings": [ChannelMappingAllOfRateStrategyMappings.from_dict(_item) for _item in obj["rateStrategyMappings"]] if obj.get("rateStrategyMappings") is not None else None
        })
        return _obj
