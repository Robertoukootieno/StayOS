...
class PricingModelAllOfTaxes(BaseModel):
    """
    ...
    is_included: Optional[StrictBool] = Field(default=False, description="Whether tax is included in displayed rate", alias="isIncluded")
    __properties: ClassVar[List[str]] = ["name", "type", "rate", "isIncluded"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PERCENTAGE', 'PER_NIGHT', 'PER_PERSON_PER_NIGHT']):
            raise ValueError("must be one of enum values ('PERCENTAGE', 'PER_NIGHT', 'PER_PERSON_PER_NIGHT')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "rate": obj.get("rate"),
            "isIncluded": obj.get("isIncluded") if obj.get("isIncluded") is not None else False
        })
        return _obj
