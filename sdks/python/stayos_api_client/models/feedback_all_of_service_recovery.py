...
class FeedbackAllOfServiceRecovery(BaseModel):
    """
    Service recovery actions taken
    """ # noqa: E501
    actions: Optional[List[StrictStr]] = None
    compensation: Optional[Model0] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compensation": Model0.from_dict(obj["compensation"]) if obj.get("compensation") is not None else None,
            "notes": obj.get("notes")
        })
        return _obj
