...
class ListProperties200Response(BaseModel):
    """
    ListProperties200Response
    """ # noqa: E501
    data: List[ModelProperty]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ModelProperty.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
