...
class SearchAvailabilityRequestFilters(BaseModel):
    """
    SearchAvailabilityRequestFilters
    """ # noqa: E501
    min_price: Optional[Money] = Field(default=None, alias="minPrice")
    max_price: Optional[Money] = Field(default=None, alias="maxPrice")
    amenities: Optional[List[StrictStr]] = None
    accessibility: Optional[StrictBool] = Field(default=None, description="Require wheelchair accessible units")
    __properties: ClassVar[List[str]] = ["minPrice", "maxPrice", "amenities", "accessibility"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minPrice": Money.from_dict(obj["minPrice"]) if obj.get("minPrice") is not None else None,
            "maxPrice": Money.from_dict(obj["maxPrice"]) if obj.get("maxPrice") is not None else None,
