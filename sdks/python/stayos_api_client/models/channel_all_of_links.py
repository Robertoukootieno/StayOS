...
class ChannelAllOfLinks(BaseModel):
    """
    ChannelAllOfLinks
    """ # noqa: E501
    var_self: Optional[StrictStr] = Field(default=None, alias="self")
    mappings: Optional[StrictStr] = None
    performance: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["self", "mappings", "performance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelAllOfLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelAllOfLinks from a dict"""
        if obj is None:
            return None
