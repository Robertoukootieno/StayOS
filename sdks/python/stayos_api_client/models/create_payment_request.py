...
class CreatePaymentRequest(BaseModel):
    ...
    amount: Money
    method: StrictStr
    __properties: ClassVar[List[str]] = ["folioId", "amount", "method"]

    @field_validator('method')
    def method_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'OTHER']):
            raise ValueError("must be one of enum values ('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'OTHER')")
        return value
