...
class GetGuestLoyalty200Response(BaseModel):
    """
    GetGuestLoyalty200Response
    """ # noqa: E501
    tier: Optional[StrictStr] = None
    points: Optional[StrictInt] = None
    lifetime_points: Optional[StrictInt] = Field(default=None, alias="lifetimePoints")
    next_tier_points: Optional[StrictInt] = Field(default=None, alias="nextTierPoints")
    __properties: ClassVar[List[str]] = ["tier", "points", "lifetimePoints", "nextTierPoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lifetimePoints": obj.get("lifetimePoints"),
            "nextTierPoints": obj.get("nextTierPoints")
        })
        return _obj
