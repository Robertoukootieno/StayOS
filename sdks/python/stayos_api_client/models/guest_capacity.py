...
class GuestCapacity(BaseModel):
    ...
    GuestCapacity
    """ # noqa: E501
    max_adults: Annotated[int, Field(strict=True, ge=1)] = Field(alias="maxAdults")
    max_children: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="maxChildren")
    max_occupancy: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Total maximum occupancy", alias="maxOccupancy")
    extra_bed_available: Optional[StrictBool] = Field(default=False, alias="extraBedAvailable")
    extra_bed_charge: Optional[Model0] = Field(default=None, alias="extraBedCharge")
    __properties: ClassVar[List[str]] = ["maxAdults", "maxChildren", "maxOccupancy", "extraBedAvailable", "extraBedCharge"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of extra_bed_charge
        if self.extra_bed_charge:
            _dict['extraBedCharge'] = self.extra_bed_charge.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxAdults": obj.get("maxAdults"),
            "maxChildren": obj.get("maxChildren"),
            "maxOccupancy": obj.get("maxOccupancy"),
            "extraBedAvailable": obj.get("extraBedAvailable") if obj.get("extraBedAvailable") is not None else False,
            "extraBedCharge": Model0.from_dict(obj["extraBedCharge"]) if obj.get("extraBedCharge") is not None else None
        })
        return _obj
