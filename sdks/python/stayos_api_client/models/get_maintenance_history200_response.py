...
class GetMaintenanceHistory200Response(BaseModel):
    """
    GetMaintenanceHistory200Response
    """ # noqa: E501
    request_id: Optional[UUID] = Field(default=None, alias="requestId")
    history: Optional[List[GetMaintenanceHistory200ResponseHistoryInner]] = None
    __properties: ClassVar[List[str]] = ["requestId", "history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": [GetMaintenanceHistory200ResponseHistoryInner.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
