...
class SearchAvailabilityRequest(BaseModel):
    ...
    """ # noqa: E501
    property_id: Optional[UUID] = Field(default=None, description="Filter by specific property (optional)", alias="propertyId")
    ...
    unit_type_id: Optional[UUID] = Field(default=None, description="Filter by unit type", alias="unitTypeId")
    rate_strategy_id: Optional[UUID] = Field(default=None, description="Filter by rate strategy", alias="rateStrategyId")
    filters: Optional[SearchAvailabilityRequestFilters] = None
    __properties: ClassVar[List[str]] = ["propertyId", "checkInDate", "checkOutDate", "occupancy", "unitTypeId", "rateStrategyId", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "occupancy": SearchAvailabilityRequestOccupancy.from_dict(obj["occupancy"]) if obj.get("occupancy") is not None else None,
            "unitTypeId": obj.get("unitTypeId"),
            "rateStrategyId": obj.get("rateStrategyId"),
            "filters": SearchAvailabilityRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
