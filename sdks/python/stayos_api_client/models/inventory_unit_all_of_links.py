...
class InventoryUnitAllOfLinks(BaseModel):
    """
    ...
    current_reservation: Optional[StrictStr] = Field(default=None, alias="currentReservation")
    __properties: ClassVar[List[str]] = ["self", "property", "availability", "currentReservation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currentReservation": obj.get("currentReservation")
        })
        return _obj
