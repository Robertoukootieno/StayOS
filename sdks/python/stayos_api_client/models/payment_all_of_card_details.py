...
class PaymentAllOfCardDetails(BaseModel):
    """
    PaymentAllOfCardDetails
    """ # noqa: E501
    last4: Optional[StrictStr] = None
    brand: Optional[StrictStr] = None
    expiry_month: Optional[StrictInt] = Field(default=None, alias="expiryMonth")
    expiry_year: Optional[StrictInt] = Field(default=None, alias="expiryYear")
    __properties: ClassVar[List[str]] = ["last4", "brand", "expiryMonth", "expiryYear"]
