...
class CreateComplianceReportRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reportType", "startDate", "endDate"]

    @field_validator('report_type')
    def report_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['GDPR', 'PCI_DSS', 'SOC2', 'CUSTOM']):
            raise ValueError("must be one of enum values ('GDPR', 'PCI_DSS', 'SOC2', 'CUSTOM')")
        return value
