...
class FolioAllOfLinks(BaseModel):
    """
    FolioAllOfLinks
    """ # noqa: E501
    var_self: Optional[StrictStr] = Field(default=None, alias="self")
    pdf: Optional[StrictStr] = None
    guest: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["self", "pdf", "guest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FolioAllOfLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FolioAllOfLinks from a dict"""
        if obj is None:
            return None
