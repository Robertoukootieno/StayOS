...
class PropertyAllOfLinks(BaseModel):
    """
    HATEOAS links
    """ # noqa: E501
    var_self: Optional[StrictStr] = Field(default=None, alias="self")
    inventory_units: Optional[StrictStr] = Field(default=None, alias="inventoryUnits")
    rate_strategies: Optional[StrictStr] = Field(default=None, alias="rateStrategies")
    reservations: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["self", "inventoryUnits", "rateStrategies", "reservations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": obj.get("self"),
            "inventoryUnits": obj.get("inventoryUnits"),
            "rateStrategies": obj.get("rateStrategies"),
