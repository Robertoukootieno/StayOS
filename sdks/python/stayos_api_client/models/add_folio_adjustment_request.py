...
class AddFolioAdjustmentRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "reason", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['DISCOUNT', 'COMP', 'REFUND', 'CORRECTION']):
            raise ValueError("must be one of enum values ('DISCOUNT', 'COMP', 'REFUND', 'CORRECTION')")
        return value
