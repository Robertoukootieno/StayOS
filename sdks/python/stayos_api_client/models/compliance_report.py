...
class ComplianceReport(BaseModel):
    ...
    submitted_to: Optional[StrictStr] = Field(default=None, description="Authority/agency submitted to", alias="submittedTo")
    ...
    __properties: ClassVar[List[str]] = ["reportId", "type", "propertyId", "startDate", "endDate", "status", "fileUrl", "submittedTo", "submittedAt", "generatedAt", "metadata"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['GUEST_REGISTRY', 'TAX_REPORT', 'OCCUPANCY_REPORT', 'REVENUE_REPORT', 'GDPR_EXPORT']):
            raise ValueError("must be one of enum values ('GUEST_REGISTRY', 'TAX_REPORT', 'OCCUPANCY_REPORT', 'REVENUE_REPORT', 'GDPR_EXPORT')")
        return value
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['GENERATING', 'COMPLETED', 'FAILED', 'SUBMITTED']):
            raise ValueError("must be one of enum values ('GENERATING', 'COMPLETED', 'FAILED', 'SUBMITTED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submittedTo": obj.get("submittedTo"),
