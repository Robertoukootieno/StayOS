...
class ApplicabilityRulesAllOfAdvanceBookingWindow(BaseModel):
    """
    ApplicabilityRulesAllOfAdvanceBookingWindow
    """ # noqa: E501
    minimum_days: Optional[StrictInt] = Field(default=None, description="Minimum days before check-in", alias="minimumDays")
    maximum_days: Optional[StrictInt] = Field(default=None, description="Maximum days before check-in", alias="maximumDays")
    __properties: ClassVar[List[str]] = ["minimumDays", "maximumDays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minimumDays": obj.get("minimumDays"),
            "maximumDays": obj.get("maximumDays")
        })
        return _obj
