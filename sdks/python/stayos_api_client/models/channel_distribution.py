...
class ChannelDistribution(BaseModel):
    ...
    markup: Optional[ChannelDistributionAllOfMarkup] = None
    commission: Optional[ChannelDistributionAllOfCommission] = None
    __properties: ClassVar[List[str]] = ["channelId", "channelName", "isEnabled", "markup", "commission"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "markup": ChannelDistributionAllOfMarkup.from_dict(obj["markup"]) if obj.get("markup") is not None else None,
            "commission": ChannelDistributionAllOfCommission.from_dict(obj["commission"]) if obj.get("commission") is not None else None
        })
        return _obj
