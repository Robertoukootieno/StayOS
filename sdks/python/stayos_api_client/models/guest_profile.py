...
class GuestProfile(BaseModel):
    ...
    address: Optional[GuestProfileAllOfAddress] = None
    loyalty_tier: Optional[StrictStr] = Field(default=None, alias="loyaltyTier")
    preferences: Optional[Any] = Field(default=None, description="Guest preferences")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    version: Optional[StrictInt] = Field(default=None, description="Version for optimistic locking")
    __properties: ClassVar[List[str]] = ["guestId", "firstName", "lastName", "email", "phone", "dateOfBirth", "nationality", "address", "loyaltyTier", "preferences", "createdAt", "updatedAt", "version"]

    @field_validator('loyalty_tier')
    def loyalty_tier_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['NONE', 'SILVER', 'GOLD', 'PLATINUM']):
            raise ValueError("must be one of enum values ('NONE', 'SILVER', 'GOLD', 'PLATINUM')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": GuestProfileAllOfAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "loyaltyTier": obj.get("loyaltyTier"),
