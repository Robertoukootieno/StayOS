...
class IncidentAllOfCorrectiveActions(BaseModel):
    """
    IncidentAllOfCorrectiveActions
    """ # noqa: E501
    action: Optional[StrictStr] = None
    taken_by: Optional[UUID] = Field(default=None, alias="takenBy")
    taken_at: Optional[datetime] = Field(default=None, alias="takenAt")
    __properties: ClassVar[List[str]] = ["action", "takenBy", "takenAt"]
