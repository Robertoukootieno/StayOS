...
class AvailabilitySlotAllOfAllocations(BaseModel):
    """
    ...
    allocated: Optional[StrictInt] = Field(default=None, description="Units allocated to this channel")
    sold: Optional[StrictInt] = Field(default=None, description="Units sold through this channel")
    __properties: ClassVar[List[str]] = ["channelId", "channelName", "allocated", "sold"]
