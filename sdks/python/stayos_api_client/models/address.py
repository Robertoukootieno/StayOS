...
class Address(BaseModel):
    ...
    street2: Optional[StrictStr] = Field(default=None, description="Apartment, suite, etc.")
    ...
    __properties: ClassVar[List[str]] = ["street", "street2", "city", "state", "postalCode", "country"]
