...
class CreateInventoryBlock201Response(BaseModel):
    """
    CreateInventoryBlock201Response
    """ # noqa: E501
    block_id: Optional[UUID] = Field(default=None, alias="blockId")
    __properties: ClassVar[List[str]] = ["blockId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateInventoryBlock201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateInventoryBlock201Response from a dict"""
        if obj is None:
            return None
