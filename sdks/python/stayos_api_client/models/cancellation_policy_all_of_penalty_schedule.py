...
class CancellationPolicyAllOfPenaltySchedule(BaseModel):
    """
    CancellationPolicyAllOfPenaltySchedule
    """ # noqa: E501
    hours_before_check_in: Optional[StrictInt] = Field(default=None, alias="hoursBeforeCheckIn")
    penalty_type: Optional[StrictStr] = Field(default=None, alias="penaltyType")
    penalty_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="penaltyValue")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["hoursBeforeCheckIn", "penaltyType", "penaltyValue", "description"]
    ...
    def penalty_type_validate_enum(cls, value):
        ...
        if value not in set(['PERCENTAGE', 'FIXED_AMOUNT', 'NIGHTS']):
            raise ValueError("must be one of enum values ('PERCENTAGE', 'FIXED_AMOUNT', 'NIGHTS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hoursBeforeCheckIn": obj.get("hoursBeforeCheckIn"),
            "penaltyType": obj.get("penaltyType"),
            "penaltyValue": obj.get("penaltyValue"),
