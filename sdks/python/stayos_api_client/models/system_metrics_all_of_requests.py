...
class SystemMetricsAllOfRequests(BaseModel):
    """
    ...
    average_response_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average response time in milliseconds", alias="averageResponseTime")
    __properties: ClassVar[List[str]] = ["total", "successful", "failed", "averageResponseTime"]
