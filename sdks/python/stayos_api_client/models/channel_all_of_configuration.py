...
class ChannelAllOfConfiguration(BaseModel):
    """
    ChannelAllOfConfiguration
    """ # noqa: E501
    auto_accept_bookings: Optional[StrictBool] = Field(default=False, alias="autoAcceptBookings")
    sync_inventory: Optional[StrictBool] = Field(default=True, alias="syncInventory")
    sync_rates: Optional[StrictBool] = Field(default=True, alias="syncRates")
    sync_restrictions: Optional[StrictBool] = Field(default=True, alias="syncRestrictions")
    __properties: ClassVar[List[str]] = ["autoAcceptBookings", "syncInventory", "syncRates", "syncRestrictions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autoAcceptBookings": obj.get("autoAcceptBookings") if obj.get("autoAcceptBookings") is not None else False,
            "syncInventory": obj.get("syncInventory") if obj.get("syncInventory") is not None else True,
            "syncRates": obj.get("syncRates") if obj.get("syncRates") is not None else True,
            "syncRestrictions": obj.get("syncRestrictions") if obj.get("syncRestrictions") is not None else True
        })
        return _obj
