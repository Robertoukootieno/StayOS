...
class WebhookAllOfRetryPolicy(BaseModel):
    """
    WebhookAllOfRetryPolicy
    """ # noqa: E501
    max_retries: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = Field(default=3, alias="maxRetries")
    retry_delay: Optional[StrictInt] = Field(default=60, description="Delay between retries in seconds", alias="retryDelay")
    __properties: ClassVar[List[str]] = ["maxRetries", "retryDelay"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "retryDelay": obj.get("retryDelay") if obj.get("retryDelay") is not None else 60
        })
        return _obj
