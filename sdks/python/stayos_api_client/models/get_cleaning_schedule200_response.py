...
class GetCleaningSchedule200Response(BaseModel):
    """
    GetCleaningSchedule200Response
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    tasks: Optional[List[HousekeepingTask]] = None
    __properties: ClassVar[List[str]] = ["date", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "tasks": [HousekeepingTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
