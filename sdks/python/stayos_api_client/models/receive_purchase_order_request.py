...
class ReceivePurchaseOrderRequest(BaseModel):
    ...
    """ # noqa: E501
    received_items: Optional[List[ReceivePurchaseOrderRequestReceivedItemsInner]] = Field(default=None, alias="receivedItems")
    received_by: Optional[UUID] = Field(default=None, alias="receivedBy")
    notes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["receivedItems", "receivedBy", "notes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in received_items (list)
        _items = []
        if self.received_items:
            for _item_received_items in self.received_items:
                if _item_received_items:
                    _items.append(_item_received_items.to_dict())
            _dict['receivedItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "receivedItems": [ReceivePurchaseOrderRequestReceivedItemsInner.from_dict(_item) for _item in obj["receivedItems"]] if obj.get("receivedItems") is not None else None,
            "receivedBy": obj.get("receivedBy"),
            "notes": obj.get("notes")
        })
        return _obj
