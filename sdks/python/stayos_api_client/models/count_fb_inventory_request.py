...
class CountFBInventoryRequest(BaseModel):
    """
    CountFBInventoryRequest
    """ # noqa: E501
    counts: List[CountFBInventoryRequestCountsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [CountFBInventoryRequestCountsInner.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None
        })
        return _obj
