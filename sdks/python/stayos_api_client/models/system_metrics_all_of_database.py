...
class SystemMetricsAllOfDatabase(BaseModel):
    """
    SystemMetricsAllOfDatabase
    """ # noqa: E501
    connections: Optional[StrictInt] = None
    query_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average query time in milliseconds", alias="queryTime")
    __properties: ClassVar[List[str]] = ["connections", "queryTime"]
