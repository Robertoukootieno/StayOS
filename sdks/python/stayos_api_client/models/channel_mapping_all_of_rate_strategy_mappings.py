...
class ChannelMappingAllOfRateStrategyMappings(BaseModel):
    """
    ChannelMappingAllOfRateStrategyMappings
    """ # noqa: E501
    internal_rate_strategy_id: Optional[UUID] = Field(default=None, alias="internalRateStrategyId")
    channel_rate_plan_id: Optional[StrictStr] = Field(default=None, alias="channelRatePlanId")
    channel_rate_plan_name: Optional[StrictStr] = Field(default=None, alias="channelRatePlanName")
    __properties: ClassVar[List[str]] = ["internalRateStrategyId", "channelRatePlanId", "channelRatePlanName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "internalRateStrategyId": obj.get("internalRateStrategyId"),
            "channelRatePlanId": obj.get("channelRatePlanId"),
            "channelRatePlanName": obj.get("channelRatePlanName")
        })
        return _obj
