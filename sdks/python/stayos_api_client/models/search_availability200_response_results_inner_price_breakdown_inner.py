...
class SearchAvailability200ResponseResultsInnerPriceBreakdownInner(BaseModel):
    """
    SearchAvailability200ResponseResultsInnerPriceBreakdownInner
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    nightly_rate: Optional[Money] = Field(default=None, alias="nightlyRate")
    taxes: Optional[List[SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner]] = None
    __properties: ClassVar[List[str]] = ["date", "nightlyRate", "taxes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nightly_rate
        if self.nightly_rate:
            _dict['nightlyRate'] = self.nightly_rate.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "nightlyRate": Money.from_dict(obj["nightlyRate"]) if obj.get("nightlyRate") is not None else None,
            "taxes": [SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner.from_dict(_item) for _item in obj["taxes"]] if obj.get("taxes") is not None else None
        })
        return _obj
