...
class PricingModelAllOfFees(BaseModel):
    """
    PricingModelAllOfFees
    """ # noqa: E501
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    amount: Optional[Model0] = None
    is_optional: Optional[StrictBool] = Field(default=False, alias="isOptional")
    __properties: ClassVar[List[str]] = ["name", "type", "amount", "isOptional"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PER_STAY', 'PER_NIGHT', 'PER_PERSON']):
            raise ValueError("must be one of enum values ('PER_STAY', 'PER_NIGHT', 'PER_PERSON')")
        return value
