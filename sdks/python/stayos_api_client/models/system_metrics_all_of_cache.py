...
class SystemMetricsAllOfCache(BaseModel):
    """
    SystemMetricsAllOfCache
    """ # noqa: E501
    hit_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cache hit rate percentage", alias="hitRate")
    memory_usage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Memory usage in MB", alias="memoryUsage")
    __properties: ClassVar[List[str]] = ["hitRate", "memoryUsage"]
