...
class HealthCheck(BaseModel):
    ...
    services: Optional[HealthCheckAllOfServices] = None
    __properties: ClassVar[List[str]] = ["status", "timestamp", "version", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": HealthCheckAllOfServices.from_dict(obj["services"]) if obj.get("services") is not None else None
        })
        return _obj
