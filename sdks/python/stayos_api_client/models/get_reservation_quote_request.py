...
class GetReservationQuoteRequest(BaseModel):
    """
    GetReservationQuoteRequest
    """ # noqa: E501
    property_id: UUID = Field(alias="propertyId")
    unit_type_id: UUID = Field(alias="unitTypeId")
    check_in_date: date = Field(alias="checkInDate")
    check_out_date: date = Field(alias="checkOutDate")
    guest_count: GetReservationQuoteRequestGuestCount = Field(alias="guestCount")
    ...
    __properties: ClassVar[List[str]] = ["propertyId", "unitTypeId", "checkInDate", "checkOutDate", "guestCount", "rateStrategyId", "promoCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "guestCount": GetReservationQuoteRequestGuestCount.from_dict(obj["guestCount"]) if obj.get("guestCount") is not None else None,
