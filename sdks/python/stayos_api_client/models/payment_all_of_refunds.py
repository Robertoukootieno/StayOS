...
class PaymentAllOfRefunds(BaseModel):
    """
    PaymentAllOfRefunds
    """ # noqa: E501
    refund_id: Optional[UUID] = Field(default=None, alias="refundId")
    amount: Optional[Model0] = None
    reason: Optional[StrictStr] = None
    refunded_at: Optional[datetime] = Field(default=None, alias="refundedAt")
    __properties: ClassVar[List[str]] = ["refundId", "amount", "reason", "refundedAt"]
