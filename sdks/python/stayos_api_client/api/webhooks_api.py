...
class WebhooksApi:
    ...
    async def get_webhook_deliveries(
        ...
        _param = self._get_webhook_deliveries_serialize(
            webhook_id=webhook_id,
            status=status,
            page_size=page_size,
            cursor=cursor,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetWebhookDeliveries200Response",
            '404': "Model0",
            '500': "Model0",
        }
        response_data = await self.api_client.call_api(
    ...
    @validate_call
    async def get_webhook_deliveries_with_http_info(
        self,
        webhook_id: UUID,
        status: Optional[StrictStr] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page (max 100)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWebhookDeliveries200Response]:
        """Get webhook deliveries
    ...
    @validate_call
    async def get_webhook_deliveries_without_preload_content(
        self,
        webhook_id: UUID,
        status: Optional[StrictStr] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page (max 100)")] = None,
    ...
    def _get_webhook_deliveries_serialize(
        self,
        webhook_id,
        status,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhooks/{webhookId}/deliveries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def replace_webhook(
        ...
        _param = self._replace_webhook_serialize(
            webhook_id=webhook_id,
            body=body,
            if_match=if_match,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def replace_webhook_with_http_info(
        self,
        webhook_id: UUID,
        body: Dict[str, Any],
        if_match: Annotated[Optional[StrictStr], Field(description="ETag for optimistic locking")] = None,
    ...
    @validate_call
    async def replace_webhook_without_preload_content(
        self,
        webhook_id: UUID,
        body: Dict[str, Any],
        if_match: Annotated[Optional[StrictStr], Field(description="ETag for optimistic locking")] = None,
    ...
    def _replace_webhook_serialize(
        self,
        webhook_id,
        body,
        if_match,
    ...
    def _test_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/webhooks/{webhookId}/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
