...
// checks if the FolioAllOfTotal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FolioAllOfTotal{}

// FolioAllOfTotal struct for FolioAllOfTotal
type FolioAllOfTotal struct {
...
type _FolioAllOfTotal FolioAllOfTotal

// NewFolioAllOfTotal instantiates a new FolioAllOfTotal object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFolioAllOfTotal(amount string, currency string) *FolioAllOfTotal {
	this := FolioAllOfTotal{}
	this.Amount = amount
	this.Currency = currency
	return &this
}

// NewFolioAllOfTotalWithDefaults instantiates a new FolioAllOfTotal object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewFolioAllOfTotalWithDefaults() *FolioAllOfTotal {
	this := FolioAllOfTotal{}
	return &this
}

// GetAmount returns the Amount field value
func (o *FolioAllOfTotal) GetAmount() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *FolioAllOfTotal) GetAmountOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FolioAllOfTotal) SetAmount(v string) {
	o.Amount = v
}

// GetCurrency returns the Currency field value
func (o *FolioAllOfTotal) GetCurrency() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FolioAllOfTotal) GetCurrencyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FolioAllOfTotal) SetCurrency(v string) {
	o.Currency = v
}

func (o FolioAllOfTotal) MarshalJSON() ([]byte, error) {
...
func (o FolioAllOfTotal) ToMap() (map[string]interface{}, error) {
...
func (o *FolioAllOfTotal) UnmarshalJSON(data []byte) (err error) {
	...
	varFolioAllOfTotal := _FolioAllOfTotal{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFolioAllOfTotal)

	if err != nil {
		return err
	}

	*o = FolioAllOfTotal(varFolioAllOfTotal)

	return err
}

type NullableFolioAllOfTotal struct {
	value *FolioAllOfTotal
	isSet bool
}

func (v NullableFolioAllOfTotal) Get() *FolioAllOfTotal {
	return v.value
}

func (v *NullableFolioAllOfTotal) Set(val *FolioAllOfTotal) {
	v.value = val
	v.isSet = true
}

func (v NullableFolioAllOfTotal) IsSet() bool {
	return v.isSet
}

func (v *NullableFolioAllOfTotal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolioAllOfTotal(val *FolioAllOfTotal) *NullableFolioAllOfTotal {
	return &NullableFolioAllOfTotal{value: val, isSet: true}
}

func (v NullableFolioAllOfTotal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolioAllOfTotal) UnmarshalJSON(src []byte) error {
	v.isSet = true
