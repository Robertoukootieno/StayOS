...
// checks if the CloseIncidentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloseIncidentRequest{}

// CloseIncidentRequest struct for CloseIncidentRequest
type CloseIncidentRequest struct {
	Resolution *string `json:"resolution,omitempty"`
}

// NewCloseIncidentRequest instantiates a new CloseIncidentRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCloseIncidentRequest() *CloseIncidentRequest {
	this := CloseIncidentRequest{}
	return &this
}

// NewCloseIncidentRequestWithDefaults instantiates a new CloseIncidentRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCloseIncidentRequestWithDefaults() *CloseIncidentRequest {
	this := CloseIncidentRequest{}
	return &this
}

// GetResolution returns the Resolution field value if set, zero value otherwise.
func (o *CloseIncidentRequest) GetResolution() string {
...
func (o *CloseIncidentRequest) GetResolutionOk() (*string, bool) {
	if o == nil || IsNil(o.Resolution) {
		return nil, false
	}
...
func (o *CloseIncidentRequest) HasResolution() bool {
	if o != nil && !IsNil(o.Resolution) {
		return true
	}
...
func (o *CloseIncidentRequest) SetResolution(v string) {
	o.Resolution = &v
}

func (o CloseIncidentRequest) MarshalJSON() ([]byte, error) {
...
func (o CloseIncidentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCloseIncidentRequest struct {
	value *CloseIncidentRequest
	isSet bool
}

func (v NullableCloseIncidentRequest) Get() *CloseIncidentRequest {
	return v.value
}

func (v *NullableCloseIncidentRequest) Set(val *CloseIncidentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCloseIncidentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCloseIncidentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloseIncidentRequest(val *CloseIncidentRequest) *NullableCloseIncidentRequest {
	return &NullableCloseIncidentRequest{value: val, isSet: true}
}

func (v NullableCloseIncidentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloseIncidentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
