...
// checks if the ListGuests200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListGuests200Response{}

// ListGuests200Response struct for ListGuests200Response
type ListGuests200Response struct {
	Data []GuestProfile `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListGuests200Response ListGuests200Response
...
func (o ListGuests200Response) MarshalJSON() ([]byte, error) {
...
func (o ListGuests200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListGuests200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListGuests200Response := _ListGuests200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListGuests200Response)

	if err != nil {
		return err
	}

	*o = ListGuests200Response(varListGuests200Response)

	return err
}

type NullableListGuests200Response struct {
	value *ListGuests200Response
	isSet bool
}

func (v NullableListGuests200Response) Get() *ListGuests200Response {
	return v.value
}

func (v *NullableListGuests200Response) Set(val *ListGuests200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListGuests200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListGuests200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListGuests200Response(val *ListGuests200Response) *NullableListGuests200Response {
	return &NullableListGuests200Response{value: val, isSet: true}
}

func (v NullableListGuests200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListGuests200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
