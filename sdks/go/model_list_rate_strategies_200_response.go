...
// checks if the ListRateStrategies200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListRateStrategies200Response{}

// ListRateStrategies200Response struct for ListRateStrategies200Response
type ListRateStrategies200Response struct {
	Data []RateStrategy `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListRateStrategies200Response ListRateStrategies200Response
...
func NewListRateStrategies200Response(data []RateStrategy, pagination PaginatedResponseAllOfPagination) *ListRateStrategies200Response {
	this := ListRateStrategies200Response{}
	this.Data = data
...
func (o ListRateStrategies200Response) MarshalJSON() ([]byte, error) {
...
func (o ListRateStrategies200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListRateStrategies200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListRateStrategies200Response := _ListRateStrategies200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListRateStrategies200Response)

	if err != nil {
		return err
	}

	*o = ListRateStrategies200Response(varListRateStrategies200Response)

	return err
}

type NullableListRateStrategies200Response struct {
	value *ListRateStrategies200Response
	isSet bool
}

func (v NullableListRateStrategies200Response) Get() *ListRateStrategies200Response {
	return v.value
}

func (v *NullableListRateStrategies200Response) Set(val *ListRateStrategies200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListRateStrategies200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListRateStrategies200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRateStrategies200Response(val *ListRateStrategies200Response) *NullableListRateStrategies200Response {
	return &NullableListRateStrategies200Response{value: val, isSet: true}
}

func (v NullableListRateStrategies200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListRateStrategies200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
