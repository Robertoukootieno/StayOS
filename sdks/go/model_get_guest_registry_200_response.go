...
// checks if the GetGuestRegistry200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGuestRegistry200Response{}

// GetGuestRegistry200Response struct for GetGuestRegistry200Response
type GetGuestRegistry200Response struct {
	Guests []map[string]interface{} `json:"guests,omitempty"`
}

// NewGetGuestRegistry200Response instantiates a new GetGuestRegistry200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetGuestRegistry200Response() *GetGuestRegistry200Response {
	this := GetGuestRegistry200Response{}
	return &this
}

// NewGetGuestRegistry200ResponseWithDefaults instantiates a new GetGuestRegistry200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetGuestRegistry200ResponseWithDefaults() *GetGuestRegistry200Response {
	this := GetGuestRegistry200Response{}
	return &this
}

// GetGuests returns the Guests field value if set, zero value otherwise.
func (o *GetGuestRegistry200Response) GetGuests() []map[string]interface{} {
...
func (o *GetGuestRegistry200Response) GetGuestsOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Guests) {
		return nil, false
	}
...
func (o *GetGuestRegistry200Response) HasGuests() bool {
	if o != nil && !IsNil(o.Guests) {
		return true
	}
...
// SetGuests gets a reference to the given []map[string]interface{} and assigns it to the Guests field.
func (o *GetGuestRegistry200Response) SetGuests(v []map[string]interface{}) {
	o.Guests = v
}

func (o GetGuestRegistry200Response) MarshalJSON() ([]byte, error) {
...
func (o GetGuestRegistry200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetGuestRegistry200Response struct {
	value *GetGuestRegistry200Response
	isSet bool
}

func (v NullableGetGuestRegistry200Response) Get() *GetGuestRegistry200Response {
	return v.value
}

func (v *NullableGetGuestRegistry200Response) Set(val *GetGuestRegistry200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGuestRegistry200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGuestRegistry200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGuestRegistry200Response(val *GetGuestRegistry200Response) *NullableGetGuestRegistry200Response {
	return &NullableGetGuestRegistry200Response{value: val, isSet: true}
}

func (v NullableGetGuestRegistry200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGuestRegistry200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
