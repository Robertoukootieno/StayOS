...
// checks if the ExtendStayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendStayRequest{}

// ExtendStayRequest struct for ExtendStayRequest
type ExtendStayRequest struct {
	NewCheckOutDate string `json:"newCheckOutDate"`
}

type _ExtendStayRequest ExtendStayRequest

// NewExtendStayRequest instantiates a new ExtendStayRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewExtendStayRequest(newCheckOutDate string) *ExtendStayRequest {
	this := ExtendStayRequest{}
	this.NewCheckOutDate = newCheckOutDate
	return &this
}

// NewExtendStayRequestWithDefaults instantiates a new ExtendStayRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewExtendStayRequestWithDefaults() *ExtendStayRequest {
	this := ExtendStayRequest{}
	return &this
}

// GetNewCheckOutDate returns the NewCheckOutDate field value
func (o *ExtendStayRequest) GetNewCheckOutDate() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.NewCheckOutDate
}

// GetNewCheckOutDateOk returns a tuple with the NewCheckOutDate field value
// and a boolean to check if the value has been set.
func (o *ExtendStayRequest) GetNewCheckOutDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NewCheckOutDate, true
}

// SetNewCheckOutDate sets field value
func (o *ExtendStayRequest) SetNewCheckOutDate(v string) {
	o.NewCheckOutDate = v
}

func (o ExtendStayRequest) MarshalJSON() ([]byte, error) {
...
func (o ExtendStayRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["newCheckOutDate"] = o.NewCheckOutDate
	return toSerialize, nil
}

func (o *ExtendStayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varExtendStayRequest := _ExtendStayRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExtendStayRequest)

	if err != nil {
		return err
	}

	*o = ExtendStayRequest(varExtendStayRequest)

	return err
}

type NullableExtendStayRequest struct {
	value *ExtendStayRequest
	isSet bool
}

func (v NullableExtendStayRequest) Get() *ExtendStayRequest {
	return v.value
}

func (v *NullableExtendStayRequest) Set(val *ExtendStayRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendStayRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendStayRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendStayRequest(val *ExtendStayRequest) *NullableExtendStayRequest {
	return &NullableExtendStayRequest{value: val, isSet: true}
}

func (v NullableExtendStayRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendStayRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
