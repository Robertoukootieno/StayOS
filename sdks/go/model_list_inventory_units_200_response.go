...
// checks if the ListInventoryUnits200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInventoryUnits200Response{}

// ListInventoryUnits200Response struct for ListInventoryUnits200Response
type ListInventoryUnits200Response struct {
	Data []InventoryUnit `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListInventoryUnits200Response ListInventoryUnits200Response
...
func NewListInventoryUnits200Response(data []InventoryUnit, pagination PaginatedResponseAllOfPagination) *ListInventoryUnits200Response {
	this := ListInventoryUnits200Response{}
	this.Data = data
...
func (o ListInventoryUnits200Response) MarshalJSON() ([]byte, error) {
...
func (o ListInventoryUnits200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListInventoryUnits200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListInventoryUnits200Response := _ListInventoryUnits200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListInventoryUnits200Response)

	if err != nil {
		return err
	}

	*o = ListInventoryUnits200Response(varListInventoryUnits200Response)

	return err
}

type NullableListInventoryUnits200Response struct {
	value *ListInventoryUnits200Response
	isSet bool
}

func (v NullableListInventoryUnits200Response) Get() *ListInventoryUnits200Response {
	return v.value
}

func (v *NullableListInventoryUnits200Response) Set(val *ListInventoryUnits200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListInventoryUnits200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListInventoryUnits200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInventoryUnits200Response(val *ListInventoryUnits200Response) *NullableListInventoryUnits200Response {
	return &NullableListInventoryUnits200Response{value: val, isSet: true}
}

func (v NullableListInventoryUnits200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInventoryUnits200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
