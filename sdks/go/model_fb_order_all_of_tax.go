...
// checks if the FBOrderAllOfTax type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FBOrderAllOfTax{}

// FBOrderAllOfTax struct for FBOrderAllOfTax
type FBOrderAllOfTax struct {
...
type _FBOrderAllOfTax FBOrderAllOfTax
...
func (o FBOrderAllOfTax) MarshalJSON() ([]byte, error) {
...
func (o FBOrderAllOfTax) ToMap() (map[string]interface{}, error) {
...
func (o *FBOrderAllOfTax) UnmarshalJSON(data []byte) (err error) {
	...
	varFBOrderAllOfTax := _FBOrderAllOfTax{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFBOrderAllOfTax)

	if err != nil {
		return err
	}

	*o = FBOrderAllOfTax(varFBOrderAllOfTax)

	return err
}

type NullableFBOrderAllOfTax struct {
	value *FBOrderAllOfTax
	isSet bool
}

func (v NullableFBOrderAllOfTax) Get() *FBOrderAllOfTax {
	return v.value
}

func (v *NullableFBOrderAllOfTax) Set(val *FBOrderAllOfTax) {
	v.value = val
	v.isSet = true
}

func (v NullableFBOrderAllOfTax) IsSet() bool {
	return v.isSet
}

func (v *NullableFBOrderAllOfTax) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFBOrderAllOfTax(val *FBOrderAllOfTax) *NullableFBOrderAllOfTax {
	return &NullableFBOrderAllOfTax{value: val, isSet: true}
}

func (v NullableFBOrderAllOfTax) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFBOrderAllOfTax) UnmarshalJSON(src []byte) error {
	v.isSet = true
