...
// checks if the FolioAllOfFees type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FolioAllOfFees{}

// FolioAllOfFees struct for FolioAllOfFees
type FolioAllOfFees struct {
...
type _FolioAllOfFees FolioAllOfFees
...
func (o FolioAllOfFees) MarshalJSON() ([]byte, error) {
...
func (o FolioAllOfFees) ToMap() (map[string]interface{}, error) {
...
func (o *FolioAllOfFees) UnmarshalJSON(data []byte) (err error) {
	...
	varFolioAllOfFees := _FolioAllOfFees{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFolioAllOfFees)

	if err != nil {
		return err
	}

	*o = FolioAllOfFees(varFolioAllOfFees)

	return err
}

type NullableFolioAllOfFees struct {
	value *FolioAllOfFees
	isSet bool
}

func (v NullableFolioAllOfFees) Get() *FolioAllOfFees {
	return v.value
}

func (v *NullableFolioAllOfFees) Set(val *FolioAllOfFees) {
	v.value = val
	v.isSet = true
}

func (v NullableFolioAllOfFees) IsSet() bool {
	return v.isSet
}

func (v *NullableFolioAllOfFees) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolioAllOfFees(val *FolioAllOfFees) *NullableFolioAllOfFees {
	return &NullableFolioAllOfFees{value: val, isSet: true}
}

func (v NullableFolioAllOfFees) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolioAllOfFees) UnmarshalJSON(src []byte) error {
	v.isSet = true
