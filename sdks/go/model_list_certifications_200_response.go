...
// checks if the ListCertifications200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCertifications200Response{}

// ListCertifications200Response struct for ListCertifications200Response
type ListCertifications200Response struct {
	Data []PropertyCertification `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListCertifications200Response ListCertifications200Response
...
func NewListCertifications200Response(data []PropertyCertification, pagination PaginatedResponseAllOfPagination) *ListCertifications200Response {
	this := ListCertifications200Response{}
	this.Data = data
...
func (o ListCertifications200Response) MarshalJSON() ([]byte, error) {
...
func (o ListCertifications200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListCertifications200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListCertifications200Response := _ListCertifications200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListCertifications200Response)

	if err != nil {
		return err
	}

	*o = ListCertifications200Response(varListCertifications200Response)

	return err
}

type NullableListCertifications200Response struct {
	value *ListCertifications200Response
	isSet bool
}

func (v NullableListCertifications200Response) Get() *ListCertifications200Response {
	return v.value
}

func (v *NullableListCertifications200Response) Set(val *ListCertifications200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListCertifications200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListCertifications200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListCertifications200Response(val *ListCertifications200Response) *NullableListCertifications200Response {
	return &NullableListCertifications200Response{value: val, isSet: true}
}

func (v NullableListCertifications200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListCertifications200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
