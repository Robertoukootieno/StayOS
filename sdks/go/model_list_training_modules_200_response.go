...
// checks if the ListTrainingModules200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTrainingModules200Response{}

// ListTrainingModules200Response struct for ListTrainingModules200Response
type ListTrainingModules200Response struct {
	Data []TrainingModule `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListTrainingModules200Response ListTrainingModules200Response
...
func NewListTrainingModules200Response(data []TrainingModule, pagination PaginatedResponseAllOfPagination) *ListTrainingModules200Response {
	this := ListTrainingModules200Response{}
	this.Data = data
...
func (o ListTrainingModules200Response) MarshalJSON() ([]byte, error) {
...
func (o ListTrainingModules200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListTrainingModules200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListTrainingModules200Response := _ListTrainingModules200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTrainingModules200Response)

	if err != nil {
		return err
	}

	*o = ListTrainingModules200Response(varListTrainingModules200Response)

	return err
}

type NullableListTrainingModules200Response struct {
	value *ListTrainingModules200Response
	isSet bool
}

func (v NullableListTrainingModules200Response) Get() *ListTrainingModules200Response {
	return v.value
}

func (v *NullableListTrainingModules200Response) Set(val *ListTrainingModules200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTrainingModules200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTrainingModules200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTrainingModules200Response(val *ListTrainingModules200Response) *NullableListTrainingModules200Response {
	return &NullableListTrainingModules200Response{value: val, isSet: true}
}

func (v NullableListTrainingModules200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTrainingModules200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
