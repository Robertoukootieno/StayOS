...
// checks if the FBOrderAllOfTotal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FBOrderAllOfTotal{}

// FBOrderAllOfTotal struct for FBOrderAllOfTotal
type FBOrderAllOfTotal struct {
...
type _FBOrderAllOfTotal FBOrderAllOfTotal
...
func (o FBOrderAllOfTotal) MarshalJSON() ([]byte, error) {
...
func (o FBOrderAllOfTotal) ToMap() (map[string]interface{}, error) {
...
func (o *FBOrderAllOfTotal) UnmarshalJSON(data []byte) (err error) {
	...
	varFBOrderAllOfTotal := _FBOrderAllOfTotal{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFBOrderAllOfTotal)

	if err != nil {
		return err
	}

	*o = FBOrderAllOfTotal(varFBOrderAllOfTotal)

	return err
}

type NullableFBOrderAllOfTotal struct {
	value *FBOrderAllOfTotal
	isSet bool
}

func (v NullableFBOrderAllOfTotal) Get() *FBOrderAllOfTotal {
	return v.value
}

func (v *NullableFBOrderAllOfTotal) Set(val *FBOrderAllOfTotal) {
	v.value = val
	v.isSet = true
}

func (v NullableFBOrderAllOfTotal) IsSet() bool {
	return v.isSet
}

func (v *NullableFBOrderAllOfTotal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFBOrderAllOfTotal(val *FBOrderAllOfTotal) *NullableFBOrderAllOfTotal {
	return &NullableFBOrderAllOfTotal{value: val, isSet: true}
}

func (v NullableFBOrderAllOfTotal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFBOrderAllOfTotal) UnmarshalJSON(src []byte) error {
	v.isSet = true
