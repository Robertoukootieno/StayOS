...
// checks if the ListReviews200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListReviews200Response{}

// ListReviews200Response struct for ListReviews200Response
type ListReviews200Response struct {
	Data []Review `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListReviews200Response ListReviews200Response
...
func (o ListReviews200Response) MarshalJSON() ([]byte, error) {
...
func (o ListReviews200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListReviews200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListReviews200Response := _ListReviews200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListReviews200Response)

	if err != nil {
		return err
	}

	*o = ListReviews200Response(varListReviews200Response)

	return err
}

type NullableListReviews200Response struct {
	value *ListReviews200Response
	isSet bool
}

func (v NullableListReviews200Response) Get() *ListReviews200Response {
	return v.value
}

func (v *NullableListReviews200Response) Set(val *ListReviews200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListReviews200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListReviews200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListReviews200Response(val *ListReviews200Response) *NullableListReviews200Response {
	return &NullableListReviews200Response{value: val, isSet: true}
}

func (v NullableListReviews200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListReviews200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
