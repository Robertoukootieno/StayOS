...
// checks if the ListPayments200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListPayments200Response{}

// ListPayments200Response struct for ListPayments200Response
type ListPayments200Response struct {
	Data []Payment `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListPayments200Response ListPayments200Response
...
func (o ListPayments200Response) MarshalJSON() ([]byte, error) {
...
func (o ListPayments200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListPayments200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListPayments200Response := _ListPayments200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListPayments200Response)

	if err != nil {
		return err
	}

	*o = ListPayments200Response(varListPayments200Response)

	return err
}

type NullableListPayments200Response struct {
	value *ListPayments200Response
	isSet bool
}

func (v NullableListPayments200Response) Get() *ListPayments200Response {
	return v.value
}

func (v *NullableListPayments200Response) Set(val *ListPayments200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListPayments200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListPayments200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPayments200Response(val *ListPayments200Response) *NullableListPayments200Response {
	return &NullableListPayments200Response{value: val, isSet: true}
}

func (v NullableListPayments200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPayments200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
