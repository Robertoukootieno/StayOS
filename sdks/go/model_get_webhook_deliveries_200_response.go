...
type _GetWebhookDeliveries200Response GetWebhookDeliveries200Response
...
func (o *GetWebhookDeliveries200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetWebhookDeliveries200Response := _GetWebhookDeliveries200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetWebhookDeliveries200Response)

	if err != nil {
		return err
	}

	*o = GetWebhookDeliveries200Response(varGetWebhookDeliveries200Response)
