...
// checks if the WasteFBInventoryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WasteFBInventoryRequest{}

// WasteFBInventoryRequest struct for WasteFBInventoryRequest
type WasteFBInventoryRequest struct {
	Quantity float32 `json:"quantity"`
	Reason string `json:"reason"`
	Notes *string `json:"notes,omitempty"`
}

type _WasteFBInventoryRequest WasteFBInventoryRequest
...
func (o WasteFBInventoryRequest) MarshalJSON() ([]byte, error) {
...
func (o WasteFBInventoryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WasteFBInventoryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varWasteFBInventoryRequest := _WasteFBInventoryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWasteFBInventoryRequest)

	if err != nil {
		return err
	}

	*o = WasteFBInventoryRequest(varWasteFBInventoryRequest)

	return err
}

type NullableWasteFBInventoryRequest struct {
	value *WasteFBInventoryRequest
	isSet bool
}

func (v NullableWasteFBInventoryRequest) Get() *WasteFBInventoryRequest {
	return v.value
}

func (v *NullableWasteFBInventoryRequest) Set(val *WasteFBInventoryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWasteFBInventoryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWasteFBInventoryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWasteFBInventoryRequest(val *WasteFBInventoryRequest) *NullableWasteFBInventoryRequest {
	return &NullableWasteFBInventoryRequest{value: val, isSet: true}
}

func (v NullableWasteFBInventoryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWasteFBInventoryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
