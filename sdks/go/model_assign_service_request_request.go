...
// checks if the AssignServiceRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignServiceRequestRequest{}

// AssignServiceRequestRequest struct for AssignServiceRequestRequest
type AssignServiceRequestRequest struct {
	AssignedTo string `json:"assignedTo"`
}

type _AssignServiceRequestRequest AssignServiceRequestRequest

// NewAssignServiceRequestRequest instantiates a new AssignServiceRequestRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAssignServiceRequestRequest(assignedTo string) *AssignServiceRequestRequest {
	this := AssignServiceRequestRequest{}
	this.AssignedTo = assignedTo
	return &this
}

// NewAssignServiceRequestRequestWithDefaults instantiates a new AssignServiceRequestRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAssignServiceRequestRequestWithDefaults() *AssignServiceRequestRequest {
	this := AssignServiceRequestRequest{}
	return &this
}

// GetAssignedTo returns the AssignedTo field value
func (o *AssignServiceRequestRequest) GetAssignedTo() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AssignServiceRequestRequest) GetAssignedToOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AssignServiceRequestRequest) SetAssignedTo(v string) {
	o.AssignedTo = v
}

func (o AssignServiceRequestRequest) MarshalJSON() ([]byte, error) {
...
func (o AssignServiceRequestRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["assignedTo"] = o.AssignedTo
	return toSerialize, nil
}

func (o *AssignServiceRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAssignServiceRequestRequest := _AssignServiceRequestRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssignServiceRequestRequest)

	if err != nil {
		return err
	}

	*o = AssignServiceRequestRequest(varAssignServiceRequestRequest)

	return err
}

type NullableAssignServiceRequestRequest struct {
	value *AssignServiceRequestRequest
	isSet bool
}

func (v NullableAssignServiceRequestRequest) Get() *AssignServiceRequestRequest {
	return v.value
}

func (v *NullableAssignServiceRequestRequest) Set(val *AssignServiceRequestRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignServiceRequestRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignServiceRequestRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignServiceRequestRequest(val *AssignServiceRequestRequest) *NullableAssignServiceRequestRequest {
	return &NullableAssignServiceRequestRequest{value: val, isSet: true}
}

func (v NullableAssignServiceRequestRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignServiceRequestRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
