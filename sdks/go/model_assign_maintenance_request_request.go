...
// checks if the AssignMaintenanceRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignMaintenanceRequestRequest{}

// AssignMaintenanceRequestRequest struct for AssignMaintenanceRequestRequest
type AssignMaintenanceRequestRequest struct {
	// Technician ID
	AssignedTo string `json:"assignedTo"`
}

type _AssignMaintenanceRequestRequest AssignMaintenanceRequestRequest

// NewAssignMaintenanceRequestRequest instantiates a new AssignMaintenanceRequestRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAssignMaintenanceRequestRequest(assignedTo string) *AssignMaintenanceRequestRequest {
	this := AssignMaintenanceRequestRequest{}
	this.AssignedTo = assignedTo
	return &this
}

// NewAssignMaintenanceRequestRequestWithDefaults instantiates a new AssignMaintenanceRequestRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAssignMaintenanceRequestRequestWithDefaults() *AssignMaintenanceRequestRequest {
	this := AssignMaintenanceRequestRequest{}
	return &this
}

// GetAssignedTo returns the AssignedTo field value
func (o *AssignMaintenanceRequestRequest) GetAssignedTo() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AssignMaintenanceRequestRequest) GetAssignedToOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AssignMaintenanceRequestRequest) SetAssignedTo(v string) {
	o.AssignedTo = v
}

func (o AssignMaintenanceRequestRequest) MarshalJSON() ([]byte, error) {
...
func (o AssignMaintenanceRequestRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["assignedTo"] = o.AssignedTo
	return toSerialize, nil
}

func (o *AssignMaintenanceRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAssignMaintenanceRequestRequest := _AssignMaintenanceRequestRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssignMaintenanceRequestRequest)

	if err != nil {
		return err
	}

	*o = AssignMaintenanceRequestRequest(varAssignMaintenanceRequestRequest)

	return err
}

type NullableAssignMaintenanceRequestRequest struct {
	value *AssignMaintenanceRequestRequest
	isSet bool
}

func (v NullableAssignMaintenanceRequestRequest) Get() *AssignMaintenanceRequestRequest {
	return v.value
}

func (v *NullableAssignMaintenanceRequestRequest) Set(val *AssignMaintenanceRequestRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignMaintenanceRequestRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignMaintenanceRequestRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignMaintenanceRequestRequest(val *AssignMaintenanceRequestRequest) *NullableAssignMaintenanceRequestRequest {
	return &NullableAssignMaintenanceRequestRequest{value: val, isSet: true}
}

func (v NullableAssignMaintenanceRequestRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignMaintenanceRequestRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
