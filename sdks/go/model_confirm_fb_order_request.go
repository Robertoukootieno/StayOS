...
// checks if the ConfirmFBOrderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfirmFBOrderRequest{}

// ConfirmFBOrderRequest struct for ConfirmFBOrderRequest
type ConfirmFBOrderRequest struct {
	EstimatedDelivery *time.Time `json:"estimatedDelivery,omitempty"`
}

// NewConfirmFBOrderRequest instantiates a new ConfirmFBOrderRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewConfirmFBOrderRequest() *ConfirmFBOrderRequest {
	this := ConfirmFBOrderRequest{}
	return &this
}

// NewConfirmFBOrderRequestWithDefaults instantiates a new ConfirmFBOrderRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewConfirmFBOrderRequestWithDefaults() *ConfirmFBOrderRequest {
	this := ConfirmFBOrderRequest{}
	return &this
}

// GetEstimatedDelivery returns the EstimatedDelivery field value if set, zero value otherwise.
func (o *ConfirmFBOrderRequest) GetEstimatedDelivery() time.Time {
	if o == nil || IsNil(o.EstimatedDelivery) {
		var ret time.Time
		return ret
	}
	return *o.EstimatedDelivery
}

// GetEstimatedDeliveryOk returns a tuple with the EstimatedDelivery field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfirmFBOrderRequest) GetEstimatedDeliveryOk() (*time.Time, bool) {
	if o == nil || IsNil(o.EstimatedDelivery) {
		return nil, false
	}
	return o.EstimatedDelivery, true
}

// HasEstimatedDelivery returns a boolean if a field has been set.
func (o *ConfirmFBOrderRequest) HasEstimatedDelivery() bool {
	if o != nil && !IsNil(o.EstimatedDelivery) {
		return true
	}
...
// SetEstimatedDelivery gets a reference to the given time.Time and assigns it to the EstimatedDelivery field.
func (o *ConfirmFBOrderRequest) SetEstimatedDelivery(v time.Time) {
	o.EstimatedDelivery = &v
}

func (o ConfirmFBOrderRequest) MarshalJSON() ([]byte, error) {
...
func (o ConfirmFBOrderRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EstimatedDelivery) {
		toSerialize["estimatedDelivery"] = o.EstimatedDelivery
	}
	return toSerialize, nil
}

type NullableConfirmFBOrderRequest struct {
	value *ConfirmFBOrderRequest
	isSet bool
}

func (v NullableConfirmFBOrderRequest) Get() *ConfirmFBOrderRequest {
	return v.value
}

func (v *NullableConfirmFBOrderRequest) Set(val *ConfirmFBOrderRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableConfirmFBOrderRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableConfirmFBOrderRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfirmFBOrderRequest(val *ConfirmFBOrderRequest) *NullableConfirmFBOrderRequest {
	return &NullableConfirmFBOrderRequest{value: val, isSet: true}
}

func (v NullableConfirmFBOrderRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfirmFBOrderRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
