...
// checks if the ApprovePurchaseOrderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovePurchaseOrderRequest{}

// ApprovePurchaseOrderRequest struct for ApprovePurchaseOrderRequest
type ApprovePurchaseOrderRequest struct {
	ApprovedBy *string `json:"approvedBy,omitempty"`
	Notes *string `json:"notes,omitempty"`
}

// NewApprovePurchaseOrderRequest instantiates a new ApprovePurchaseOrderRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewApprovePurchaseOrderRequest() *ApprovePurchaseOrderRequest {
	this := ApprovePurchaseOrderRequest{}
	return &this
}

// NewApprovePurchaseOrderRequestWithDefaults instantiates a new ApprovePurchaseOrderRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewApprovePurchaseOrderRequestWithDefaults() *ApprovePurchaseOrderRequest {
	this := ApprovePurchaseOrderRequest{}
	return &this
}

// GetApprovedBy returns the ApprovedBy field value if set, zero value otherwise.
func (o *ApprovePurchaseOrderRequest) GetApprovedBy() string {
...
func (o *ApprovePurchaseOrderRequest) GetApprovedByOk() (*string, bool) {
	if o == nil || IsNil(o.ApprovedBy) {
		return nil, false
	}
...
func (o *ApprovePurchaseOrderRequest) HasApprovedBy() bool {
	if o != nil && !IsNil(o.ApprovedBy) {
		return true
	}
...
func (o *ApprovePurchaseOrderRequest) SetApprovedBy(v string) {
	o.ApprovedBy = &v
}

// GetNotes returns the Notes field value if set, zero value otherwise.
func (o *ApprovePurchaseOrderRequest) GetNotes() string {
...
// and a boolean to check if the value has been set.
func (o *ApprovePurchaseOrderRequest) GetNotesOk() (*string, bool) {
	if o == nil || IsNil(o.Notes) {
		return nil, false
	}
	return o.Notes, true
...
func (o *ApprovePurchaseOrderRequest) HasNotes() bool {
	if o != nil && !IsNil(o.Notes) {
		return true
	}
...
func (o *ApprovePurchaseOrderRequest) SetNotes(v string) {
	o.Notes = &v
}

func (o ApprovePurchaseOrderRequest) MarshalJSON() ([]byte, error) {
...
func (o ApprovePurchaseOrderRequest) ToMap() (map[string]interface{}, error) {
...
type NullableApprovePurchaseOrderRequest struct {
	value *ApprovePurchaseOrderRequest
	isSet bool
}

func (v NullableApprovePurchaseOrderRequest) Get() *ApprovePurchaseOrderRequest {
	return v.value
}

func (v *NullableApprovePurchaseOrderRequest) Set(val *ApprovePurchaseOrderRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovePurchaseOrderRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovePurchaseOrderRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovePurchaseOrderRequest(val *ApprovePurchaseOrderRequest) *NullableApprovePurchaseOrderRequest {
	return &NullableApprovePurchaseOrderRequest{value: val, isSet: true}
}

func (v NullableApprovePurchaseOrderRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovePurchaseOrderRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
