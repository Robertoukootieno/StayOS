...
// checks if the DeleteGuestData200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteGuestData200Response{}

// DeleteGuestData200Response struct for DeleteGuestData200Response
type DeleteGuestData200Response struct {
	RequestId *string `json:"requestId,omitempty"`
	Status *string `json:"status,omitempty"`
}

// NewDeleteGuestData200Response instantiates a new DeleteGuestData200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeleteGuestData200Response() *DeleteGuestData200Response {
	this := DeleteGuestData200Response{}
	return &this
}

// NewDeleteGuestData200ResponseWithDefaults instantiates a new DeleteGuestData200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDeleteGuestData200ResponseWithDefaults() *DeleteGuestData200Response {
	this := DeleteGuestData200Response{}
	return &this
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *DeleteGuestData200Response) GetRequestId() string {
...
func (o *DeleteGuestData200Response) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *DeleteGuestData200Response) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *DeleteGuestData200Response) SetRequestId(v string) {
	o.RequestId = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *DeleteGuestData200Response) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *DeleteGuestData200Response) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *DeleteGuestData200Response) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *DeleteGuestData200Response) SetStatus(v string) {
	o.Status = &v
}

func (o DeleteGuestData200Response) MarshalJSON() ([]byte, error) {
...
func (o DeleteGuestData200Response) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteGuestData200Response struct {
	value *DeleteGuestData200Response
	isSet bool
}

func (v NullableDeleteGuestData200Response) Get() *DeleteGuestData200Response {
	return v.value
}

func (v *NullableDeleteGuestData200Response) Set(val *DeleteGuestData200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteGuestData200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteGuestData200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteGuestData200Response(val *DeleteGuestData200Response) *NullableDeleteGuestData200Response {
	return &NullableDeleteGuestData200Response{value: val, isSet: true}
}

func (v NullableDeleteGuestData200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteGuestData200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
