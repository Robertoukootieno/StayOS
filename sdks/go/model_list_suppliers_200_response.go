...
// checks if the ListSuppliers200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSuppliers200Response{}

// ListSuppliers200Response struct for ListSuppliers200Response
type ListSuppliers200Response struct {
...
type _ListSuppliers200Response ListSuppliers200Response
...
func (o ListSuppliers200Response) MarshalJSON() ([]byte, error) {
...
func (o ListSuppliers200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListSuppliers200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListSuppliers200Response := _ListSuppliers200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListSuppliers200Response)

	if err != nil {
		return err
	}

	*o = ListSuppliers200Response(varListSuppliers200Response)

	return err
}

type NullableListSuppliers200Response struct {
	value *ListSuppliers200Response
	isSet bool
}

func (v NullableListSuppliers200Response) Get() *ListSuppliers200Response {
	return v.value
}

func (v *NullableListSuppliers200Response) Set(val *ListSuppliers200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSuppliers200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSuppliers200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSuppliers200Response(val *ListSuppliers200Response) *NullableListSuppliers200Response {
	return &NullableListSuppliers200Response{value: val, isSet: true}
}

func (v NullableListSuppliers200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSuppliers200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
