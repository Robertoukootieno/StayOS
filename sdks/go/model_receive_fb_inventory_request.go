...
// checks if the ReceiveFBInventoryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReceiveFBInventoryRequest{}

// ReceiveFBInventoryRequest struct for ReceiveFBInventoryRequest
type ReceiveFBInventoryRequest struct {
	Quantity float32 `json:"quantity"`
	Notes *string `json:"notes,omitempty"`
}

type _ReceiveFBInventoryRequest ReceiveFBInventoryRequest
...
func NewReceiveFBInventoryRequest(quantity float32) *ReceiveFBInventoryRequest {
	this := ReceiveFBInventoryRequest{}
...
func (o ReceiveFBInventoryRequest) MarshalJSON() ([]byte, error) {
...
func (o ReceiveFBInventoryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ReceiveFBInventoryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varReceiveFBInventoryRequest := _ReceiveFBInventoryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReceiveFBInventoryRequest)

	if err != nil {
		return err
	}

	*o = ReceiveFBInventoryRequest(varReceiveFBInventoryRequest)

	return err
}

type NullableReceiveFBInventoryRequest struct {
	value *ReceiveFBInventoryRequest
	isSet bool
}

func (v NullableReceiveFBInventoryRequest) Get() *ReceiveFBInventoryRequest {
	return v.value
}

func (v *NullableReceiveFBInventoryRequest) Set(val *ReceiveFBInventoryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableReceiveFBInventoryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableReceiveFBInventoryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReceiveFBInventoryRequest(val *ReceiveFBInventoryRequest) *NullableReceiveFBInventoryRequest {
	return &NullableReceiveFBInventoryRequest{value: val, isSet: true}
}

func (v NullableReceiveFBInventoryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReceiveFBInventoryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
