...
// checks if the ListProperties200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListProperties200Response{}

// ListProperties200Response struct for ListProperties200Response
type ListProperties200Response struct {
...
type _ListProperties200Response ListProperties200Response
...
func NewListProperties200Response(data []Property, pagination PaginatedResponseAllOfPagination) *ListProperties200Response {
	this := ListProperties200Response{}
	this.Data = data
...
func (o ListProperties200Response) MarshalJSON() ([]byte, error) {
...
func (o ListProperties200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListProperties200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListProperties200Response := _ListProperties200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListProperties200Response)

	if err != nil {
		return err
	}

	*o = ListProperties200Response(varListProperties200Response)

	return err
}

type NullableListProperties200Response struct {
	value *ListProperties200Response
	isSet bool
}

func (v NullableListProperties200Response) Get() *ListProperties200Response {
	return v.value
}

func (v *NullableListProperties200Response) Set(val *ListProperties200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListProperties200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListProperties200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListProperties200Response(val *ListProperties200Response) *NullableListProperties200Response {
	return &NullableListProperties200Response{value: val, isSet: true}
}

func (v NullableListProperties200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListProperties200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
