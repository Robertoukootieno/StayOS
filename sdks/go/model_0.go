...
// checks if the Model0 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Model0{}

// Model0 Monetary amount with currency
type Model0 struct {
...
func (o Model0) MarshalJSON() ([]byte, error) {
...
func (o Model0) ToMap() (map[string]interface{}, error) {
...
func (o *Model0) UnmarshalJSON(data []byte) (err error) {
...
type NullableModel0 struct {
	value *Model0
	isSet bool
}

func (v NullableModel0) Get() *Model0 {
	return v.value
}

func (v *NullableModel0) Set(val *Model0) {
	v.value = val
	v.isSet = true
}

func (v NullableModel0) IsSet() bool {
	return v.isSet
}

func (v *NullableModel0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModel0(val *Model0) *NullableModel0 {
	return &NullableModel0{value: val, isSet: true}
}

func (v NullableModel0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModel0) UnmarshalJSON(src []byte) error {
	v.isSet = true
