...
// checks if the GetGuestStays200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGuestStays200Response{}

// GetGuestStays200Response struct for GetGuestStays200Response
type GetGuestStays200Response struct {
	Data []map[string]interface{} `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _GetGuestStays200Response GetGuestStays200Response
...
func (o GetGuestStays200Response) MarshalJSON() ([]byte, error) {
...
func (o GetGuestStays200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetGuestStays200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetGuestStays200Response := _GetGuestStays200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetGuestStays200Response)

	if err != nil {
		return err
	}

	*o = GetGuestStays200Response(varGetGuestStays200Response)

	return err
}

type NullableGetGuestStays200Response struct {
	value *GetGuestStays200Response
	isSet bool
}

func (v NullableGetGuestStays200Response) Get() *GetGuestStays200Response {
	return v.value
}

func (v *NullableGetGuestStays200Response) Set(val *GetGuestStays200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGuestStays200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGuestStays200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGuestStays200Response(val *GetGuestStays200Response) *NullableGetGuestStays200Response {
	return &NullableGetGuestStays200Response{value: val, isSet: true}
}

func (v NullableGetGuestStays200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGuestStays200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
