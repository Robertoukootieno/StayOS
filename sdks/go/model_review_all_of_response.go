...
// checks if the ReviewAllOfResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewAllOfResponse{}

// ReviewAllOfResponse struct for ReviewAllOfResponse
type ReviewAllOfResponse struct {
	RespondedBy *string `json:"respondedBy,omitempty"`
	RespondedAt *time.Time `json:"respondedAt,omitempty"`
	Message *string `json:"message,omitempty"`
}

// NewReviewAllOfResponse instantiates a new ReviewAllOfResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReviewAllOfResponse() *ReviewAllOfResponse {
	this := ReviewAllOfResponse{}
	return &this
}

// NewReviewAllOfResponseWithDefaults instantiates a new ReviewAllOfResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewReviewAllOfResponseWithDefaults() *ReviewAllOfResponse {
	this := ReviewAllOfResponse{}
	return &this
}

// GetRespondedBy returns the RespondedBy field value if set, zero value otherwise.
func (o *ReviewAllOfResponse) GetRespondedBy() string {
...
func (o *ReviewAllOfResponse) GetRespondedByOk() (*string, bool) {
	if o == nil || IsNil(o.RespondedBy) {
		return nil, false
	}
...
func (o *ReviewAllOfResponse) HasRespondedBy() bool {
	if o != nil && !IsNil(o.RespondedBy) {
		return true
	}
...
func (o *ReviewAllOfResponse) SetRespondedBy(v string) {
	o.RespondedBy = &v
}

// GetRespondedAt returns the RespondedAt field value if set, zero value otherwise.
func (o *ReviewAllOfResponse) GetRespondedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ReviewAllOfResponse) GetRespondedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.RespondedAt) {
		return nil, false
	}
...
func (o *ReviewAllOfResponse) HasRespondedAt() bool {
	if o != nil && !IsNil(o.RespondedAt) {
		return true
	}
...
func (o *ReviewAllOfResponse) SetRespondedAt(v time.Time) {
	o.RespondedAt = &v
}

// GetMessage returns the Message field value if set, zero value otherwise.
func (o *ReviewAllOfResponse) GetMessage() string {
...
// and a boolean to check if the value has been set.
func (o *ReviewAllOfResponse) GetMessageOk() (*string, bool) {
	if o == nil || IsNil(o.Message) {
		return nil, false
	}
...
func (o *ReviewAllOfResponse) HasMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *ReviewAllOfResponse) SetMessage(v string) {
	o.Message = &v
}

func (o ReviewAllOfResponse) MarshalJSON() ([]byte, error) {
...
func (o ReviewAllOfResponse) ToMap() (map[string]interface{}, error) {
...
type NullableReviewAllOfResponse struct {
	value *ReviewAllOfResponse
	isSet bool
}

func (v NullableReviewAllOfResponse) Get() *ReviewAllOfResponse {
	return v.value
}

func (v *NullableReviewAllOfResponse) Set(val *ReviewAllOfResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewAllOfResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewAllOfResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewAllOfResponse(val *ReviewAllOfResponse) *NullableReviewAllOfResponse {
	return &NullableReviewAllOfResponse{value: val, isSet: true}
}

func (v NullableReviewAllOfResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReviewAllOfResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
