...
// checks if the ListUnitTypes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListUnitTypes200Response{}

// ListUnitTypes200Response struct for ListUnitTypes200Response
type ListUnitTypes200Response struct {
	Data []UnitType `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListUnitTypes200Response ListUnitTypes200Response
...
func (o ListUnitTypes200Response) MarshalJSON() ([]byte, error) {
...
func (o ListUnitTypes200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListUnitTypes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListUnitTypes200Response := _ListUnitTypes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListUnitTypes200Response)

	if err != nil {
		return err
	}

	*o = ListUnitTypes200Response(varListUnitTypes200Response)

	return err
}

type NullableListUnitTypes200Response struct {
	value *ListUnitTypes200Response
	isSet bool
}

func (v NullableListUnitTypes200Response) Get() *ListUnitTypes200Response {
	return v.value
}

func (v *NullableListUnitTypes200Response) Set(val *ListUnitTypes200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListUnitTypes200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListUnitTypes200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUnitTypes200Response(val *ListUnitTypes200Response) *NullableListUnitTypes200Response {
	return &NullableListUnitTypes200Response{value: val, isSet: true}
}

func (v NullableListUnitTypes200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUnitTypes200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
