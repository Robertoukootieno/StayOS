...
// checks if the MarkReservationNoShowRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarkReservationNoShowRequest{}

// MarkReservationNoShowRequest struct for MarkReservationNoShowRequest
type MarkReservationNoShowRequest struct {
	Notes *string `json:"notes,omitempty"`
}

// NewMarkReservationNoShowRequest instantiates a new MarkReservationNoShowRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMarkReservationNoShowRequest() *MarkReservationNoShowRequest {
	this := MarkReservationNoShowRequest{}
	return &this
}

// NewMarkReservationNoShowRequestWithDefaults instantiates a new MarkReservationNoShowRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMarkReservationNoShowRequestWithDefaults() *MarkReservationNoShowRequest {
	this := MarkReservationNoShowRequest{}
	return &this
}

// GetNotes returns the Notes field value if set, zero value otherwise.
func (o *MarkReservationNoShowRequest) GetNotes() string {
...
func (o *MarkReservationNoShowRequest) GetNotesOk() (*string, bool) {
	if o == nil || IsNil(o.Notes) {
		return nil, false
	}
	return o.Notes, true
...
func (o *MarkReservationNoShowRequest) HasNotes() bool {
	if o != nil && !IsNil(o.Notes) {
		return true
	}
...
func (o *MarkReservationNoShowRequest) SetNotes(v string) {
	o.Notes = &v
}

func (o MarkReservationNoShowRequest) MarshalJSON() ([]byte, error) {
...
func (o MarkReservationNoShowRequest) ToMap() (map[string]interface{}, error) {
...
type NullableMarkReservationNoShowRequest struct {
	value *MarkReservationNoShowRequest
	isSet bool
}

func (v NullableMarkReservationNoShowRequest) Get() *MarkReservationNoShowRequest {
	return v.value
}

func (v *NullableMarkReservationNoShowRequest) Set(val *MarkReservationNoShowRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMarkReservationNoShowRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMarkReservationNoShowRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarkReservationNoShowRequest(val *MarkReservationNoShowRequest) *NullableMarkReservationNoShowRequest {
	return &NullableMarkReservationNoShowRequest{value: val, isSet: true}
}

func (v NullableMarkReservationNoShowRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarkReservationNoShowRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
