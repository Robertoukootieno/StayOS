...
// checks if the CancelServiceRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelServiceRequestRequest{}

// CancelServiceRequestRequest struct for CancelServiceRequestRequest
type CancelServiceRequestRequest struct {
	Reason *string `json:"reason,omitempty"`
}

// NewCancelServiceRequestRequest instantiates a new CancelServiceRequestRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCancelServiceRequestRequest() *CancelServiceRequestRequest {
	this := CancelServiceRequestRequest{}
	return &this
}

// NewCancelServiceRequestRequestWithDefaults instantiates a new CancelServiceRequestRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCancelServiceRequestRequestWithDefaults() *CancelServiceRequestRequest {
	this := CancelServiceRequestRequest{}
	return &this
}

// GetReason returns the Reason field value if set, zero value otherwise.
func (o *CancelServiceRequestRequest) GetReason() string {
...
func (o *CancelServiceRequestRequest) GetReasonOk() (*string, bool) {
	if o == nil || IsNil(o.Reason) {
		return nil, false
	}
...
func (o *CancelServiceRequestRequest) HasReason() bool {
	if o != nil && !IsNil(o.Reason) {
		return true
	}
...
func (o *CancelServiceRequestRequest) SetReason(v string) {
	o.Reason = &v
}

func (o CancelServiceRequestRequest) MarshalJSON() ([]byte, error) {
...
func (o CancelServiceRequestRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCancelServiceRequestRequest struct {
	value *CancelServiceRequestRequest
	isSet bool
}

func (v NullableCancelServiceRequestRequest) Get() *CancelServiceRequestRequest {
	return v.value
}

func (v *NullableCancelServiceRequestRequest) Set(val *CancelServiceRequestRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelServiceRequestRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelServiceRequestRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelServiceRequestRequest(val *CancelServiceRequestRequest) *NullableCancelServiceRequestRequest {
	return &NullableCancelServiceRequestRequest{value: val, isSet: true}
}

func (v NullableCancelServiceRequestRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelServiceRequestRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
