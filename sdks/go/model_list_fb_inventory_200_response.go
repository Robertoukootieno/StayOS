...
// checks if the ListFBInventory200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListFBInventory200Response{}

// ListFBInventory200Response struct for ListFBInventory200Response
type ListFBInventory200Response struct {
	Data []FBInventoryItem `json:"data"`
	Pagination PaginatedResponseAllOfPagination `json:"pagination"`
	Links *PaginatedResponseAllOfLinks `json:"links,omitempty"`
}

type _ListFBInventory200Response ListFBInventory200Response
...
func NewListFBInventory200Response(data []FBInventoryItem, pagination PaginatedResponseAllOfPagination) *ListFBInventory200Response {
	this := ListFBInventory200Response{}
	this.Data = data
...
func (o ListFBInventory200Response) MarshalJSON() ([]byte, error) {
...
func (o ListFBInventory200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListFBInventory200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListFBInventory200Response := _ListFBInventory200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListFBInventory200Response)

	if err != nil {
		return err
	}

	*o = ListFBInventory200Response(varListFBInventory200Response)

	return err
}

type NullableListFBInventory200Response struct {
	value *ListFBInventory200Response
	isSet bool
}

func (v NullableListFBInventory200Response) Get() *ListFBInventory200Response {
	return v.value
}

func (v *NullableListFBInventory200Response) Set(val *ListFBInventory200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListFBInventory200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListFBInventory200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListFBInventory200Response(val *ListFBInventory200Response) *NullableListFBInventory200Response {
	return &NullableListFBInventory200Response{value: val, isSet: true}
}

func (v NullableListFBInventory200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListFBInventory200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
