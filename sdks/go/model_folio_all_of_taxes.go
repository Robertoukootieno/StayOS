...
// checks if the FolioAllOfTaxes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FolioAllOfTaxes{}

// FolioAllOfTaxes struct for FolioAllOfTaxes
type FolioAllOfTaxes struct {
...
type _FolioAllOfTaxes FolioAllOfTaxes
...
func (o FolioAllOfTaxes) MarshalJSON() ([]byte, error) {
...
func (o FolioAllOfTaxes) ToMap() (map[string]interface{}, error) {
...
func (o *FolioAllOfTaxes) UnmarshalJSON(data []byte) (err error) {
	...
	varFolioAllOfTaxes := _FolioAllOfTaxes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFolioAllOfTaxes)

	if err != nil {
		return err
	}

	*o = FolioAllOfTaxes(varFolioAllOfTaxes)

	return err
}

type NullableFolioAllOfTaxes struct {
	value *FolioAllOfTaxes
	isSet bool
}

func (v NullableFolioAllOfTaxes) Get() *FolioAllOfTaxes {
	return v.value
}

func (v *NullableFolioAllOfTaxes) Set(val *FolioAllOfTaxes) {
	v.value = val
	v.isSet = true
}

func (v NullableFolioAllOfTaxes) IsSet() bool {
	return v.isSet
}

func (v *NullableFolioAllOfTaxes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolioAllOfTaxes(val *FolioAllOfTaxes) *NullableFolioAllOfTaxes {
	return &NullableFolioAllOfTaxes{value: val, isSet: true}
}

func (v NullableFolioAllOfTaxes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolioAllOfTaxes) UnmarshalJSON(src []byte) error {
	v.isSet = true
