...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "completeMaintenanceRequest_request_partsUsed_inner")]
    public partial class CompleteMaintenanceRequestRequestPartsUsedInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompleteMaintenanceRequestRequestPartsUsedInner" /> class.
        /// </summary>
        /// <param name="partId">partId.</param>
        /// <param name="quantity">quantity.</param>
        public CompleteMaintenanceRequestRequestPartsUsedInner(string partId = default, int quantity = default)
        {
            this.PartId = partId;
