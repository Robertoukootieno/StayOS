...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "batchProcessPayments_request")]
    public partial class BatchProcessPaymentsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchProcessPaymentsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchProcessPaymentsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchProcessPaymentsRequest" /> class.
        /// </summary>
        /// <param name="payments">payments (required).</param>
        public BatchProcessPaymentsRequest(List<BatchProcessPaymentsRequestPaymentsInner> payments = default)
        {
            // to ensure "payments" is required (not null)
            if (payments == null)
            {
                throw new ArgumentNullException("payments is a required property for BatchProcessPaymentsRequest and cannot be null");
            }
        ...
        public List<BatchProcessPaymentsRequestPaymentsInner> Payments { get; set; }
