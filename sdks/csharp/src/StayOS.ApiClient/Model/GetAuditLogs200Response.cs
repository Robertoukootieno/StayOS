...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAuditLogs_200_response")]
    public partial class GetAuditLogs200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAuditLogs200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAuditLogs200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAuditLogs200Response" /> class.
        /// </summary>
        ...
        public GetAuditLogs200Response(List<GetAuditLogs200ResponseAllOfDataInner> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetAuditLogs200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for GetAuditLogs200Response and cannot be null");
            }
        ...
        public List<GetAuditLogs200ResponseAllOfDataInner> Data { get; set; }
