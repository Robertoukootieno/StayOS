...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PurchaseOrder_allOf_total")]
    public partial class PurchaseOrderAllOfTotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderAllOfTotal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseOrderAllOfTotal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderAllOfTotal" /> class.
        /// </summary>
        ...
        public PurchaseOrderAllOfTotal(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for PurchaseOrderAllOfTotal and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for PurchaseOrderAllOfTotal and cannot be null");
            }
