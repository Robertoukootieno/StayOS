...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Webhook_allOf_retryPolicy")]
    public partial class WebhookAllOfRetryPolicy : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookAllOfRetryPolicy" /> class.
        /// </summary>
        /// <param name="maxRetries">maxRetries (default to 3).</param>
        /// <param name="retryDelay">Delay between retries in seconds (default to 60).</param>
        public WebhookAllOfRetryPolicy(int maxRetries = 3, int retryDelay = 60)
        {
        ...
        /// </summary>
        /// <value>Delay between retries in seconds</value>
