...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listMenuItems_200_response")]
    public partial class ListMenuItems200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMenuItems200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListMenuItems200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMenuItems200Response" /> class.
        /// </summary>
        ...
        public ListMenuItems200Response(List<MenuItem> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListMenuItems200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListMenuItems200Response and cannot be null");
            }
