...
namespace StayOS.ApiClient.Model
{
    ...
    /// ServeFBOrderRequest
    /// </summary>
    [DataContract(Name = "serveFBOrder_request")]
    public partial class ServeFBOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServeFBOrderRequest" /> class.
        /// </summary>
        /// <param name="servedAt">servedAt.</param>
        /// <param name="servedBy">servedBy.</param>
        public ServeFBOrderRequest(DateTime servedAt = default, Guid servedBy = default)
        {
        ...
        /// <summary>
        /// Gets or Sets ServedBy
        /// </summary>
        [DataMember(Name = "servedBy", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ServedBy: ").Append(ServedBy).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
