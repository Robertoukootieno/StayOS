...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listCertifications_200_response")]
    public partial class ListCertifications200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCertifications200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListCertifications200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListCertifications200Response" /> class.
        /// </summary>
        ...
        public ListCertifications200Response(List<PropertyCertification> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListCertifications200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListCertifications200Response and cannot be null");
            }
        ...
        public List<PropertyCertification> Data { get; set; }
