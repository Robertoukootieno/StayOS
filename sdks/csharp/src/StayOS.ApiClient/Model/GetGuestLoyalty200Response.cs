...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getGuestLoyalty_200_response")]
    public partial class GetGuestLoyalty200Response : IValidatableObject
    {
        /// <summary>
        /// Defines Tier
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGuestLoyalty200Response" /> class.
        /// </summary>
        /// <param name="tier">tier.</param>
        /// <param name="points">points.</param>
        /// <param name="lifetimePoints">lifetimePoints.</param>
        /// <param name="nextTierPoints">nextTierPoints.</param>
        public GetGuestLoyalty200Response(TierEnum? tier = default, int points = default, int lifetimePoints = default, int nextTierPoints = default)
        {
            this.Tier = tier;
            this.Points = points;
        ...
        /// <summary>
        /// Gets or Sets LifetimePoints
        /// </summary>
        [DataMember(Name = "lifetimePoints", EmitDefaultValue = false)]
        public int LifetimePoints { get; set; }

        /// <summary>
        /// Gets or Sets NextTierPoints
        /// </summary>
        [DataMember(Name = "nextTierPoints", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LifetimePoints: ").Append(LifetimePoints).Append("\n");
            sb.Append("  NextTierPoints: ").Append(NextTierPoints).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
