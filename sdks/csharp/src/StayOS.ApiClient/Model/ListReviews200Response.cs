...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listReviews_200_response")]
    public partial class ListReviews200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListReviews200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListReviews200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListReviews200Response" /> class.
        /// </summary>
        ...
        public ListReviews200Response(List<Review> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListReviews200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListReviews200Response and cannot be null");
            }
