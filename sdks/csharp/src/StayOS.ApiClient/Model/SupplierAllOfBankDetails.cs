...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Supplier_allOf_bankDetails")]
    public partial class SupplierAllOfBankDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupplierAllOfBankDetails" /> class.
        /// </summary>
        /// <param name="accountName">accountName.</param>
        /// <param name="accountNumber">accountNumber.</param>
        /// <param name="routingNumber">routingNumber.</param>
        /// <param name="bankName">bankName.</param>
        public SupplierAllOfBankDetails(string accountName = default, string accountNumber = default, string routingNumber = default, string bankName = default)
        {
