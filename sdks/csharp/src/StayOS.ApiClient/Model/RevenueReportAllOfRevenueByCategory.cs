...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RevenueReport_allOf_revenueByCategory")]
    public partial class RevenueReportAllOfRevenueByCategory : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevenueReportAllOfRevenueByCategory" /> class.
        /// </summary>
        /// <param name="room">room.</param>
        /// <param name="foodBeverage">foodBeverage.</param>
        /// <param name="other">other.</param>
        public RevenueReportAllOfRevenueByCategory(Model0 room = default, Model0 foodBeverage = default, Model0 other = default)
        {
            this.Room = room;
        ...
        public Model0 Room { get; set; }

        /// <summary>
        /// Gets or Sets FoodBeverage
        /// </summary>
        [DataMember(Name = "foodBeverage", EmitDefaultValue = false)]
        public Model0 FoodBeverage { get; set; }

        /// <summary>
        /// Gets or Sets Other
        /// </summary>
        [DataMember(Name = "other", EmitDefaultValue = false)]
        public Model0 Other { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FoodBeverage: ").Append(FoodBeverage).Append("\n");
