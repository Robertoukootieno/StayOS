...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "assignServiceRequest_request")]
    public partial class AssignServiceRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignServiceRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssignServiceRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignServiceRequestRequest" /> class.
        /// </summary>
        /// <param name="assignedTo">assignedTo (required).</param>
        public AssignServiceRequestRequest(Guid assignedTo = default)
        {
