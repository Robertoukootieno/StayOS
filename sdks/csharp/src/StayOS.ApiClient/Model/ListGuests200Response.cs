...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listGuests_200_response")]
    public partial class ListGuests200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListGuests200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListGuests200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListGuests200Response" /> class.
        /// </summary>
        ...
        public ListGuests200Response(List<GuestProfile> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListGuests200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListGuests200Response and cannot be null");
            }
        ...
        public List<GuestProfile> Data { get; set; }
