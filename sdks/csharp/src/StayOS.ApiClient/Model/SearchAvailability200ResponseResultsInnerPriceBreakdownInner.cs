...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "searchAvailability_200_response_results_inner_priceBreakdown_inner")]
    public partial class SearchAvailability200ResponseResultsInnerPriceBreakdownInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchAvailability200ResponseResultsInnerPriceBreakdownInner" /> class.
        /// </summary>
        /// <param name="date">date.</param>
        /// <param name="nightlyRate">nightlyRate.</param>
        /// <param name="taxes">taxes.</param>
        public SearchAvailability200ResponseResultsInnerPriceBreakdownInner(DateTime date = default, Money nightlyRate = default, List<SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner> taxes = default)
        {
            this.Date = date;
        ...
        /// <summary>
        /// Gets or Sets NightlyRate
        /// </summary>
        [DataMember(Name = "nightlyRate", EmitDefaultValue = false)]
        public Money NightlyRate { get; set; }

        /// <summary>
        /// Gets or Sets Taxes
        /// </summary>
        [DataMember(Name = "taxes", EmitDefaultValue = false)]
        public List<SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner> Taxes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NightlyRate: ").Append(NightlyRate).Append("\n");
