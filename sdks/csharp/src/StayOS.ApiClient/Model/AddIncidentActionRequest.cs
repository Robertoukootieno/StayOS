...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addIncidentAction_request")]
    public partial class AddIncidentActionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddIncidentActionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddIncidentActionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddIncidentActionRequest" /> class.
        /// </summary>
        /// <param name="action">action (required).</param>
        /// <param name="assignedTo">assignedTo.</param>
        public AddIncidentActionRequest(string action = default, Guid assignedTo = default)
        {
            // to ensure "action" is required (not null)
            if (action == null)
            {
                throw new ArgumentNullException("action is a required property for AddIncidentActionRequest and cannot be null");
            }
            this.Action = action;
