...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listFeedback_200_response")]
    public partial class ListFeedback200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFeedback200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListFeedback200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFeedback200Response" /> class.
        /// </summary>
        ...
        public ListFeedback200Response(List<Feedback> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListFeedback200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListFeedback200Response and cannot be null");
            }
