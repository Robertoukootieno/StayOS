...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PricingModel_allOf_baseRates")]
    public partial class PricingModelAllOfBaseRates : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModelAllOfBaseRates" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingModelAllOfBaseRates() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModelAllOfBaseRates" /> class.
        /// </summary>
        /// <param name="unitTypeId">unitTypeId (required).</param>
        /// <param name="rate">rate (required).</param>
        public PricingModelAllOfBaseRates(Guid unitTypeId = default, Model0 rate = default)
        {
            this.UnitTypeId = unitTypeId;
            // to ensure "rate" is required (not null)
            if (rate == null)
            {
                throw new ArgumentNullException("rate is a required property for PricingModelAllOfBaseRates and cannot be null");
            }
            this.Rate = rate;
        }
