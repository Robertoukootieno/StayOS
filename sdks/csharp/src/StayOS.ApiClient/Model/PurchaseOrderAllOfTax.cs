...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PurchaseOrder_allOf_tax")]
    public partial class PurchaseOrderAllOfTax : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderAllOfTax" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseOrderAllOfTax() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderAllOfTax" /> class.
        /// </summary>
        ...
        public PurchaseOrderAllOfTax(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for PurchaseOrderAllOfTax and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for PurchaseOrderAllOfTax and cannot be null");
            }
