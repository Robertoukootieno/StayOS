...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listFBInventory_200_response")]
    public partial class ListFBInventory200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFBInventory200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListFBInventory200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFBInventory200Response" /> class.
        /// </summary>
        ...
        public ListFBInventory200Response(List<FBInventoryItem> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListFBInventory200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListFBInventory200Response and cannot be null");
            }
        ...
        public List<FBInventoryItem> Data { get; set; }
