...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FBOrder_allOf_subtotal")]
    public partial class FBOrderAllOfSubtotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfSubtotal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FBOrderAllOfSubtotal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfSubtotal" /> class.
        /// </summary>
        ...
        public FBOrderAllOfSubtotal(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FBOrderAllOfSubtotal and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FBOrderAllOfSubtotal and cannot be null");
            }
