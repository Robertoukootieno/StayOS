...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "verifyHousekeepingTask_request")]
    public partial class VerifyHousekeepingTaskRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifyHousekeepingTaskRequest" /> class.
        /// </summary>
        /// <param name="verified">verified.</param>
        /// <param name="notes">notes.</param>
        public VerifyHousekeepingTaskRequest(bool verified = default, string notes = default)
        {
