...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ServiceRequest_allOf_guestFeedback")]
    public partial class ServiceRequestAllOfGuestFeedback : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceRequestAllOfGuestFeedback" /> class.
        /// </summary>
        /// <param name="rating">rating.</param>
        /// <param name="comments">comments.</param>
        public ServiceRequestAllOfGuestFeedback(int rating = default, string comments = default)
        {
            this.Rating = rating;
