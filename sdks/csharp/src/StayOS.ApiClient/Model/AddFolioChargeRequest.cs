...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addFolioCharge_request")]
    public partial class AddFolioChargeRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddFolioChargeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddFolioChargeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddFolioChargeRequest" /> class.
        /// </summary>
        ...
        public AddFolioChargeRequest(Money amount = default, string description = default, string category = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for AddFolioChargeRequest and cannot be null");
            }
            this.Amount = amount;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for AddFolioChargeRequest and cannot be null");
            }
