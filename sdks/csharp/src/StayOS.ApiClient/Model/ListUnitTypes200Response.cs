...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listUnitTypes_200_response")]
    public partial class ListUnitTypes200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnitTypes200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListUnitTypes200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUnitTypes200Response" /> class.
        /// </summary>
        ...
        public ListUnitTypes200Response(List<UnitType> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListUnitTypes200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListUnitTypes200Response and cannot be null");
            }
