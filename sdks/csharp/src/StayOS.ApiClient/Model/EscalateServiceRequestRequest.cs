...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "escalateServiceRequest_request")]
    public partial class EscalateServiceRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EscalateServiceRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EscalateServiceRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EscalateServiceRequestRequest" /> class.
        /// </summary>
        /// <param name="reason">reason (required).</param>
        public EscalateServiceRequestRequest(string reason = default)
        {
            // to ensure "reason" is required (not null)
            if (reason == null)
            {
                throw new ArgumentNullException("reason is a required property for EscalateServiceRequestRequest and cannot be null");
            }
            this.Reason = reason;
        }
