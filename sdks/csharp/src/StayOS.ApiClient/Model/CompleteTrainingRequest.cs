...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "completeTraining_request")]
    public partial class CompleteTrainingRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompleteTrainingRequest" /> class.
        /// </summary>
        /// <param name="completionDate">completionDate.</param>
        public CompleteTrainingRequest(DateTime completionDate = default)
        {
