...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deleteGuestData_request")]
    public partial class DeleteGuestDataRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteGuestDataRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteGuestDataRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteGuestDataRequest" /> class.
        /// </summary>
        /// <param name="guestId">guestId (required).</param>
        /// <param name="confirmation">confirmation.</param>
        public DeleteGuestDataRequest(Guid guestId = default, bool confirmation = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "confirmation", EmitDefaultValue = true)]
