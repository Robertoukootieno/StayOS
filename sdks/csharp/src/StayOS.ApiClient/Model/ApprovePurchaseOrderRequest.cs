...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "approvePurchaseOrder_request")]
    public partial class ApprovePurchaseOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApprovePurchaseOrderRequest" /> class.
        /// </summary>
        /// <param name="approvedBy">approvedBy.</param>
        /// <param name="notes">notes.</param>
        public ApprovePurchaseOrderRequest(Guid approvedBy = default, string notes = default)
        {
