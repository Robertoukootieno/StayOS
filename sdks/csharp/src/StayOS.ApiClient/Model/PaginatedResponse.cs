...
namespace StayOS.ApiClient.Model
{
    ...
    /// PaginatedResponse
    /// </summary>
    [DataContract(Name = "PaginatedResponse")]
    public partial class PaginatedResponse : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="PaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">Array of resources (required).</param>
        /// <param name="pagination">pagination (required).</param>
        /// <param name="links">links.</param>
        public PaginatedResponse(List<Object> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for PaginatedResponse and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for PaginatedResponse and cannot be null");
            }
        ...
        /// Array of resources
        /// </summary>
        /// <value>Array of resources</value>
