...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "countFBInventory_request")]
    public partial class CountFBInventoryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountFBInventoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CountFBInventoryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CountFBInventoryRequest" /> class.
        /// </summary>
        /// <param name="counts">counts (required).</param>
        public CountFBInventoryRequest(List<CountFBInventoryRequestCountsInner> counts = default)
        {
            // to ensure "counts" is required (not null)
            if (counts == null)
            {
                throw new ArgumentNullException("counts is a required property for CountFBInventoryRequest and cannot be null");
            }
            this.Counts = counts;
        }
        ...
        public List<CountFBInventoryRequestCountsInner> Counts { get; set; }
