...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AvailabilityCalendar_allOf_dateRange")]
    public partial class AvailabilityCalendarAllOfDateRange : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailabilityCalendarAllOfDateRange" /> class.
        /// </summary>
        /// <param name="startDate">startDate.</param>
        /// <param name="endDate">endDate.</param>
        public AvailabilityCalendarAllOfDateRange(DateTime startDate = default, DateTime endDate = default)
        {
