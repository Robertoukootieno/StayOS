...
namespace StayOS.ApiClient.Model
{
    ...
    /// ExtendStayRequest
    /// </summary>
    [DataContract(Name = "extendStay_request")]
    public partial class ExtendStayRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendStayRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExtendStayRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendStayRequest" /> class.
        /// </summary>
        /// <param name="newCheckOutDate">newCheckOutDate (required).</param>
        public ExtendStayRequest(DateTime newCheckOutDate = default)
        {
            this.NewCheckOutDate = newCheckOutDate;
        }

        /// <summary>
        /// Gets or Sets NewCheckOutDate
        /// </summary>
        [DataMember(Name = "newCheckOutDate", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NewCheckOutDate: ").Append(NewCheckOutDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
