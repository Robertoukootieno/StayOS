...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getReservationQuote_request_guestCount")]
    public partial class GetReservationQuoteRequestGuestCount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReservationQuoteRequestGuestCount" /> class.
        /// </summary>
        /// <param name="adults">adults.</param>
        /// <param name="children">children.</param>
        public GetReservationQuoteRequestGuestCount(int adults = default, int children = default)
        {
            this.Adults = adults;
