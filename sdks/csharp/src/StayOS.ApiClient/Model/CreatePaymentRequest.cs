...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createPayment_request")]
    public partial class CreatePaymentRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="CreatePaymentRequest" /> class.
        /// </summary>
        /// <param name="folioId">folioId (required).</param>
        /// <param name="amount">amount (required).</param>
        /// <param name="method">method (required).</param>
        public CreatePaymentRequest(Guid folioId = default, Money amount = default, MethodEnum method = default)
        {
