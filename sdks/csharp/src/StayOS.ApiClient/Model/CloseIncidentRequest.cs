...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "closeIncident_request")]
    public partial class CloseIncidentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloseIncidentRequest" /> class.
        /// </summary>
        /// <param name="resolution">resolution.</param>
        public CloseIncidentRequest(string resolution = default)
        {
