...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "receivePurchaseOrder_request")]
    public partial class ReceivePurchaseOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivePurchaseOrderRequest" /> class.
        /// </summary>
        /// <param name="receivedItems">receivedItems.</param>
        /// <param name="receivedBy">receivedBy.</param>
        /// <param name="notes">notes.</param>
        public ReceivePurchaseOrderRequest(List<ReceivePurchaseOrderRequestReceivedItemsInner> receivedItems = default, Guid receivedBy = default, string notes = default)
        {
        ...
        /// <summary>
        /// Gets or Sets ReceivedItems
        /// </summary>
        [DataMember(Name = "receivedItems", EmitDefaultValue = false)]
        public List<ReceivePurchaseOrderRequestReceivedItemsInner> ReceivedItems { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReceivedItems: ").Append(ReceivedItems).Append("\n");
