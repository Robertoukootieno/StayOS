...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getNPSMetrics_200_response")]
    public partial class GetNPSMetrics200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetNPSMetrics200Response" /> class.
        /// </summary>
        /// <param name="npsScore">npsScore.</param>
        /// <param name="promoters">promoters.</param>
        /// <param name="passives">passives.</param>
        /// <param name="detractors">detractors.</param>
        /// <param name="totalResponses">totalResponses.</param>
        /// <param name="trend">trend.</param>
        public GetNPSMetrics200Response(float npsScore = default, int promoters = default, int passives = default, int detractors = default, int totalResponses = default, List<Object> trend = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "promoters", EmitDefaultValue = false)]
        public int Promoters { get; set; }

        /// <summary>
        /// Gets or Sets Passives
        /// </summary>
        [DataMember(Name = "passives", EmitDefaultValue = false)]
        public int Passives { get; set; }

        /// <summary>
        /// Gets or Sets Detractors
        /// </summary>
        [DataMember(Name = "detractors", EmitDefaultValue = false)]
        public int Detractors { get; set; }

        /// <summary>
        /// Gets or Sets TotalResponses
        /// </summary>
        [DataMember(Name = "totalResponses", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Detractors: ").Append(Detractors).Append("\n");
            sb.Append("  TotalResponses: ").Append(TotalResponses).Append("\n");
