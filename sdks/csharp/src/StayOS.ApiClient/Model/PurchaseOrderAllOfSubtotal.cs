...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PurchaseOrder_allOf_subtotal")]
    public partial class PurchaseOrderAllOfSubtotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderAllOfSubtotal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseOrderAllOfSubtotal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderAllOfSubtotal" /> class.
        /// </summary>
        ...
        public PurchaseOrderAllOfSubtotal(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for PurchaseOrderAllOfSubtotal and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for PurchaseOrderAllOfSubtotal and cannot be null");
            }
