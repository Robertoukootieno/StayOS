...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Reservation_allOf_guestCount")]
    public partial class ReservationAllOfGuestCount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReservationAllOfGuestCount" /> class.
        /// </summary>
        /// <param name="adults">adults.</param>
        /// <param name="children">children.</param>
        public ReservationAllOfGuestCount(int adults = default, int children = default)
        {
            this.Adults = adults;
