...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Feedback_allOf_serviceRecovery")]
    public partial class FeedbackAllOfServiceRecovery : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackAllOfServiceRecovery" /> class.
        /// </summary>
        /// <param name="actions">actions.</param>
        /// <param name="compensation">compensation.</param>
        /// <param name="notes">notes.</param>
        public FeedbackAllOfServiceRecovery(List<string> actions = default, Model0 compensation = default, string notes = default)
        {
        ...
        public Model0 Compensation { get; set; }
