...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "assignHousekeepingTask_request")]
    public partial class AssignHousekeepingTaskRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignHousekeepingTaskRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssignHousekeepingTaskRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignHousekeepingTaskRequest" /> class.
        /// </summary>
        /// <param name="assignedTo">Staff member ID (required).</param>
        public AssignHousekeepingTaskRequest(Guid assignedTo = default)
        {
