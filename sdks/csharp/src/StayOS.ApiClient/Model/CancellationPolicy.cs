...
namespace StayOS.ApiClient.Model
{
    ...
    public partial class CancellationPolicy : IValidatableObject
    {
        /// <summary>
        /// Defines Refundability
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum RefundabilityEnum
        {
            /// <summary>
            /// Enum FULLYREFUNDABLE for value: FULLY_REFUNDABLE
            /// </summary>
            [EnumMember(Value = "FULLY_REFUNDABLE")]
            FULLYREFUNDABLE = 1,

            /// <summary>
            /// Enum PARTIALLYREFUNDABLE for value: PARTIALLY_REFUNDABLE
            /// </summary>
            [EnumMember(Value = "PARTIALLY_REFUNDABLE")]
            PARTIALLYREFUNDABLE = 2,

            /// <summary>
            /// Enum NONREFUNDABLE for value: NON_REFUNDABLE
            /// </summary>
            [EnumMember(Value = "NON_REFUNDABLE")]
            NONREFUNDABLE = 3
        }
        ...
        /// </summary>
        /*
        <example>FULLY_REFUNDABLE</example>
        */
        [DataMember(Name = "refundability", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// Initializes a new instance of the <see cref="CancellationPolicy" /> class.
        /// </summary>
        /// <param name="refundability">refundability (required).</param>
        /// <param name="freeCancellationHours">Hours before check-in for free cancellation.</param>
        /// <param name="penaltySchedule">penaltySchedule.</param>
        public CancellationPolicy(RefundabilityEnum refundability = default, int freeCancellationHours = default, List<CancellationPolicyAllOfPenaltySchedule> penaltySchedule = default)
        {
        ...
        /// </summary>
        /// <value>Hours before check-in for free cancellation</value>
        /*
        <example>24</example>
        */
        [DataMember(Name = "freeCancellationHours", EmitDefaultValue = false)]
        public int FreeCancellationHours { get; set; }

        /// <summary>
        /// Gets or Sets PenaltySchedule
        /// </summary>
        [DataMember(Name = "penaltySchedule", EmitDefaultValue = false)]
        public List<CancellationPolicyAllOfPenaltySchedule> PenaltySchedule { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FreeCancellationHours: ").Append(FreeCancellationHours).Append("\n");
            sb.Append("  PenaltySchedule: ").Append(PenaltySchedule).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
