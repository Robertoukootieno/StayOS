...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "batchProcessPayments_request_payments_inner")]
    public partial class BatchProcessPaymentsRequestPaymentsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchProcessPaymentsRequestPaymentsInner" /> class.
        /// </summary>
        /// <param name="folioId">folioId.</param>
        /// <param name="amount">amount.</param>
        /// <param name="paymentMethod">paymentMethod.</param>
        public BatchProcessPaymentsRequestPaymentsInner(Guid folioId = default, Money amount = default, string paymentMethod = default)
        {
