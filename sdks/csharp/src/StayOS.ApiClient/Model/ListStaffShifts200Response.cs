...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listStaffShifts_200_response")]
    public partial class ListStaffShifts200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListStaffShifts200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListStaffShifts200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListStaffShifts200Response" /> class.
        /// </summary>
        ...
        public ListStaffShifts200Response(List<StaffShift> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListStaffShifts200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListStaffShifts200Response and cannot be null");
            }
