...
namespace StayOS.ApiClient.Model
{
    ...
    /// FolioAllOfTotal
    /// </summary>
    [DataContract(Name = "Folio_allOf_total")]
    public partial class FolioAllOfTotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfTotal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolioAllOfTotal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfTotal" /> class.
        /// </summary>
        ...
        public FolioAllOfTotal(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FolioAllOfTotal and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FolioAllOfTotal and cannot be null");
            }
