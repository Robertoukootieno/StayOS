...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getTaxReport_200_response")]
    public partial class GetTaxReport200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTaxReport200Response" /> class.
        /// </summary>
        /// <param name="totalTax">totalTax.</param>
        /// <param name="breakdown">breakdown.</param>
        public GetTaxReport200Response(Money totalTax = default, List<Object> breakdown = default)
        {
