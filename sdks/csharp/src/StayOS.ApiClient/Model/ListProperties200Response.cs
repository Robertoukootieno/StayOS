...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listProperties_200_response")]
    public partial class ListProperties200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListProperties200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListProperties200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListProperties200Response" /> class.
        /// </summary>
        ...
        public ListProperties200Response(List<Property> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListProperties200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListProperties200Response and cannot be null");
            }
