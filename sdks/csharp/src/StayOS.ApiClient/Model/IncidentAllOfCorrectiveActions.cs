...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Incident_allOf_correctiveActions")]
    public partial class IncidentAllOfCorrectiveActions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncidentAllOfCorrectiveActions" /> class.
        /// </summary>
        /// <param name="action">action.</param>
        /// <param name="takenBy">takenBy.</param>
        /// <param name="takenAt">takenAt.</param>
        public IncidentAllOfCorrectiveActions(string action = default, Guid takenBy = default, DateTime takenAt = default)
        {
            this.Action = action;
        ...
        /// </summary>
        [DataMember(Name = "takenAt", EmitDefaultValue = false)]
