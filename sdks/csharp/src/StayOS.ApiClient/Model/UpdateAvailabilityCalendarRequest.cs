...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAvailabilityCalendar_request")]
    public partial class UpdateAvailabilityCalendarRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAvailabilityCalendarRequest" /> class.
        /// </summary>
        /// <param name="propertyId">propertyId.</param>
        /// <param name="unitTypeId">unitTypeId.</param>
        /// <param name="updates">updates.</param>
        public UpdateAvailabilityCalendarRequest(Guid propertyId = default, Guid unitTypeId = default, List<UpdateAvailabilityCalendarRequestUpdatesInner> updates = default)
        {
        ...
        public List<UpdateAvailabilityCalendarRequestUpdatesInner> Updates { get; set; }
