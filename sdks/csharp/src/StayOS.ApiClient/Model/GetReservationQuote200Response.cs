...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getReservationQuote_200_response")]
    public partial class GetReservationQuote200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReservationQuote200Response" /> class.
        /// </summary>
        ...
        public GetReservationQuote200Response(Guid quoteId = default, Money totalAmount = default, List<Object> breakdown = default, CancellationPolicy cancellationPolicy = default, DateTime validUntil = default)
        {
