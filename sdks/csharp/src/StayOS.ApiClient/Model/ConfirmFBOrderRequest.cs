...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "confirmFBOrder_request")]
    public partial class ConfirmFBOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmFBOrderRequest" /> class.
        /// </summary>
        /// <param name="estimatedDelivery">estimatedDelivery.</param>
        public ConfirmFBOrderRequest(DateTime estimatedDelivery = default)
        {
