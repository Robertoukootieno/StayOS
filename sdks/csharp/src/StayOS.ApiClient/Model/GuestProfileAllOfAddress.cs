...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GuestProfile_allOf_address")]
    public partial class GuestProfileAllOfAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GuestProfileAllOfAddress" /> class.
        /// </summary>
        ...
        public GuestProfileAllOfAddress(string street = default, string city = default, string state = default, string postalCode = default, string country = default)
        {
            this.Street = street;
            this.City = city;
            this.State = state;
