...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listPayments_200_response")]
    public partial class ListPayments200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPayments200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListPayments200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPayments200Response" /> class.
        /// </summary>
        ...
        public ListPayments200Response(List<Payment> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListPayments200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListPayments200Response and cannot be null");
            }
