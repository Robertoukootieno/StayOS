...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "searchAvailability_request_filters")]
    public partial class SearchAvailabilityRequestFilters : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchAvailabilityRequestFilters" /> class.
        /// </summary>
        /// <param name="minPrice">minPrice.</param>
        /// <param name="maxPrice">maxPrice.</param>
        /// <param name="amenities">amenities.</param>
        /// <param name="accessibility">Require wheelchair accessible units.</param>
        public SearchAvailabilityRequestFilters(Money minPrice = default, Money maxPrice = default, List<string> amenities = default, bool accessibility = default)
        {
        ...
        */
        ...
        /// </summary>
        /// <value>Require wheelchair accessible units</value>
