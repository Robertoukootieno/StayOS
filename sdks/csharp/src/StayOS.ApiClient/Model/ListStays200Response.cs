...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listStays_200_response")]
    public partial class ListStays200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListStays200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListStays200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListStays200Response" /> class.
        /// </summary>
        ...
        public ListStays200Response(List<Stay> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListStays200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListStays200Response and cannot be null");
            }
