...
namespace StayOS.ApiClient.Model
{
    ...
    /// FolioAllOfTaxes
    /// </summary>
    [DataContract(Name = "Folio_allOf_taxes")]
    public partial class FolioAllOfTaxes : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfTaxes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolioAllOfTaxes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfTaxes" /> class.
        /// </summary>
        ...
        public FolioAllOfTaxes(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FolioAllOfTaxes and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FolioAllOfTaxes and cannot be null");
            }
