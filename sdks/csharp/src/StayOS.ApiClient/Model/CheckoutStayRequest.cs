...
namespace StayOS.ApiClient.Model
{
    ...
    /// CheckoutStayRequest
    /// </summary>
    [DataContract(Name = "checkoutStay_request")]
    public partial class CheckoutStayRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckoutStayRequest" /> class.
        /// </summary>
        /// <param name="checkoutTime">checkoutTime.</param>
        /// <param name="notes">notes.</param>
        public CheckoutStayRequest(DateTime checkoutTime = default, string notes = default)
        {
