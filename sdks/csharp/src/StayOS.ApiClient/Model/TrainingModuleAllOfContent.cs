...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TrainingModule_allOf_content")]
    public partial class TrainingModuleAllOfContent : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrainingModuleAllOfContent" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="url">url.</param>
        public TrainingModuleAllOfContent(TypeEnum? type = default, string url = default)
        {
            this.Type = type;
            this.Url = url;
        }
