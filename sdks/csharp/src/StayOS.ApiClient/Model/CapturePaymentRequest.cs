...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "capturePayment_request")]
    public partial class CapturePaymentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CapturePaymentRequest" /> class.
        /// </summary>
        /// <param name="amount">amount.</param>
        public CapturePaymentRequest(Money amount = default)
        {
            this.Amount = amount;
        }
