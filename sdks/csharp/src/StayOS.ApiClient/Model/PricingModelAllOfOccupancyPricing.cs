...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PricingModel_allOf_occupancyPricing")]
    public partial class PricingModelAllOfOccupancyPricing : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModelAllOfOccupancyPricing" /> class.
        /// </summary>
        /// <param name="enabled">enabled (default to false).</param>
        /// <param name="baseOccupancy">baseOccupancy.</param>
        /// <param name="additionalGuestCharge">additionalGuestCharge.</param>
        public PricingModelAllOfOccupancyPricing(bool enabled = false, int baseOccupancy = default, Model0 additionalGuestCharge = default)
        {
        ...
        /// <summary>
        /// Gets or Sets BaseOccupancy
        /// </summary>
        /*
        <example>2</example>
        */
        [DataMember(Name = "baseOccupancy", EmitDefaultValue = false)]
        public int BaseOccupancy { get; set; }

        /// <summary>
        /// Gets or Sets AdditionalGuestCharge
        /// </summary>
        [DataMember(Name = "additionalGuestCharge", EmitDefaultValue = false)]
        public Model0 AdditionalGuestCharge { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BaseOccupancy: ").Append(BaseOccupancy).Append("\n");
            sb.Append("  AdditionalGuestCharge: ").Append(AdditionalGuestCharge).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
