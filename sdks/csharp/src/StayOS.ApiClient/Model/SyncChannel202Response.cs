...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "syncChannel_202_response")]
    public partial class SyncChannel202Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncChannel202Response" /> class.
        /// </summary>
        /// <param name="syncId">syncId.</param>
        /// <param name="status">status.</param>
        public SyncChannel202Response(Guid syncId = default, string status = default)
        {
            this.SyncId = syncId;
            this.Status = status;
        }
