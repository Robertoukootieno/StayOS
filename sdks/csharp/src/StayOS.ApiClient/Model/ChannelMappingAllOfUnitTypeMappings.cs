...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelMapping_allOf_unitTypeMappings")]
    public partial class ChannelMappingAllOfUnitTypeMappings : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelMappingAllOfUnitTypeMappings" /> class.
        /// </summary>
        /// <param name="internalUnitTypeId">internalUnitTypeId.</param>
        /// <param name="channelRoomTypeId">channelRoomTypeId.</param>
        /// <param name="channelRoomTypeName">channelRoomTypeName.</param>
        public ChannelMappingAllOfUnitTypeMappings(Guid internalUnitTypeId = default, string channelRoomTypeId = default, string channelRoomTypeName = default)
        {
        ...
        /// <summary>
        /// Gets or Sets InternalUnitTypeId
        /// </summary>
        [DataMember(Name = "internalUnitTypeId", EmitDefaultValue = false)]
        public Guid InternalUnitTypeId { get; set; }

        /// <summary>
        /// Gets or Sets ChannelRoomTypeId
        /// </summary>
        [DataMember(Name = "channelRoomTypeId", EmitDefaultValue = false)]
        public string ChannelRoomTypeId { get; set; }

        /// <summary>
        /// Gets or Sets ChannelRoomTypeName
        /// </summary>
        [DataMember(Name = "channelRoomTypeName", EmitDefaultValue = false)]
        public string ChannelRoomTypeName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InternalUnitTypeId: ").Append(InternalUnitTypeId).Append("\n");
            sb.Append("  ChannelRoomTypeId: ").Append(ChannelRoomTypeId).Append("\n");
            sb.Append("  ChannelRoomTypeName: ").Append(ChannelRoomTypeName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
