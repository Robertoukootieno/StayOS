...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSystemHealth_200_response")]
    public partial class GetSystemHealth200Response : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSystemHealth200Response" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="varVersion">varVersion.</param>
        /// <param name="timestamp">timestamp.</param>
        /// <param name="services">services.</param>
        public GetSystemHealth200Response(StatusEnum? status = default, string varVersion = default, DateTime timestamp = default, Object services = default)
        {
            this.Status = status;
