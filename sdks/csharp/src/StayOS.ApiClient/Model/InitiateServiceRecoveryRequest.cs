...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "initiateServiceRecovery_request")]
    public partial class InitiateServiceRecoveryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateServiceRecoveryRequest" /> class.
        /// </summary>
        /// <param name="actions">actions.</param>
        /// <param name="compensation">compensation.</param>
        /// <param name="notes">notes.</param>
        public InitiateServiceRecoveryRequest(List<string> actions = default, Money compensation = default, string notes = default)
        {
