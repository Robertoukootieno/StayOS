...
namespace StayOS.ApiClient.Model
{
    ...
    /// SearchGuestsRequest
    /// </summary>
    [DataContract(Name = "searchGuests_request")]
    public partial class SearchGuestsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchGuestsRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="email">email.</param>
        /// <param name="phone">phone.</param>
        /// <param name="loyaltyTier">loyaltyTier.</param>
        public SearchGuestsRequest(string name = default, string email = default, string phone = default, string loyaltyTier = default)
        {
            this.Name = name;
            this.Email = email;
            this.Phone = phone;
