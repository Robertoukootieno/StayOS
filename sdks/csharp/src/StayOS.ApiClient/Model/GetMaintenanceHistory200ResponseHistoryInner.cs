...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getMaintenanceHistory_200_response_history_inner")]
    public partial class GetMaintenanceHistory200ResponseHistoryInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMaintenanceHistory200ResponseHistoryInner" /> class.
        /// </summary>
        /// <param name="timestamp">timestamp.</param>
        /// <param name="action">action.</param>
        /// <param name="performedBy">performedBy.</param>
        /// <param name="notes">notes.</param>
        public GetMaintenanceHistory200ResponseHistoryInner(DateTime timestamp = default, string action = default, Guid performedBy = default, string notes = default)
        {
        ...
        /// <summary>
        /// Gets or Sets PerformedBy
        /// </summary>
        [DataMember(Name = "performedBy", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PerformedBy: ").Append(PerformedBy).Append("\n");
