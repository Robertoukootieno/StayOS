...
namespace StayOS.ApiClient.Model
{
    ...
    /// UnitTypeAllOfPhotos
    /// </summary>
    [DataContract(Name = "UnitType_allOf_photos")]
    public partial class UnitTypeAllOfPhotos : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitTypeAllOfPhotos" /> class.
        /// </summary>
        /// <param name="url">url.</param>
        /// <param name="caption">caption.</param>
        /// <param name="isPrimary">isPrimary.</param>
        public UnitTypeAllOfPhotos(string url = default, string caption = default, bool isPrimary = default)
        {
            this.Url = url;
