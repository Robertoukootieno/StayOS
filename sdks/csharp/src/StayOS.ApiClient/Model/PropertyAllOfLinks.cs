...
namespace StayOS.ApiClient.Model
{
    ...
    /// HATEOAS links
    /// </summary>
    [DataContract(Name = "Property_allOf_links")]
    public partial class PropertyAllOfLinks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyAllOfLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="inventoryUnits">inventoryUnits.</param>
        /// <param name="rateStrategies">rateStrategies.</param>
        /// <param name="reservations">reservations.</param>
        public PropertyAllOfLinks(string self = default, string inventoryUnits = default, string rateStrategies = default, string reservations = default)
        {
            this.Self = self;
        ...
        /// <summary>
        /// Gets or Sets InventoryUnits
        /// </summary>
        [DataMember(Name = "inventoryUnits", EmitDefaultValue = false)]
        public string InventoryUnits { get; set; }

        /// <summary>
        /// Gets or Sets RateStrategies
        /// </summary>
        [DataMember(Name = "rateStrategies", EmitDefaultValue = false)]
        public string RateStrategies { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InventoryUnits: ").Append(InventoryUnits).Append("\n");
            sb.Append("  RateStrategies: ").Append(RateStrategies).Append("\n");
