...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listRateStrategies_200_response")]
    public partial class ListRateStrategies200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListRateStrategies200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListRateStrategies200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListRateStrategies200Response" /> class.
        /// </summary>
        ...
        public ListRateStrategies200Response(List<RateStrategy> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListRateStrategies200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListRateStrategies200Response and cannot be null");
            }
        ...
        public List<RateStrategy> Data { get; set; }
