...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Incident_allOf_witnesses")]
    public partial class IncidentAllOfWitnesses : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncidentAllOfWitnesses" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="contactInfo">contactInfo.</param>
        /// <param name="statement">statement.</param>
        public IncidentAllOfWitnesses(string name = default, string contactInfo = default, string statement = default)
        {
            this.Name = name;
