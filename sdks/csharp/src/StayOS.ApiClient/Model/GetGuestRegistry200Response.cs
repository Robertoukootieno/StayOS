...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getGuestRegistry_200_response")]
    public partial class GetGuestRegistry200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGuestRegistry200Response" /> class.
        /// </summary>
        /// <param name="guests">guests.</param>
        public GetGuestRegistry200Response(List<Object> guests = default)
        {
            this.Guests = guests;
        }
