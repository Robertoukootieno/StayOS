...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MaintenanceRequest_allOf_workLog")]
    public partial class MaintenanceRequestAllOfWorkLog : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaintenanceRequestAllOfWorkLog" /> class.
        /// </summary>
        /// <param name="timestamp">timestamp.</param>
        /// <param name="technician">technician.</param>
        /// <param name="action">action.</param>
        /// <param name="notes">notes.</param>
        public MaintenanceRequestAllOfWorkLog(DateTime timestamp = default, Guid technician = default, string action = default, string notes = default)
        {
