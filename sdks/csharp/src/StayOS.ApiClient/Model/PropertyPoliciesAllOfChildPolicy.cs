...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PropertyPolicies_allOf_childPolicy")]
    public partial class PropertyPoliciesAllOfChildPolicy : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyPoliciesAllOfChildPolicy" /> class.
        /// </summary>
        /// <param name="childrenAllowed">childrenAllowed (default to true).</param>
        /// <param name="freeChildAge">Maximum age for free child stay.</param>
        public PropertyPoliciesAllOfChildPolicy(bool childrenAllowed = true, int freeChildAge = default)
        {
        ...
        /// <summary>
        /// Gets or Sets ChildrenAllowed
        /// </summary>
        [DataMember(Name = "childrenAllowed", EmitDefaultValue = true)]
        public bool ChildrenAllowed { get; set; }

        /// <summary>
        /// Maximum age for free child stay
        /// </summary>
        /// <value>Maximum age for free child stay</value>
        /*
        <example>12</example>
        */
        [DataMember(Name = "freeChildAge", EmitDefaultValue = false)]
        public int FreeChildAge { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ChildrenAllowed: ").Append(ChildrenAllowed).Append("\n");
            sb.Append("  FreeChildAge: ").Append(FreeChildAge).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
