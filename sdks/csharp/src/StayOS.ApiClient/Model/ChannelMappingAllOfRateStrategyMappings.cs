...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelMapping_allOf_rateStrategyMappings")]
    public partial class ChannelMappingAllOfRateStrategyMappings : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelMappingAllOfRateStrategyMappings" /> class.
        /// </summary>
        /// <param name="internalRateStrategyId">internalRateStrategyId.</param>
        /// <param name="channelRatePlanId">channelRatePlanId.</param>
        /// <param name="channelRatePlanName">channelRatePlanName.</param>
        public ChannelMappingAllOfRateStrategyMappings(Guid internalRateStrategyId = default, string channelRatePlanId = default, string channelRatePlanName = default)
        {
        ...
        /// <summary>
        /// Gets or Sets InternalRateStrategyId
        /// </summary>
        [DataMember(Name = "internalRateStrategyId", EmitDefaultValue = false)]
        public Guid InternalRateStrategyId { get; set; }

        /// <summary>
        /// Gets or Sets ChannelRatePlanId
        /// </summary>
        [DataMember(Name = "channelRatePlanId", EmitDefaultValue = false)]
        public string ChannelRatePlanId { get; set; }

        /// <summary>
        /// Gets or Sets ChannelRatePlanName
        /// </summary>
        [DataMember(Name = "channelRatePlanName", EmitDefaultValue = false)]
        public string ChannelRatePlanName { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InternalRateStrategyId: ").Append(InternalRateStrategyId).Append("\n");
            sb.Append("  ChannelRatePlanId: ").Append(ChannelRatePlanId).Append("\n");
            sb.Append("  ChannelRatePlanName: ").Append(ChannelRatePlanName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
