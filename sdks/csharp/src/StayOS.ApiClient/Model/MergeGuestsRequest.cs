...
namespace StayOS.ApiClient.Model
{
    ...
    /// MergeGuestsRequest
    /// </summary>
    [DataContract(Name = "mergeGuests_request")]
    public partial class MergeGuestsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MergeGuestsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MergeGuestsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MergeGuestsRequest" /> class.
        /// </summary>
        /// <param name="primaryGuestId">primaryGuestId (required).</param>
        /// <param name="secondaryGuestId">secondaryGuestId (required).</param>
        public MergeGuestsRequest(Guid primaryGuestId = default, Guid secondaryGuestId = default)
        {
        ...
        /// <summary>
        /// Gets or Sets PrimaryGuestId
        /// </summary>
        [DataMember(Name = "primaryGuestId", IsRequired = true, EmitDefaultValue = true)]
        public Guid PrimaryGuestId { get; set; }

        /// <summary>
        /// Gets or Sets SecondaryGuestId
        /// </summary>
        [DataMember(Name = "secondaryGuestId", IsRequired = true, EmitDefaultValue = true)]
        public Guid SecondaryGuestId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrimaryGuestId: ").Append(PrimaryGuestId).Append("\n");
            sb.Append("  SecondaryGuestId: ").Append(SecondaryGuestId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
