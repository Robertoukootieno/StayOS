...
namespace StayOS.ApiClient.Model
{
    ...
    /// FBOrderAllOfTax
    /// </summary>
    [DataContract(Name = "FBOrder_allOf_tax")]
    public partial class FBOrderAllOfTax : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfTax" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FBOrderAllOfTax() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfTax" /> class.
        /// </summary>
        ...
        public FBOrderAllOfTax(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FBOrderAllOfTax and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FBOrderAllOfTax and cannot be null");
            }
