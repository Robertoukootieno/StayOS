...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Feedback_allOf_response")]
    public partial class FeedbackAllOfResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeedbackAllOfResponse" /> class.
        /// </summary>
        /// <param name="respondedBy">respondedBy.</param>
        /// <param name="respondedAt">respondedAt.</param>
        /// <param name="message">message.</param>
        public FeedbackAllOfResponse(Guid respondedBy = default, DateTime respondedAt = default, string message = default)
        {
        ...
        /// <summary>
        /// Gets or Sets RespondedBy
        /// </summary>
        [DataMember(Name = "respondedBy", EmitDefaultValue = false)]
        public Guid RespondedBy { get; set; }

        /// <summary>
        /// Gets or Sets RespondedAt
        /// </summary>
        [DataMember(Name = "respondedAt", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RespondedBy: ").Append(RespondedBy).Append("\n");
            sb.Append("  RespondedAt: ").Append(RespondedAt).Append("\n");
