...
namespace StayOS.ApiClient.Model
{
    ...
    /// ReviewAllOfResponse
    /// </summary>
    [DataContract(Name = "Review_allOf_response")]
    public partial class ReviewAllOfResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewAllOfResponse" /> class.
        /// </summary>
        /// <param name="respondedBy">respondedBy.</param>
        /// <param name="respondedAt">respondedAt.</param>
        /// <param name="message">message.</param>
        public ReviewAllOfResponse(string respondedBy = default, DateTime respondedAt = default, string message = default)
        {
