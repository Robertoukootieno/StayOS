...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addLoyaltyPoints_200_response")]
    public partial class AddLoyaltyPoints200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddLoyaltyPoints200Response" /> class.
        /// </summary>
        /// <param name="newBalance">newBalance.</param>
        public AddLoyaltyPoints200Response(int newBalance = default)
        {
