...
namespace StayOS.ApiClient.Model
{
    ...
    /// FBOrderAllOfTotal
    /// </summary>
    [DataContract(Name = "FBOrder_allOf_total")]
    public partial class FBOrderAllOfTotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfTotal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FBOrderAllOfTotal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfTotal" /> class.
        /// </summary>
        ...
        public FBOrderAllOfTotal(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FBOrderAllOfTotal and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FBOrderAllOfTotal and cannot be null");
            }
