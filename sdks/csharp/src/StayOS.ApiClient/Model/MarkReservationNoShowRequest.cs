...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "markReservationNoShow_request")]
    public partial class MarkReservationNoShowRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkReservationNoShowRequest" /> class.
        /// </summary>
        /// <param name="notes">notes.</param>
        public MarkReservationNoShowRequest(string notes = default)
        {
            this.Notes = notes;
        }
