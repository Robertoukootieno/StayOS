...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "refundPayment_request")]
    public partial class RefundPaymentRequest : IValidatableObject
    {
        /// <summary>
        ...
        public RefundPaymentRequest(Money amount = default, string reason = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for RefundPaymentRequest and cannot be null");
            }
            this.Amount = amount;
            this.Reason = reason;
        }
