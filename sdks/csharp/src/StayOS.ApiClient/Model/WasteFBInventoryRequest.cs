...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "wasteFBInventory_request")]
    public partial class WasteFBInventoryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteFBInventoryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WasteFBInventoryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteFBInventoryRequest" /> class.
        /// </summary>
        ...
        public WasteFBInventoryRequest(float quantity = default, string reason = default, string notes = default)
        {
            this.Quantity = quantity;
            // to ensure "reason" is required (not null)
            if (reason == null)
            {
                throw new ArgumentNullException("reason is a required property for WasteFBInventoryRequest and cannot be null");
            }
            this.Reason = reason;
            this.Notes = notes;
        }
