...
namespace StayOS.ApiClient.Model
{
    ...
    /// ChannelAllOfLinks
    /// </summary>
    [DataContract(Name = "Channel_allOf_links")]
    public partial class ChannelAllOfLinks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelAllOfLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="mappings">mappings.</param>
        /// <param name="performance">performance.</param>
        public ChannelAllOfLinks(string self = default, string mappings = default, string performance = default)
        {
            this.Self = self;
