...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicabilityRules_allOf_advanceBookingWindow")]
    public partial class ApplicabilityRulesAllOfAdvanceBookingWindow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicabilityRulesAllOfAdvanceBookingWindow" /> class.
        /// </summary>
        /// <param name="minimumDays">Minimum days before check-in.</param>
        /// <param name="maximumDays">Maximum days before check-in.</param>
        public ApplicabilityRulesAllOfAdvanceBookingWindow(int minimumDays = default, int maximumDays = default)
        {
        ...
        /// </summary>
        /// <value>Minimum days before check-in</value>
        /*
        <example>0</example>
        */
        ...
        /// </summary>
        /// <value>Maximum days before check-in</value>
        /*
        <example>365</example>
        */
