...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAvailabilityCalendar_request_updates_inner")]
    public partial class UpdateAvailabilityCalendarRequestUpdatesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAvailabilityCalendarRequestUpdatesInner" /> class.
        /// </summary>
        /// <param name="date">date.</param>
        /// <param name="available">available.</param>
        /// <param name="rate">rate.</param>
        /// <param name="restrictions">restrictions.</param>
        public UpdateAvailabilityCalendarRequestUpdatesInner(DateTime date = default, int available = default, Money rate = default, Object restrictions = default)
        {
            this.Date = date;
