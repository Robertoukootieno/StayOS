...
namespace StayOS.ApiClient.Model
{
    ...
    /// VerifyGuestRequest
    /// </summary>
    [DataContract(Name = "verifyGuest_request")]
    public partial class VerifyGuestRequest : IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum IDDOCUMENT for value: ID_DOCUMENT
            /// </summary>
            [EnumMember(Value = "ID_DOCUMENT")]
            IDDOCUMENT = 1,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifyGuestRequest" /> class.
        /// </summary>
        /// <param name="verificationType">verificationType.</param>
        /// <param name="verificationData">verificationData.</param>
        public VerifyGuestRequest(VerificationTypeEnum? verificationType = default, Object verificationData = default)
        {
        ...
        /// <summary>
        /// Gets or Sets VerificationData
        /// </summary>
        [DataMember(Name = "verificationData", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VerificationData: ").Append(VerificationData).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
