...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "countFBInventory_200_response")]
    public partial class CountFBInventory200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountFBInventory200Response" /> class.
        /// </summary>
        /// <param name="discrepancies">discrepancies.</param>
        public CountFBInventory200Response(List<Object> discrepancies = default)
        {
        ...
        public List<Object> Discrepancies { get; set; }
