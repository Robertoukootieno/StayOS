...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Channel_allOf_credentials")]
    public partial class ChannelAllOfCredentials : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelAllOfCredentials" /> class.
        /// </summary>
        /// <param name="apiKey">apiKey.</param>
        /// <param name="apiSecret">apiSecret.</param>
        /// <param name="hotelId">hotelId.</param>
        public ChannelAllOfCredentials(string apiKey = default, string apiSecret = default, string hotelId = default)
        {
            this.ApiKey = apiKey;
