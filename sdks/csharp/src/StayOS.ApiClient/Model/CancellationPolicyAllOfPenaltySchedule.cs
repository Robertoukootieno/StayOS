...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CancellationPolicy_allOf_penaltySchedule")]
    public partial class CancellationPolicyAllOfPenaltySchedule : IValidatableObject
    {
        /// <summary>
        /// Defines PenaltyType
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name = "penaltyType", EmitDefaultValue = false)]
        public PenaltyTypeEnum? PenaltyType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="CancellationPolicyAllOfPenaltySchedule" /> class.
        /// </summary>
        /// <param name="hoursBeforeCheckIn">hoursBeforeCheckIn.</param>
        /// <param name="penaltyType">penaltyType.</param>
        /// <param name="penaltyValue">penaltyValue.</param>
        /// <param name="description">description.</param>
        public CancellationPolicyAllOfPenaltySchedule(int hoursBeforeCheckIn = default, PenaltyTypeEnum? penaltyType = default, decimal penaltyValue = default, string description = default)
        {
        ...
        /// <summary>
        /// Gets or Sets HoursBeforeCheckIn
        /// </summary>
        /*
        <example>24</example>
        */
        [DataMember(Name = "hoursBeforeCheckIn", EmitDefaultValue = false)]
        ...
        <example>50</example>
        */
        [DataMember(Name = "penaltyValue", EmitDefaultValue = false)]
        ...
        /// </summary>
        /*
        <example>50% charge if cancelled within 24 hours</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HoursBeforeCheckIn: ").Append(HoursBeforeCheckIn).Append("\n");
