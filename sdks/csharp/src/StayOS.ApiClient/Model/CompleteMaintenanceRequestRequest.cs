...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "completeMaintenanceRequest_request")]
    public partial class CompleteMaintenanceRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompleteMaintenanceRequestRequest" /> class.
        /// </summary>
        /// <param name="notes">notes.</param>
        /// <param name="partsUsed">partsUsed.</param>
        public CompleteMaintenanceRequestRequest(string notes = default, List<CompleteMaintenanceRequestRequestPartsUsedInner> partsUsed = default)
        {
            this.Notes = notes;
        ...
        public List<CompleteMaintenanceRequestRequestPartsUsedInner> PartsUsed { get; set; }
