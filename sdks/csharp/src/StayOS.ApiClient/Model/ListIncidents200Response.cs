...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listIncidents_200_response")]
    public partial class ListIncidents200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListIncidents200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListIncidents200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListIncidents200Response" /> class.
        /// </summary>
        ...
        public ListIncidents200Response(List<Incident> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListIncidents200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListIncidents200Response and cannot be null");
            }
