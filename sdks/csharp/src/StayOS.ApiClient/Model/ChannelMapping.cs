...
namespace StayOS.ApiClient.Model
{
    ...
    /// ChannelMapping
    /// </summary>
    [DataContract(Name = "ChannelMapping")]
    public partial class ChannelMapping : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="unitTypeMappings">unitTypeMappings.</param>
        /// <param name="rateStrategyMappings">rateStrategyMappings.</param>
        public ChannelMapping(Guid channelId = default, Guid propertyId = default, List<ChannelMappingAllOfUnitTypeMappings> unitTypeMappings = default, List<ChannelMappingAllOfRateStrategyMappings> rateStrategyMappings = default)
        {
        ...
        /// <summary>
        /// Gets or Sets UnitTypeMappings
        /// </summary>
        [DataMember(Name = "unitTypeMappings", EmitDefaultValue = false)]
        public List<ChannelMappingAllOfUnitTypeMappings> UnitTypeMappings { get; set; }

        /// <summary>
        /// Gets or Sets RateStrategyMappings
        /// </summary>
        [DataMember(Name = "rateStrategyMappings", EmitDefaultValue = false)]
        public List<ChannelMappingAllOfRateStrategyMappings> RateStrategyMappings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UnitTypeMappings: ").Append(UnitTypeMappings).Append("\n");
            sb.Append("  RateStrategyMappings: ").Append(RateStrategyMappings).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
