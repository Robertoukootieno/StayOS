...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "assignMaintenanceRequest_request")]
    public partial class AssignMaintenanceRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignMaintenanceRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssignMaintenanceRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignMaintenanceRequestRequest" /> class.
        /// </summary>
        /// <param name="assignedTo">Technician ID (required).</param>
        public AssignMaintenanceRequestRequest(Guid assignedTo = default)
        {
