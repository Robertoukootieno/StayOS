...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemMetrics_allOf_cache")]
    public partial class SystemMetricsAllOfCache : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemMetricsAllOfCache" /> class.
        /// </summary>
        /// <param name="hitRate">Cache hit rate percentage.</param>
        /// <param name="memoryUsage">Memory usage in MB.</param>
        public SystemMetricsAllOfCache(float hitRate = default, float memoryUsage = default)
        {
        ...
        /// </summary>
        /// <value>Cache hit rate percentage</value>
        [DataMember(Name = "hitRate", EmitDefaultValue = false)]
        public float HitRate { get; set; }

        /// <summary>
        /// Memory usage in MB
        /// </summary>
        /// <value>Memory usage in MB</value>
