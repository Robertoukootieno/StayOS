...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "countFBInventory_request_counts_inner")]
    public partial class CountFBInventoryRequestCountsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountFBInventoryRequestCountsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CountFBInventoryRequestCountsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CountFBInventoryRequestCountsInner" /> class.
        /// </summary>
        /// <param name="itemId">itemId (required).</param>
        /// <param name="quantity">quantity (required).</param>
        public CountFBInventoryRequestCountsInner(Guid itemId = default, float quantity = default)
        {
            this.ItemId = itemId;
