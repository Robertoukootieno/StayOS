...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "invoicePurchaseOrder_request")]
    public partial class InvoicePurchaseOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicePurchaseOrderRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoicePurchaseOrderRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicePurchaseOrderRequest" /> class.
        /// </summary>
        ...
        public InvoicePurchaseOrderRequest(string invoiceNumber = default, Money amount = default, DateTime invoiceDate = default)
        {
            // to ensure "invoiceNumber" is required (not null)
            if (invoiceNumber == null)
            {
                throw new ArgumentNullException("invoiceNumber is a required property for InvoicePurchaseOrderRequest and cannot be null");
            }
            this.InvoiceNumber = invoiceNumber;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for InvoicePurchaseOrderRequest and cannot be null");
            }
            this.Amount = amount;
