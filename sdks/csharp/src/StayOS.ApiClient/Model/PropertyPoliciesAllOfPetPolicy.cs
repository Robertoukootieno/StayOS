...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PropertyPolicies_allOf_petPolicy")]
    public partial class PropertyPoliciesAllOfPetPolicy : IValidatableObject
    {
        /// <summary>
        /// Defines PetTypes
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyPoliciesAllOfPetPolicy" /> class.
        /// </summary>
        /// <param name="petsAllowed">petsAllowed (default to false).</param>
        /// <param name="petFee">petFee.</param>
        /// <param name="petTypes">petTypes.</param>
        public PropertyPoliciesAllOfPetPolicy(bool petsAllowed = false, Model0 petFee = default, List<PetTypesEnum> petTypes = default)
        {
        ...
        /// <summary>
        /// Gets or Sets PetsAllowed
        /// </summary>
        [DataMember(Name = "petsAllowed", EmitDefaultValue = true)]
        public bool PetsAllowed { get; set; }

        /// <summary>
        /// Gets or Sets PetFee
        /// </summary>
        [DataMember(Name = "petFee", EmitDefaultValue = false)]
        public Model0 PetFee { get; set; }

        /// <summary>
        /// Gets or Sets PetTypes
        /// </summary>
        [DataMember(Name = "petTypes", EmitDefaultValue = false)]
        public List<PropertyPoliciesAllOfPetPolicy.PetTypesEnum> PetTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PetsAllowed: ").Append(PetsAllowed).Append("\n");
            sb.Append("  PetFee: ").Append(PetFee).Append("\n");
            sb.Append("  PetTypes: ").Append(PetTypes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
