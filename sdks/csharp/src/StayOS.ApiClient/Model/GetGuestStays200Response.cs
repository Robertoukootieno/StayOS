...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getGuestStays_200_response")]
    public partial class GetGuestStays200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGuestStays200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetGuestStays200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGuestStays200Response" /> class.
        /// </summary>
        ...
        public GetGuestStays200Response(List<Object> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetGuestStays200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for GetGuestStays200Response and cannot be null");
            }
