...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "exportGuestData_request")]
    public partial class ExportGuestDataRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportGuestDataRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExportGuestDataRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportGuestDataRequest" /> class.
        /// </summary>
        /// <param name="guestId">guestId (required).</param>
        public ExportGuestDataRequest(Guid guestId = default)
        {
