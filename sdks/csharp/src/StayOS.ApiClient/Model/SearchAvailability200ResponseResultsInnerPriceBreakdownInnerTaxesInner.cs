...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "searchAvailability_200_response_results_inner_priceBreakdown_inner_taxes_inner")]
    public partial class SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="amount">amount.</param>
        public SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner(string name = default, Money amount = default)
        {
            this.Name = name;
            this.Amount = amount;
        }
