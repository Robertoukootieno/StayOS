...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "respondToFeedback_request")]
    public partial class RespondToFeedbackRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RespondToFeedbackRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RespondToFeedbackRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RespondToFeedbackRequest" /> class.
        /// </summary>
        /// <param name="message">message (required).</param>
        public RespondToFeedbackRequest(string message = default)
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for RespondToFeedbackRequest and cannot be null");
            }
