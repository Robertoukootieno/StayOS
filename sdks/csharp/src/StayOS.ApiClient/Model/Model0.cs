...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "0")]
    public partial class Model0 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Model0" /> class.
        /// </summary>
        ...
        public Model0(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for Model0 and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for Model0 and cannot be null");
            }
