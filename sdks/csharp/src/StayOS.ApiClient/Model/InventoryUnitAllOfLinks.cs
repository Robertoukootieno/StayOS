...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InventoryUnit_allOf_links")]
    public partial class InventoryUnitAllOfLinks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryUnitAllOfLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="property">property.</param>
        /// <param name="availability">availability.</param>
        /// <param name="currentReservation">currentReservation.</param>
        public InventoryUnitAllOfLinks(string self = default, string property = default, string availability = default, string currentReservation = default)
        {
            this.Self = self;
        ...
        /// <summary>
        /// Gets or Sets CurrentReservation
        /// </summary>
        [DataMember(Name = "currentReservation", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CurrentReservation: ").Append(CurrentReservation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
