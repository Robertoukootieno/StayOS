...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "completeHousekeepingTask_request")]
    public partial class CompleteHousekeepingTaskRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompleteHousekeepingTaskRequest" /> class.
        /// </summary>
        /// <param name="notes">notes.</param>
        /// <param name="issues">issues.</param>
        public CompleteHousekeepingTaskRequest(string notes = default, List<string> issues = default)
        {
            this.Notes = notes;
            this.Issues = issues;
        }
