...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deleteGuestData_200_response")]
    public partial class DeleteGuestData200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteGuestData200Response" /> class.
        /// </summary>
        /// <param name="requestId">requestId.</param>
        /// <param name="status">status.</param>
        public DeleteGuestData200Response(Guid requestId = default, string status = default)
        {
