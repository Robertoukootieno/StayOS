...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSystemStatus_200_response_components_value")]
    public partial class GetSystemStatus200ResponseComponentsValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSystemStatus200ResponseComponentsValue" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="lastCheck">lastCheck.</param>
        public GetSystemStatus200ResponseComponentsValue(string status = default, DateTime lastCheck = default)
        {
            this.Status = status;
