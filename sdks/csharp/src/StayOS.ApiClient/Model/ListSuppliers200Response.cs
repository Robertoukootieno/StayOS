...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listSuppliers_200_response")]
    public partial class ListSuppliers200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSuppliers200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListSuppliers200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSuppliers200Response" /> class.
        /// </summary>
        ...
        public ListSuppliers200Response(List<Supplier> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListSuppliers200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListSuppliers200Response and cannot be null");
            }
