...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AvailabilityCalendar")]
    public partial class AvailabilityCalendar : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AvailabilityCalendar" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="AvailabilityCalendar" /> class.
        /// </summary>
        /// <param name="inventoryUnitId">inventoryUnitId (required).</param>
        /// <param name="dateRange">dateRange (required).</param>
        /// <param name="slots">slots.</param>
        public AvailabilityCalendar(Guid inventoryUnitId = default, AvailabilityCalendarAllOfDateRange dateRange = default, List<Model0> slots = default)
        {
            this.InventoryUnitId = inventoryUnitId;
            // to ensure "dateRange" is required (not null)
            if (dateRange == null)
            {
                throw new ArgumentNullException("dateRange is a required property for AvailabilityCalendar and cannot be null");
            }
        ...
        */
        ...
        public AvailabilityCalendarAllOfDateRange DateRange { get; set; }

        /// <summary>
        /// Gets or Sets Slots
        /// </summary>
        [DataMember(Name = "slots", EmitDefaultValue = false)]
        public List<Model0> Slots { get; set; }
