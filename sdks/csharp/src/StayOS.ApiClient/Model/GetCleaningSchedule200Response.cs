...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getCleaningSchedule_200_response")]
    public partial class GetCleaningSchedule200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCleaningSchedule200Response" /> class.
        /// </summary>
        /// <param name="date">date.</param>
        /// <param name="tasks">tasks.</param>
        public GetCleaningSchedule200Response(DateTime date = default, List<HousekeepingTask> tasks = default)
        {
            this.Date = date;
            this.Tasks = tasks;
        }
        ...
        public List<HousekeepingTask> Tasks { get; set; }
