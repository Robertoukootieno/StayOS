...
namespace StayOS.ApiClient.Model
{
    ...
    /// FolioAllOfSubtotal
    /// </summary>
    [DataContract(Name = "Folio_allOf_subtotal")]
    public partial class FolioAllOfSubtotal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfSubtotal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolioAllOfSubtotal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfSubtotal" /> class.
        /// </summary>
        ...
        public FolioAllOfSubtotal(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FolioAllOfSubtotal and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FolioAllOfSubtotal and cannot be null");
            }
