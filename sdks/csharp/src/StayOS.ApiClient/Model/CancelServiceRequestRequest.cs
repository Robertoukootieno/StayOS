...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cancelServiceRequest_request")]
    public partial class CancelServiceRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelServiceRequestRequest" /> class.
        /// </summary>
        /// <param name="reason">reason.</param>
        public CancelServiceRequestRequest(string reason = default)
        {
            this.Reason = reason;
        }
