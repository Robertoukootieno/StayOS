...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "receivePurchaseOrder_request_receivedItems_inner")]
    public partial class ReceivePurchaseOrderRequestReceivedItemsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivePurchaseOrderRequestReceivedItemsInner" /> class.
        /// </summary>
        /// <param name="itemId">itemId.</param>
        /// <param name="quantityReceived">quantityReceived.</param>
        public ReceivePurchaseOrderRequestReceivedItemsInner(string itemId = default, int quantityReceived = default)
        {
            this.ItemId = itemId;
