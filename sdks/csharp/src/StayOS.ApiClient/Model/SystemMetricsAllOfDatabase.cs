...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemMetrics_allOf_database")]
    public partial class SystemMetricsAllOfDatabase : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemMetricsAllOfDatabase" /> class.
        /// </summary>
        /// <param name="connections">connections.</param>
        /// <param name="queryTime">Average query time in milliseconds.</param>
        public SystemMetricsAllOfDatabase(int connections = default, float queryTime = default)
        {
        ...
        /// </summary>
        /// <value>Average query time in milliseconds</value>
