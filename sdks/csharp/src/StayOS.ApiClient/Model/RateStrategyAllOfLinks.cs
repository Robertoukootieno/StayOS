...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RateStrategy_allOf_links")]
    public partial class RateStrategyAllOfLinks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateStrategyAllOfLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="property">property.</param>
        public RateStrategyAllOfLinks(string self = default, string property = default)
        {
            this.Self = self;
