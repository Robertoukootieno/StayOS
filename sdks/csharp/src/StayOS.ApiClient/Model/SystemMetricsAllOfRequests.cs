...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemMetrics_allOf_requests")]
    public partial class SystemMetricsAllOfRequests : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemMetricsAllOfRequests" /> class.
        /// </summary>
        ...
        public SystemMetricsAllOfRequests(int total = default, int successful = default, int failed = default, float averageResponseTime = default)
        {
            this.Total = total;
