...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getWebhookDeliveries_200_response")]
    public partial class GetWebhookDeliveries200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhookDeliveries200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWebhookDeliveries200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhookDeliveries200Response" /> class.
        /// </summary>
        ...
        public GetWebhookDeliveries200Response(List<WebhookDelivery> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for GetWebhookDeliveries200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for GetWebhookDeliveries200Response and cannot be null");
            }
