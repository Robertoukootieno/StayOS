...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaginatedResponse_allOf_links")]
    public partial class PaginatedResponseAllOfLinks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponseAllOfLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="next">next.</param>
        /// <param name="prev">prev.</param>
        public PaginatedResponseAllOfLinks(string self = default, string next = default, string prev = default)
        {
            this.Self = self;
            this.Next = next;
            this.Prev = prev;
        ...
        /// </summary>
        /*
        <example>https://api.stayos.com/v1/reservations?pageSize&#x3D;20</example>
        */
        ...
        /// </summary>
        /*
        <example>https://api.stayos.com/v1/reservations?pageSize&#x3D;20&amp;cursor&#x3D;eyJpZCI6MTIzNDU2fQ&#x3D;&#x3D;</example>
        */
