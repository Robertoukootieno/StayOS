...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listTrainingModules_200_response")]
    public partial class ListTrainingModules200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTrainingModules200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTrainingModules200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTrainingModules200Response" /> class.
        /// </summary>
        ...
        public ListTrainingModules200Response(List<TrainingModule> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListTrainingModules200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListTrainingModules200Response and cannot be null");
            }
        ...
        public List<TrainingModule> Data { get; set; }
