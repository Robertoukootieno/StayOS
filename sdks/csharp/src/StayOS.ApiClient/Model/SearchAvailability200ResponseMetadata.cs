...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "searchAvailability_200_response_metadata")]
    public partial class SearchAvailability200ResponseMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchAvailability200ResponseMetadata" /> class.
        /// </summary>
        /// <param name="totalResults">totalResults.</param>
        /// <param name="searchDuration">Search duration in milliseconds.</param>
        /// <param name="cacheHit">cacheHit.</param>
        public SearchAvailability200ResponseMetadata(int totalResults = default, int searchDuration = default, bool cacheHit = default)
        {
        ...
        /// </summary>
        /// <value>Search duration in milliseconds</value>
        [DataMember(Name = "searchDuration", EmitDefaultValue = false)]
        public int SearchDuration { get; set; }

        /// <summary>
        /// Gets or Sets CacheHit
        /// </summary>
        [DataMember(Name = "cacheHit", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SearchDuration: ").Append(SearchDuration).Append("\n");
