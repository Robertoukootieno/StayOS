...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getRevenueReconciliation_200_response")]
    public partial class GetRevenueReconciliation200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRevenueReconciliation200Response" /> class.
        /// </summary>
        /// <param name="date">date.</param>
        /// <param name="totalRevenue">totalRevenue.</param>
        /// <param name="totalPayments">totalPayments.</param>
        /// <param name="variance">variance.</param>
        public GetRevenueReconciliation200Response(DateTime date = default, Money totalRevenue = default, Money totalPayments = default, Money variance = default)
        {
            this.Date = date;
        ...
        public Money TotalPayments { get; set; }
