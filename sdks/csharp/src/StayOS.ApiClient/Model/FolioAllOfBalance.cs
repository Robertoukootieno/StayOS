...
namespace StayOS.ApiClient.Model
{
    ...
    /// FolioAllOfBalance
    /// </summary>
    [DataContract(Name = "Folio_allOf_balance")]
    public partial class FolioAllOfBalance : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfBalance" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FolioAllOfBalance() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FolioAllOfBalance" /> class.
        /// </summary>
        ...
        public FolioAllOfBalance(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FolioAllOfBalance and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FolioAllOfBalance and cannot be null");
            }
