...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listInventoryUnits_200_response")]
    public partial class ListInventoryUnits200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListInventoryUnits200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListInventoryUnits200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListInventoryUnits200Response" /> class.
        /// </summary>
        ...
        public ListInventoryUnits200Response(List<InventoryUnit> data = default, PaginatedResponseAllOfPagination pagination = default, PaginatedResponseAllOfLinks links = default)
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ListInventoryUnits200Response and cannot be null");
            }
            this.Data = data;
            // to ensure "pagination" is required (not null)
            if (pagination == null)
            {
                throw new ArgumentNullException("pagination is a required property for ListInventoryUnits200Response and cannot be null");
            }
        ...
        public List<InventoryUnit> Data { get; set; }
