...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PricingModel_allOf_seasonalAdjustments")]
    public partial class PricingModelAllOfSeasonalAdjustments : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModelAllOfSeasonalAdjustments" /> class.
        /// </summary>
        ...
        public PricingModelAllOfSeasonalAdjustments(string name = default, DateTime startDate = default, DateTime endDate = default, AdjustmentTypeEnum? adjustmentType = default, decimal adjustmentValue = default, string description = default)
        {
            this.Name = name;
