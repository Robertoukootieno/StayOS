...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FBOrder_allOf_serviceCharge")]
    public partial class FBOrderAllOfServiceCharge : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfServiceCharge" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FBOrderAllOfServiceCharge() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FBOrderAllOfServiceCharge" /> class.
        /// </summary>
        ...
        public FBOrderAllOfServiceCharge(string amount = default, string currency = default)
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FBOrderAllOfServiceCharge and cannot be null");
            }
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for FBOrderAllOfServiceCharge and cannot be null");
            }
