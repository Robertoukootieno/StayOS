...
namespace StayOS.ApiClient.Model
{
    ...
    /// StayAllOfLinks
    /// </summary>
    [DataContract(Name = "Stay_allOf_links")]
    public partial class StayAllOfLinks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StayAllOfLinks" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="reservation">reservation.</param>
        /// <param name="guest">guest.</param>
        /// <param name="folio">folio.</param>
        public StayAllOfLinks(string self = default, string reservation = default, string guest = default, string folio = default)
        {
            this.Self = self;
