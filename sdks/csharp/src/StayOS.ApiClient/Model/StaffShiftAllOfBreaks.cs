...
namespace StayOS.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StaffShift_allOf_breaks")]
    public partial class StaffShiftAllOfBreaks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffShiftAllOfBreaks" /> class.
        /// </summary>
        /// <param name="startTime">startTime.</param>
        /// <param name="endTime">endTime.</param>
        public StaffShiftAllOfBreaks(DateTime startTime = default, DateTime endTime = default)
        {
