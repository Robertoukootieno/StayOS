...
/**
 * ChannelDistributionAllOfCommission Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ChannelDistributionAllOfCommission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelDistribution_allOf_commission';
    ...
    public const PAID_BY_PROPERTY = 'PROPERTY';
    public const PAID_BY_GUEST = 'GUEST';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('paid_by', $data ?? [], 'PROPERTY');
    }
    ...
    */
     ...
     * Sets paid_by
     *
     * @param string|null $paid_by paid_by
     *
     * @return self
     */
