...
/**
 * WebhookAllOfRetryPolicy Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookAllOfRetryPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Webhook_allOf_retryPolicy';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('retry_delay', $data ?? [], 60);
    }
    ...
    */
    ...
    public function setMaxRetries($max_retries)
    {
        ...
        if (($max_retries > 10)) {
            throw new \InvalidArgumentException('invalid value for $max_retries when calling WebhookAllOfRetryPolicy., must be smaller than or equal to 10.');
        }
        if (($max_retries < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_retries when calling WebhookAllOfRetryPolicy., must be bigger than or equal to 0.');
        }
     ...
     * Sets retry_delay
     *
     * @param int|null $retry_delay Delay between retries in seconds
     *
     * @return self
     */
    public function setRetryDelay($retry_delay)
    {
        if (is_null($retry_delay)) {
            throw new \InvalidArgumentException('non-nullable retry_delay cannot be null');
        }
