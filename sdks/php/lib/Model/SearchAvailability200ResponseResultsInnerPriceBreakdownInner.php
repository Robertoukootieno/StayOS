...
/**
 * SearchAvailability200ResponseResultsInnerPriceBreakdownInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchAvailability200ResponseResultsInnerPriceBreakdownInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchAvailability_200_response_results_inner_priceBreakdown_inner';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'nightly_rate' => '\OpenAPI\Client\Model\Money',
        'taxes' => '\OpenAPI\Client\Model\SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nightly_rate', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['nightly_rate'];
    }

    /**
     * Sets nightly_rate
     *
     * @param \OpenAPI\Client\Model\Money|null $nightly_rate nightly_rate
     *
     * @return self
     */
    public function setNightlyRate($nightly_rate)
    {
        if (is_null($nightly_rate)) {
            throw new \InvalidArgumentException('non-nullable nightly_rate cannot be null');
        }
        $this->container['nightly_rate'] = $nightly_rate;
     ...
     * Gets taxes
     *
     * @return \OpenAPI\Client\Model\SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner[]|null
     */
     ...
     * Sets taxes
     *
     * @param \OpenAPI\Client\Model\SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner[]|null $taxes taxes
     *
     * @return self
     */
