...
/**
 * AddSpecialRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddSpecialRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addSpecialRequest_request';
    ...
    public const CATEGORY_ROOM_PREFERENCE = 'ROOM_PREFERENCE';
    public const CATEGORY_DIETARY = 'DIETARY';
    public const CATEGORY_ACCESSIBILITY = 'ACCESSIBILITY';
    public const CATEGORY_CELEBRATION = 'CELEBRATION';
    ...
    {
        return [
            self::CATEGORY_ROOM_PREFERENCE,
            self::CATEGORY_DIETARY,
            self::CATEGORY_ACCESSIBILITY,
            self::CATEGORY_CELEBRATION,
            self::CATEGORY_OTHER,
        ];
    }
