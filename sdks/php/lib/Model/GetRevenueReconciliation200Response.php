...
/**
 * GetRevenueReconciliation200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetRevenueReconciliation200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getRevenueReconciliation_200_response';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'total_revenue' => '\OpenAPI\Client\Model\Money',
        'total_payments' => '\OpenAPI\Client\Model\Money',
        'variance' => '\OpenAPI\Client\Model\Money'
    ];
    ...
    */
     ...
     * Sets total_revenue
     *
     * @param \OpenAPI\Client\Model\Money|null $total_revenue total_revenue
     *
     * @return self
     */
     ...
     * Sets total_payments
     *
     * @param \OpenAPI\Client\Model\Money|null $total_payments total_payments
     *
     * @return self
     */
     ...
     * Sets variance
     *
     * @param \OpenAPI\Client\Model\Money|null $variance variance
     *
     * @return self
     */
    ...
    {
        if (is_null($variance)) {
            throw new \InvalidArgumentException('non-nullable variance cannot be null');
        }
