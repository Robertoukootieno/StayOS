    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^\\d+\\.\\d{2}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling Money., must conform to the pattern /^\\d+\\.\\d{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling Money., must conform to the pattern /^[A-Z]{3}$/.");
        }
