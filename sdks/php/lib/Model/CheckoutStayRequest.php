...
/**
 * CheckoutStayRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutStayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'checkoutStay_request';
    ...
    {
        $this->setIfExists('checkout_time', $data ?? [], null);
    ...
    */
     ...
     * Sets checkout_time
     *
     * @param \DateTime|null $checkout_time checkout_time
     *
     * @return self
     */
    public function setCheckoutTime($checkout_time)
    {
        if (is_null($checkout_time)) {
            throw new \InvalidArgumentException('non-nullable checkout_time cannot be null');
        }
