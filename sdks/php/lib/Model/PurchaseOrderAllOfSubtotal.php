...
/**
 * PurchaseOrderAllOfSubtotal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseOrderAllOfSubtotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrder_allOf_subtotal';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^\\d+\\.\\d{2}$/", $this->container['amount'])) {
            $invalidProperties[] = "invalid value for 'amount', must be conform to the pattern /^\\d+\\.\\d{2}$/.";
        }
     ...
     * Sets amount
     *
     * @param string $amount Decimal amount (always 2 decimal places)
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^\\d+\\.\\d{2}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling PurchaseOrderAllOfSubtotal., must conform to the pattern /^\\d+\\.\\d{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling PurchaseOrderAllOfSubtotal., must conform to the pattern /^[A-Z]{3}$/.");
        }
