...
/**
 * RevenueReportAllOfRevenueByCategory Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RevenueReportAllOfRevenueByCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RevenueReport_allOf_revenueByCategory';
    ...
    protected static $openAPITypes = [
        'room' => '\OpenAPI\Client\Model\Model0',
        'food_beverage' => '\OpenAPI\Client\Model\Model0',
        'other' => '\OpenAPI\Client\Model\Model0'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('food_beverage', $data ?? [], null);
    ...
    */
     ...
     * Sets room
     *
     * @param \OpenAPI\Client\Model\Model0|null $room room
     *
     * @return self
     */
    ...
    {
        return $this->container['food_beverage'];
    }

    /**
     * Sets food_beverage
     *
     * @param \OpenAPI\Client\Model\Model0|null $food_beverage food_beverage
     *
     * @return self
     */
    public function setFoodBeverage($food_beverage)
    {
        if (is_null($food_beverage)) {
            throw new \InvalidArgumentException('non-nullable food_beverage cannot be null');
        }
        $this->container['food_beverage'] = $food_beverage;
     ...
     * Sets other
     *
     * @param \OpenAPI\Client\Model\Model0|null $other other
     *
     * @return self
     */
