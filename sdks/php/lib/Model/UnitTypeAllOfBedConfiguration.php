...
/**
 * UnitTypeAllOfBedConfiguration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UnitTypeAllOfBedConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnitType_allOf_bedConfiguration';
    ...
    public const BED_TYPE_KING = 'KING';
    public const BED_TYPE_QUEEN = 'QUEEN';
    public const BED_TYPE_DOUBLE = 'DOUBLE';
    public const BED_TYPE_TWIN = 'TWIN';
    public const BED_TYPE_SINGLE = 'SINGLE';
    public const BED_TYPE_SOFA_BED = 'SOFA_BED';
    public const BED_TYPE_BUNK = 'BUNK';
    ...
    {
        $this->setIfExists('bed_type', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($bed_type)) {
            throw new \InvalidArgumentException('non-nullable bed_type cannot be null');
        }
        $allowedValues = $this->getBedTypeAllowableValues();
        if (!in_array($bed_type, $allowedValues, true)) {
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling UnitTypeAllOfBedConfiguration., must be bigger than or equal to 1.');
        }
