...
/**
 * PricingModelAllOfBaseRates Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PricingModelAllOfBaseRates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PricingModel_allOf_baseRates';
    ...
    */
     ...
     * Sets rate
     *
     * @param \OpenAPI\Client\Model\Model0 $rate rate
     *
     * @return self
     */
