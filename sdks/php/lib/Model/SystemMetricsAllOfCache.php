...
/**
 * SystemMetricsAllOfCache Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SystemMetricsAllOfCache implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SystemMetrics_allOf_cache';
    ...
    */
     ...
     * Sets hit_rate
     *
     * @param float|null $hit_rate Cache hit rate percentage
     *
     * @return self
     */
     ...
     * Sets memory_usage
     *
     * @param float|null $memory_usage Memory usage in MB
     *
     * @return self
     */
