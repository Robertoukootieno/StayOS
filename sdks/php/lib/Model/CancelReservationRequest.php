...
/**
 * CancelReservationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CancelReservationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cancelReservation_request';
    ...
    public const REASON_GUEST_REQUEST = 'GUEST_REQUEST';
    public const REASON_NO_SHOW = 'NO_SHOW';
    public const REASON_PROPERTY_ISSUE = 'PROPERTY_ISSUE';
    ...
    {
        return [
            self::REASON_GUEST_REQUEST,
            self::REASON_NO_SHOW,
            self::REASON_PROPERTY_ISSUE,
            self::REASON_OTHER,
        ];
    }
