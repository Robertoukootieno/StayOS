...
/**
 * SearchAvailability200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchAvailability200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchAvailability_200_response_results_inner';
    ...
    protected static $openAPITypes = [
        ...
        'unit_type' => '\OpenAPI\Client\Model\UnitType',
        'property' => '\OpenAPI\Client\Model\Property',
        'rate_strategy' => '\OpenAPI\Client\Model\RateStrategy',
        'total_price' => '\OpenAPI\Client\Model\Money',
        'price_breakdown' => '\OpenAPI\Client\Model\SearchAvailability200ResponseResultsInnerPriceBreakdownInner[]',
        'availability' => 'string',
        'cancellation_policy' => '\OpenAPI\Client\Model\CancellationPolicy'
    ];
    ...
    public const AVAILABILITY_LAST_ROOM = 'LAST_ROOM';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rate_strategy', $data ?? [], null);
    ...
    */
     ...
     * Gets unit_type
     *
     * @return \OpenAPI\Client\Model\UnitType|null
     */
     ...
     * Sets unit_type
     *
     * @param \OpenAPI\Client\Model\UnitType|null $unit_type unit_type
     *
     * @return self
     */
     ...
     * Sets property
     *
     * @param \OpenAPI\Client\Model\Property|null $property property
     *
     * @return self
     */
     ...
     * Gets rate_strategy
     *
     * @return \OpenAPI\Client\Model\RateStrategy|null
     */
    public function getRateStrategy()
    {
        return $this->container['rate_strategy'];
    }

    /**
     * Sets rate_strategy
     *
     * @param \OpenAPI\Client\Model\RateStrategy|null $rate_strategy rate_strategy
     *
     * @return self
     */
    public function setRateStrategy($rate_strategy)
    {
        if (is_null($rate_strategy)) {
            throw new \InvalidArgumentException('non-nullable rate_strategy cannot be null');
        }
        $this->container['rate_strategy'] = $rate_strategy;
     ...
     * Sets total_price
     *
     * @param \OpenAPI\Client\Model\Money|null $total_price total_price
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\SearchAvailability200ResponseResultsInnerPriceBreakdownInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SearchAvailability200ResponseResultsInnerPriceBreakdownInner[]|null $price_breakdown price_breakdown
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\CancellationPolicy|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CancellationPolicy|null $cancellation_policy cancellation_policy
     *
     * @return self
     */
