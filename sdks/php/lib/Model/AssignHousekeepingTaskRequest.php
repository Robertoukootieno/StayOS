...
/**
 * AssignHousekeepingTaskRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AssignHousekeepingTaskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'assignHousekeepingTask_request';
    ...
    */
     ...
     * Sets assigned_to
     *
     * @param string $assigned_to Staff member ID
     *
     * @return self
     */
