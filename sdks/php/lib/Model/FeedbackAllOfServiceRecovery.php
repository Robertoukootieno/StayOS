...
/**
 * FeedbackAllOfServiceRecovery Class Doc Comment
 *
 * @category Class
 ...
 */
class FeedbackAllOfServiceRecovery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Feedback_allOf_serviceRecovery';
    ...
    protected static $openAPITypes = [
        'actions' => 'string[]',
        'compensation' => '\OpenAPI\Client\Model\Model0',
        'notes' => 'string'
    ];
    ...
    */
     ...
     * Sets compensation
     *
     * @param \OpenAPI\Client\Model\Model0|null $compensation compensation
     *
     * @return self
     */
