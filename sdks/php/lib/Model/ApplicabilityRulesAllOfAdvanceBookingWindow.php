...
/**
 * ApplicabilityRulesAllOfAdvanceBookingWindow Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApplicabilityRulesAllOfAdvanceBookingWindow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicabilityRules_allOf_advanceBookingWindow';
    ...
    {
        $this->setIfExists('minimum_days', $data ?? [], null);
        $this->setIfExists('maximum_days', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets minimum_days
     *
     * @param int|null $minimum_days Minimum days before check-in
     *
     * @return self
     */
    public function setMinimumDays($minimum_days)
    {
        if (is_null($minimum_days)) {
            throw new \InvalidArgumentException('non-nullable minimum_days cannot be null');
        }
     ...
     * Sets maximum_days
     *
     * @param int|null $maximum_days Maximum days before check-in
     *
     * @return self
     */
    public function setMaximumDays($maximum_days)
    {
        if (is_null($maximum_days)) {
            throw new \InvalidArgumentException('non-nullable maximum_days cannot be null');
        }
