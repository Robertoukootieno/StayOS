...
/**
 * ReceivePurchaseOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReceivePurchaseOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'receivePurchaseOrder_request';
    ...
    protected static $openAPITypes = [
        'received_items' => '\OpenAPI\Client\Model\ReceivePurchaseOrderRequestReceivedItemsInner[]',
        'received_by' => 'string',
        'notes' => 'string'
    ];
    ...
    protected static $setters = [
        'received_items' => 'setReceivedItems',
    ...
    protected static $getters = [
        'received_items' => 'getReceivedItems',
    ...
    {
        $this->setIfExists('received_items', $data ?? [], null);
    ...
    */
     ...
     * Gets received_items
     *
     * @return \OpenAPI\Client\Model\ReceivePurchaseOrderRequestReceivedItemsInner[]|null
     */
    public function getReceivedItems()
    {
        return $this->container['received_items'];
    }

    /**
     * Sets received_items
     *
     * @param \OpenAPI\Client\Model\ReceivePurchaseOrderRequestReceivedItemsInner[]|null $received_items received_items
     *
     * @return self
     */
    public function setReceivedItems($received_items)
    {
        if (is_null($received_items)) {
            throw new \InvalidArgumentException('non-nullable received_items cannot be null');
        }
        $this->container['received_items'] = $received_items;
