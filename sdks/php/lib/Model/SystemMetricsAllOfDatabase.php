...
/**
 * SystemMetricsAllOfDatabase Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SystemMetricsAllOfDatabase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SystemMetrics_allOf_database';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('query_time', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets query_time
     *
     * @param float|null $query_time Average query time in milliseconds
     *
     * @return self
     */
    public function setQueryTime($query_time)
    {
        if (is_null($query_time)) {
            throw new \InvalidArgumentException('non-nullable query_time cannot be null');
        }
