...
/**
 * CreateComplianceReportRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateComplianceReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createComplianceReport_request';
    ...
    public const REPORT_TYPE_PCI_DSS = 'PCI_DSS';
    public const REPORT_TYPE_SOC2 = 'SOC2';
    public const REPORT_TYPE_CUSTOM = 'CUSTOM';
    ...
    {
        return [
            self::REPORT_TYPE_GDPR,
            self::REPORT_TYPE_PCI_DSS,
            self::REPORT_TYPE_SOC2,
            self::REPORT_TYPE_CUSTOM,
        ];
    }
