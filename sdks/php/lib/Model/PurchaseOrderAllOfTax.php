...
/**
 * PurchaseOrderAllOfTax Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseOrderAllOfTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrder_allOf_tax';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^\\d+\\.\\d{2}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling PurchaseOrderAllOfTax., must conform to the pattern /^\\d+\\.\\d{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling PurchaseOrderAllOfTax., must conform to the pattern /^[A-Z]{3}$/.");
        }
