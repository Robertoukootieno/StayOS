...
/**
 * SyncChannelRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SyncChannelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'syncChannel_request';
    ...
    public const SYNC_TYPE_RATES_ONLY = 'RATES_ONLY';
    public const SYNC_TYPE_AVAILABILITY_ONLY = 'AVAILABILITY_ONLY';
    ...
    public function getSyncTypeAllowableValues()
    {
        return [
            self::SYNC_TYPE_FULL,
            self::SYNC_TYPE_INCREMENTAL,
            self::SYNC_TYPE_RATES_ONLY,
            self::SYNC_TYPE_AVAILABILITY_ONLY,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sync_type']) && !in_array($this->container['sync_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'sync_type', must be one of '%s'",
                $this->container['sync_type'],
    ...
    public function setSyncType($sync_type)
    {
        ...
        $allowedValues = $this->getSyncTypeAllowableValues();
        if (!in_array($sync_type, $allowedValues, true)) {
