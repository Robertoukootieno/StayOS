...
/**
 * InitiateServiceRecoveryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InitiateServiceRecoveryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'initiateServiceRecovery_request';
    ...
    protected static $openAPITypes = [
        'actions' => 'string[]',
        'compensation' => '\OpenAPI\Client\Model\Money',
        'notes' => 'string'
    ];
    ...
    */
     ...
     * Sets compensation
     *
     * @param \OpenAPI\Client\Model\Money|null $compensation compensation
     *
     * @return self
     */
