...
/**
 * SystemMetricsAllOfRequests Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SystemMetricsAllOfRequests implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SystemMetrics_allOf_requests';
    ...
    */
     ...
     *
     * @param float|null $average_response_time Average response time in milliseconds
     *
     * @return self
     */
