...
/**
 * SearchAvailability200ResponseMetadata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchAvailability200ResponseMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchAvailability_200_response_metadata';
    ...
    protected static $setters = [
        ...
        'search_duration' => 'setSearchDuration',
    ...
    protected static $getters = [
        ...
        'search_duration' => 'getSearchDuration',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('search_duration', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets search_duration
     *
     * @return int|null
     */
    public function getSearchDuration()
    {
        return $this->container['search_duration'];
    }

    /**
     * Sets search_duration
     *
     * @param int|null $search_duration Search duration in milliseconds
     *
     * @return self
     */
    public function setSearchDuration($search_duration)
    {
        if (is_null($search_duration)) {
            throw new \InvalidArgumentException('non-nullable search_duration cannot be null');
        }
        $this->container['search_duration'] = $search_duration;
