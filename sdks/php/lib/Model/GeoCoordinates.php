...
class GeoCoordinates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setLatitude($latitude)
    {
        ...
        if (($latitude > 90)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling GeoCoordinates., must be smaller than or equal to 90.');
        }
        if (($latitude < -90)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling GeoCoordinates., must be bigger than or equal to -90.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (($longitude > 180)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling GeoCoordinates., must be smaller than or equal to 180.');
        }
        if (($longitude < -180)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling GeoCoordinates., must be bigger than or equal to -180.');
        }
