...
/**
 * ServiceRequestAllOfGuestFeedback Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceRequestAllOfGuestFeedback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceRequest_allOf_guestFeedback';
    ...
    */
    ...
    public function setRating($rating)
    {
        ...
        if (($rating > 5)) {
            throw new \InvalidArgumentException('invalid value for $rating when calling ServiceRequestAllOfGuestFeedback., must be smaller than or equal to 5.');
        }
        if (($rating < 1)) {
            throw new \InvalidArgumentException('invalid value for $rating when calling ServiceRequestAllOfGuestFeedback., must be bigger than or equal to 1.');
        }
