...
/**
 * SearchAvailabilityRequestOccupancy Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchAvailabilityRequestOccupancy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchAvailability_request_occupancy';
    ...
    */
    ...
    public function setAdults($adults)
    {
        ...
        if (($adults < 1)) {
            throw new \InvalidArgumentException('invalid value for $adults when calling SearchAvailabilityRequestOccupancy., must be bigger than or equal to 1.');
        }
    ...
    public function setChildren($children)
    {
        ...
        if (($children < 0)) {
            throw new \InvalidArgumentException('invalid value for $children when calling SearchAvailabilityRequestOccupancy., must be bigger than or equal to 0.');
        }
     ...
     * Sets child_ages
     *
     * @param int[]|null $child_ages child_ages
     *
     * @return self
     */
