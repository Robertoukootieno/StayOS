...
/**
 * MaintenanceRequestAllOfWorkLog Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MaintenanceRequestAllOfWorkLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaintenanceRequest_allOf_workLog';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('technician', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['technician'];
    }

    /**
     * Sets technician
     *
     * @param string|null $technician technician
     *
     * @return self
     */
    public function setTechnician($technician)
    {
        if (is_null($technician)) {
            throw new \InvalidArgumentException('non-nullable technician cannot be null');
        }
        $this->container['technician'] = $technician;
