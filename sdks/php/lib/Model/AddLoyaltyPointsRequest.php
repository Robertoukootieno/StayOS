...
/**
 * AddLoyaltyPointsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddLoyaltyPointsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addLoyaltyPoints_request';
    ...
    */
    ...
    public function setPoints($points)
    {
        ...
        if (($points < 1)) {
            throw new \InvalidArgumentException('invalid value for $points when calling AddLoyaltyPointsRequest., must be bigger than or equal to 1.');
        }
