...
/**
 * PricingModelAllOfTaxes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PricingModelAllOfTaxes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PricingModel_allOf_taxes';
    ...
    public const TYPE_PER_PERSON_PER_NIGHT = 'PER_PERSON_PER_NIGHT';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_PER_NIGHT,
            self::TYPE_PER_PERSON_PER_NIGHT,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_included', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets is_included
     *
     * @param bool|null $is_included Whether tax is included in displayed rate
     *
     * @return self
     */
