 ...
 */
class UnitType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnitType';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'capacity' => '\OpenAPI\Client\Model\Model0',
        'bed_configuration' => '\OpenAPI\Client\Model\UnitTypeAllOfBedConfiguration[]',
        'size' => '\OpenAPI\Client\Model\UnitTypeAllOfSize',
        'amenities' => 'string[]',
        'photos' => '\OpenAPI\Client\Model\UnitTypeAllOfPhotos[]',
    ...
    protected static $setters = [
        ...
        'bed_configuration' => 'setBedConfiguration',
        'size' => 'setSize',
    ...
    protected static $getters = [
        ...
        'bed_configuration' => 'getBedConfiguration',
        'size' => 'getSize',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bed_configuration', $data ?? [], null);
    ...
    */
     ...
     * Sets capacity
     *
     * @param \OpenAPI\Client\Model\Model0 $capacity capacity
     *
     * @return self
     */
    ...
    /**
     * Gets bed_configuration
     *
     * @return \OpenAPI\Client\Model\UnitTypeAllOfBedConfiguration[]|null
     */
    public function getBedConfiguration()
    {
        return $this->container['bed_configuration'];
    }

    /**
     * Sets bed_configuration
     *
     * @param \OpenAPI\Client\Model\UnitTypeAllOfBedConfiguration[]|null $bed_configuration bed_configuration
     *
     * @return self
     */
    public function setBedConfiguration($bed_configuration)
    {
        if (is_null($bed_configuration)) {
            throw new \InvalidArgumentException('non-nullable bed_configuration cannot be null');
        }
        $this->container['bed_configuration'] = $bed_configuration;
     ...
     * Gets size
     *
     * @return \OpenAPI\Client\Model\UnitTypeAllOfSize|null
     */
     ...
     * Sets size
     *
     * @param \OpenAPI\Client\Model\UnitTypeAllOfSize|null $size size
     *
     * @return self
     */
     ...
     * Gets photos
     *
     * @return \OpenAPI\Client\Model\UnitTypeAllOfPhotos[]|null
     */
     ...
     * Sets photos
     *
     * @param \OpenAPI\Client\Model\UnitTypeAllOfPhotos[]|null $photos photos
     *
     * @return self
     */
