...
/**
 * GetGuestLoyalty200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetGuestLoyalty200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getGuestLoyalty_200_response';
    ...
    protected static $setters = [
        ...
        'next_tier_points' => 'setNextTierPoints'
    ];
    ...
    protected static $getters = [
        ...
        'next_tier_points' => 'getNextTierPoints'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('lifetime_points', $data ?? [], null);
        $this->setIfExists('next_tier_points', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['lifetime_points'];
    }

    /**
     * Sets lifetime_points
     *
     * @param int|null $lifetime_points lifetime_points
     *
     * @return self
     */
    public function setLifetimePoints($lifetime_points)
    {
        if (is_null($lifetime_points)) {
            throw new \InvalidArgumentException('non-nullable lifetime_points cannot be null');
        }
        $this->container['lifetime_points'] = $lifetime_points;

        return $this;
    }

    /**
     * Gets next_tier_points
     *
     * @return int|null
     */
    public function getNextTierPoints()
    {
        return $this->container['next_tier_points'];
    }

    /**
     * Sets next_tier_points
     *
     * @param int|null $next_tier_points next_tier_points
     *
     * @return self
     */
    public function setNextTierPoints($next_tier_points)
    {
        if (is_null($next_tier_points)) {
            throw new \InvalidArgumentException('non-nullable next_tier_points cannot be null');
        }
        $this->container['next_tier_points'] = $next_tier_points;
