...
class AuditMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditMetadata';
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Creation timestamp (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets created_by
     *
     * @param string|null $created_by User ID who created the resource
     *
     * @return self
     */
     ...
     * Sets updated_by
     *
     * @param string|null $updated_by User ID who last updated the resource
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version number for optimistic locking
     *
     * @return self
     */
