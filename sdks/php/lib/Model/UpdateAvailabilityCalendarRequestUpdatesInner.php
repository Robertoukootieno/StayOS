...
/**
 * UpdateAvailabilityCalendarRequestUpdatesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAvailabilityCalendarRequestUpdatesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateAvailabilityCalendar_request_updates_inner';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'available' => 'int',
        'rate' => '\OpenAPI\Client\Model\Money',
        'restrictions' => 'object'
    ];
    ...
    */
     ...
     * Sets rate
     *
     * @param \OpenAPI\Client\Model\Money|null $rate rate
     *
     * @return self
     */
