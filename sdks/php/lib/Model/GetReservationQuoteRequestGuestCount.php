...
/**
 * GetReservationQuoteRequestGuestCount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetReservationQuoteRequestGuestCount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getReservationQuote_request_guestCount';
    ...
    */
    ...
    public function setAdults($adults)
    {
        ...
        if (($adults < 1)) {
            throw new \InvalidArgumentException('invalid value for $adults when calling GetReservationQuoteRequestGuestCount., must be bigger than or equal to 1.');
        }
    ...
    public function setChildren($children)
    {
        ...
        if (($children < 0)) {
            throw new \InvalidArgumentException('invalid value for $children when calling GetReservationQuoteRequestGuestCount., must be bigger than or equal to 0.');
        }
