...
/**
 * InventoryUnitAllOfLinks Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryUnitAllOfLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InventoryUnit_allOf_links';
    ...
    protected static $setters = [
        ...
        'current_reservation' => 'setCurrentReservation'
    ];
    ...
    protected static $getters = [
        ...
        'current_reservation' => 'getCurrentReservation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('current_reservation', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets current_reservation
     *
     * @return string|null
     */
    public function getCurrentReservation()
    {
        return $this->container['current_reservation'];
    }

    /**
     * Sets current_reservation
     *
     * @param string|null $current_reservation current_reservation
     *
     * @return self
     */
    public function setCurrentReservation($current_reservation)
    {
        if (is_null($current_reservation)) {
            throw new \InvalidArgumentException('non-nullable current_reservation cannot be null');
        }
        $this->container['current_reservation'] = $current_reservation;
