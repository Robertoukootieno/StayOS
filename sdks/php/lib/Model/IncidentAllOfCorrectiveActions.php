...
/**
 * IncidentAllOfCorrectiveActions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IncidentAllOfCorrectiveActions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Incident_allOf_correctiveActions';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('taken_by', $data ?? [], null);
    ...
    */
     ...
     * Sets taken_by
     *
     * @param string|null $taken_by taken_by
     *
     * @return self
     */
    ...
    {
        if (is_null($taken_by)) {
            throw new \InvalidArgumentException('non-nullable taken_by cannot be null');
        }
