...
/**
 * AssignMaintenanceRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AssignMaintenanceRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'assignMaintenanceRequest_request';
    ...
    */
     ...
     * Sets assigned_to
     *
     * @param string $assigned_to Technician ID
     *
     * @return self
     */
