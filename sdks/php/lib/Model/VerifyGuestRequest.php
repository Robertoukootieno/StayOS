...
/**
 * VerifyGuestRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerifyGuestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'verifyGuest_request';
    ...
    public const VERIFICATION_TYPE_ID_DOCUMENT = 'ID_DOCUMENT';
    public const VERIFICATION_TYPE_EMAIL = 'EMAIL';
    public const VERIFICATION_TYPE_PHONE = 'PHONE';
    public const VERIFICATION_TYPE_BIOMETRIC = 'BIOMETRIC';
    ...
    {
        return [
            self::VERIFICATION_TYPE_ID_DOCUMENT,
            self::VERIFICATION_TYPE_EMAIL,
            self::VERIFICATION_TYPE_PHONE,
            self::VERIFICATION_TYPE_BIOMETRIC,
        ];
    }
    ...
    */
     ...
     *
     * @param object|null $verification_data verification_data
     *
     * @return self
     */
