...
/**
 * FeedbackAllOfResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FeedbackAllOfResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Feedback_allOf_response';
    ...
    {
        $this->setIfExists('responded_by', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['responded_by'];
    }

    /**
     * Sets responded_by
     *
     * @param string|null $responded_by responded_by
     *
     * @return self
     */
    public function setRespondedBy($responded_by)
    {
        if (is_null($responded_by)) {
            throw new \InvalidArgumentException('non-nullable responded_by cannot be null');
        }
        $this->container['responded_by'] = $responded_by;
