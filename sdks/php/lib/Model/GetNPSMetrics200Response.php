...
/**
 * GetNPSMetrics200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetNPSMetrics200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNPSMetrics_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('promoters', $data ?? [], null);
        $this->setIfExists('passives', $data ?? [], null);
        $this->setIfExists('detractors', $data ?? [], null);
    ...
    */
     ...
     * Sets nps_score
     *
     * @param float|null $nps_score nps_score
     *
     * @return self
     */
    ...
    {
        return $this->container['promoters'];
    }

    /**
     * Sets promoters
     *
     * @param int|null $promoters promoters
     *
     * @return self
     */
    public function setPromoters($promoters)
    {
        if (is_null($promoters)) {
            throw new \InvalidArgumentException('non-nullable promoters cannot be null');
        }
        $this->container['promoters'] = $promoters;
    ...
    {
        return $this->container['passives'];
    }

    /**
     * Sets passives
     *
     * @param int|null $passives passives
     *
     * @return self
     */
    public function setPassives($passives)
    {
        if (is_null($passives)) {
            throw new \InvalidArgumentException('non-nullable passives cannot be null');
        }
        $this->container['passives'] = $passives;
    ...
    {
        return $this->container['detractors'];
    }

    /**
     * Sets detractors
     *
     * @param int|null $detractors detractors
     *
     * @return self
     */
    public function setDetractors($detractors)
    {
        if (is_null($detractors)) {
            throw new \InvalidArgumentException('non-nullable detractors cannot be null');
        }
        $this->container['detractors'] = $detractors;
     ...
     *
     * @param int|null $total_responses total_responses
     *
     * @return self
     */
