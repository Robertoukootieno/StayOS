...
// @ts-ignore
import type { ChannelMappingAllOfRateStrategyMappings } from './channel-mapping-all-of-rate-strategy-mappings';
// May contain unused imports in some cases
// @ts-ignore
import type { ChannelMappingAllOfUnitTypeMappings } from './channel-mapping-all-of-unit-type-mappings';

export interface ChannelMapping {
    'channelId': string;
    'propertyId': string;
    'unitTypeMappings'?: Array<ChannelMappingAllOfUnitTypeMappings>;
    'rateStrategyMappings'?: Array<ChannelMappingAllOfRateStrategyMappings>;
}
