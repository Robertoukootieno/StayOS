...
export interface PropertyPoliciesPetPolicy {
    'petsAllowed'?: boolean;
    'petFee'?: Money;
    'petTypes'?: Array<PropertyPoliciesPetPolicyPetTypes>;
}

export const PropertyPoliciesPetPolicyPetTypes = {
    DOG: 'DOG',
    CAT: 'CAT',
    BIRD: 'BIRD',
    OTHER: 'OTHER'
...
export type PropertyPoliciesPetPolicyPetTypes = typeof PropertyPoliciesPetPolicyPetTypes[keyof typeof PropertyPoliciesPetPolicyPetTypes];
