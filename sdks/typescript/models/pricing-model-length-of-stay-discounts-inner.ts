...
export interface PricingModelLengthOfStayDiscountsInner {
    'minimumNights'?: number;
    'discountType'?: PricingModelLengthOfStayDiscountsInnerDiscountType;
    'discountValue'?: number;
    'description'?: string;
}

export const PricingModelLengthOfStayDiscountsInnerDiscountType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT',
    FREE_NIGHTS: 'FREE_NIGHTS'
} as const;

export type PricingModelLengthOfStayDiscountsInnerDiscountType = typeof PricingModelLengthOfStayDiscountsInnerDiscountType[keyof typeof PricingModelLengthOfStayDiscountsInnerDiscountType];
