...
// @ts-ignore
import type { UpdateAvailabilityCalendarRequestUpdatesInner } from './update-availability-calendar-request-updates-inner';

export interface UpdateAvailabilityCalendarRequest {
    'propertyId'?: string;
    'unitTypeId'?: string;
