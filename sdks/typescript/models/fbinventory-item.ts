...
export interface FBInventoryItem {
    ...
    'name': string;
    'category'?: FBInventoryItemCategory;
    'unit': FBInventoryItemUnit;
    'currentStock': number;
    'minimumStock'?: number;
    'maximumStock'?: number;
    'reorderPoint'?: number;
...
export const FBInventoryItemCategory = {
    PRODUCE: 'PRODUCE',
    MEAT: 'MEAT',
    DAIRY: 'DAIRY',
    BEVERAGE: 'BEVERAGE',
...
export type FBInventoryItemCategory = typeof FBInventoryItemCategory[keyof typeof FBInventoryItemCategory];
export const FBInventoryItemUnit = {
    KG: 'KG',
    LB: 'LB',
    L: 'L',
    GAL: 'GAL',
...
export type FBInventoryItemUnit = typeof FBInventoryItemUnit[keyof typeof FBInventoryItemUnit];
