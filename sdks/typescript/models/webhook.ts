...
// May contain unused imports in some cases
// @ts-ignore
import type { WebhookAllOfRetryPolicy } from './webhook-all-of-retry-policy';
...
export interface Webhook {
    ...
    'retryPolicy'?: WebhookAllOfRetryPolicy;
    'lastDeliveryAt'?: string;
    'lastDeliveryStatus'?: WebhookLastDeliveryStatus;
    'metadata'?: Model0;
}
...
export const WebhookLastDeliveryStatus = {
    SUCCESS: 'SUCCESS',
    FAILURE: 'FAILURE'
} as const;

export type WebhookLastDeliveryStatus = typeof WebhookLastDeliveryStatus[keyof typeof WebhookLastDeliveryStatus];
