...
export interface AddFolioAdjustmentRequest {
    'amount': Money;
    'reason': string;
    'type'?: AddFolioAdjustmentRequestType;
}

export const AddFolioAdjustmentRequestType = {
    DISCOUNT: 'DISCOUNT',
    COMP: 'COMP',
    REFUND: 'REFUND',
...
export type AddFolioAdjustmentRequestType = typeof AddFolioAdjustmentRequestType[keyof typeof AddFolioAdjustmentRequestType];
