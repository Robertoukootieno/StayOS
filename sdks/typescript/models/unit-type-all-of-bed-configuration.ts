...
export interface UnitTypeAllOfBedConfiguration {
    'bedType'?: UnitTypeAllOfBedConfigurationBedType;
    'quantity'?: number;
}

export const UnitTypeAllOfBedConfigurationBedType = {
    KING: 'KING',
    QUEEN: 'QUEEN',
    DOUBLE: 'DOUBLE',
    TWIN: 'TWIN',
...
export type UnitTypeAllOfBedConfigurationBedType = typeof UnitTypeAllOfBedConfigurationBedType[keyof typeof UnitTypeAllOfBedConfigurationBedType];
