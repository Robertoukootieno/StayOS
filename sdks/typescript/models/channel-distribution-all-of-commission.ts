...
export interface ChannelDistributionAllOfCommission {
    'type'?: ChannelDistributionAllOfCommissionType;
    'value'?: number;
    'paidBy'?: ChannelDistributionAllOfCommissionPaidBy;
}

export const ChannelDistributionAllOfCommissionType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT'
} as const;

export type ChannelDistributionAllOfCommissionType = typeof ChannelDistributionAllOfCommissionType[keyof typeof ChannelDistributionAllOfCommissionType];
export const ChannelDistributionAllOfCommissionPaidBy = {
    PROPERTY: 'PROPERTY',
    GUEST: 'GUEST'
} as const;

export type ChannelDistributionAllOfCommissionPaidBy = typeof ChannelDistributionAllOfCommissionPaidBy[keyof typeof ChannelDistributionAllOfCommissionPaidBy];
