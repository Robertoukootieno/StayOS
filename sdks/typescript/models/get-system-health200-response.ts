...
export interface GetSystemHealth200Response {
    'status'?: GetSystemHealth200ResponseStatus;
    'version'?: string;
    'timestamp'?: string;
    'services'?: object;
}

export const GetSystemHealth200ResponseStatus = {
    HEALTHY: 'healthy',
    DEGRADED: 'degraded',
    UNHEALTHY: 'unhealthy'
} as const;

export type GetSystemHealth200ResponseStatus = typeof GetSystemHealth200ResponseStatus[keyof typeof GetSystemHealth200ResponseStatus];
