...
export interface ChannelDistributionAllOfMarkup {
    'type'?: ChannelDistributionAllOfMarkupType;
    'value'?: number;
}

export const ChannelDistributionAllOfMarkupType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT'
} as const;

export type ChannelDistributionAllOfMarkupType = typeof ChannelDistributionAllOfMarkupType[keyof typeof ChannelDistributionAllOfMarkupType];
