...
export interface IncidentPersonsInvolvedInner {
    'name'?: string;
    'role'?: IncidentPersonsInvolvedInnerRole;
    'contactInfo'?: string;
}

export const IncidentPersonsInvolvedInnerRole = {
    GUEST: 'GUEST',
    STAFF: 'STAFF',
    VISITOR: 'VISITOR',
...
export type IncidentPersonsInvolvedInnerRole = typeof IncidentPersonsInvolvedInnerRole[keyof typeof IncidentPersonsInvolvedInnerRole];
