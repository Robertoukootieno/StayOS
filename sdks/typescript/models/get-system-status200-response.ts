...
// @ts-ignore
import type { GetSystemStatus200ResponseComponentsValue } from './get-system-status200-response-components-value';

export interface GetSystemStatus200Response {
    'status'?: GetSystemStatus200ResponseStatus;
    'components'?: { [key: string]: GetSystemStatus200ResponseComponentsValue; };
}

export const GetSystemStatus200ResponseStatus = {
    OPERATIONAL: 'OPERATIONAL',
    DEGRADED: 'DEGRADED',
    OUTAGE: 'OUTAGE'
} as const;

export type GetSystemStatus200ResponseStatus = typeof GetSystemStatus200ResponseStatus[keyof typeof GetSystemStatus200ResponseStatus];
