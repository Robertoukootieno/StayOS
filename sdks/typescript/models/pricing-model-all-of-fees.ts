...
export interface PricingModelAllOfFees {
    'name'?: string;
    'type'?: PricingModelAllOfFeesType;
    'amount'?: Model0;
    'isOptional'?: boolean;
}

export const PricingModelAllOfFeesType = {
    PER_STAY: 'PER_STAY',
    PER_NIGHT: 'PER_NIGHT',
    PER_PERSON: 'PER_PERSON'
} as const;

export type PricingModelAllOfFeesType = typeof PricingModelAllOfFeesType[keyof typeof PricingModelAllOfFeesType];
