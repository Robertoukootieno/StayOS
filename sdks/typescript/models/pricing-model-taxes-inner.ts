...
export interface PricingModelTaxesInner {
    'name'?: string;
    'type'?: PricingModelTaxesInnerType;
    'rate'?: number;
    /**
...
export const PricingModelTaxesInnerType = {
    PERCENTAGE: 'PERCENTAGE',
    PER_NIGHT: 'PER_NIGHT',
    PER_PERSON_PER_NIGHT: 'PER_PERSON_PER_NIGHT'
} as const;

export type PricingModelTaxesInnerType = typeof PricingModelTaxesInnerType[keyof typeof PricingModelTaxesInnerType];
