...
// @ts-ignore
import type { PricingModelAllOfBaseRates } from './pricing-model-all-of-base-rates';
// May contain unused imports in some cases
// @ts-ignore
import type { PricingModelAllOfFees } from './pricing-model-all-of-fees';
// May contain unused imports in some cases
// @ts-ignore
import type { PricingModelAllOfLengthOfStayDiscounts } from './pricing-model-all-of-length-of-stay-discounts';
// May contain unused imports in some cases
// @ts-ignore
import type { PricingModelAllOfOccupancyPricing } from './pricing-model-all-of-occupancy-pricing';
// May contain unused imports in some cases
// @ts-ignore
import type { PricingModelAllOfSeasonalAdjustments } from './pricing-model-all-of-seasonal-adjustments';
// May contain unused imports in some cases
// @ts-ignore
import type { PricingModelAllOfTaxes } from './pricing-model-all-of-taxes';

export interface PricingModel {
    /**
     * Base rates per unit type
     */
    'baseRates': Array<PricingModelAllOfBaseRates>;
    'occupancyPricing'?: PricingModelAllOfOccupancyPricing;
    'seasonalAdjustments'?: Array<PricingModelAllOfSeasonalAdjustments>;
    'lengthOfStayDiscounts'?: Array<PricingModelAllOfLengthOfStayDiscounts>;
