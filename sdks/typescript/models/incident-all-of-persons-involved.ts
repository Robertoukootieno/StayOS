...
export interface IncidentAllOfPersonsInvolved {
    'name'?: string;
    'role'?: IncidentAllOfPersonsInvolvedRole;
    'contactInfo'?: string;
}

export const IncidentAllOfPersonsInvolvedRole = {
    GUEST: 'GUEST',
    STAFF: 'STAFF',
    VISITOR: 'VISITOR',
...
export type IncidentAllOfPersonsInvolvedRole = typeof IncidentAllOfPersonsInvolvedRole[keyof typeof IncidentAllOfPersonsInvolvedRole];
