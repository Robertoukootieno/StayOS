...
export interface UnitTypeSize {
    'value'?: number;
    'unit'?: UnitTypeSizeUnit;
}

export const UnitTypeSizeUnit = {
    SQM: 'SQM',
    SQFT: 'SQFT'
} as const;

export type UnitTypeSizeUnit = typeof UnitTypeSizeUnit[keyof typeof UnitTypeSizeUnit];
