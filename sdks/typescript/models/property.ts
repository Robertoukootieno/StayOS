...
// May contain unused imports in some cases
// @ts-ignore
import type { PropertyAllOfLinks } from './property-all-of-links';
...
export const PropertyOperationalStatus = {
    ACTIVE: 'ACTIVE',
    SUSPENDED: 'SUSPENDED',
    CLOSED: 'CLOSED'
} as const;

export type PropertyOperationalStatus = typeof PropertyOperationalStatus[keyof typeof PropertyOperationalStatus];
