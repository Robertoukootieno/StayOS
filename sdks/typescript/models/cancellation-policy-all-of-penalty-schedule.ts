...
export interface CancellationPolicyAllOfPenaltySchedule {
    'hoursBeforeCheckIn'?: number;
    'penaltyType'?: CancellationPolicyAllOfPenaltySchedulePenaltyType;
    'penaltyValue'?: number;
    'description'?: string;
}

export const CancellationPolicyAllOfPenaltySchedulePenaltyType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT',
    NIGHTS: 'NIGHTS'
} as const;

export type CancellationPolicyAllOfPenaltySchedulePenaltyType = typeof CancellationPolicyAllOfPenaltySchedulePenaltyType[keyof typeof CancellationPolicyAllOfPenaltySchedulePenaltyType];
