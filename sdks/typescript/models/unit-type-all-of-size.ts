...
export interface UnitTypeAllOfSize {
    'value'?: number;
    'unit'?: UnitTypeAllOfSizeUnit;
}

export const UnitTypeAllOfSizeUnit = {
    SQM: 'SQM',
    SQFT: 'SQFT'
} as const;

export type UnitTypeAllOfSizeUnit = typeof UnitTypeAllOfSizeUnit[keyof typeof UnitTypeAllOfSizeUnit];
