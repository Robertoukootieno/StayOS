...
// May contain unused imports in some cases
// @ts-ignore
import type { RateStrategyAllOfLinks } from './rate-strategy-all-of-links';
...
export interface RateStrategy {
    ...
    'name': string;
    'description'?: string;
    'strategyType': RateStrategyStrategyType;
    'isActive'?: boolean;
    'applicability'?: Model0;
    'pricingModel': Model0;
    'cancellationTerms'?: Model0;
    'channelDistribution'?: Array<Model0>;
    'metadata'?: Model0;
    'links'?: RateStrategyAllOfLinks;
}

export const RateStrategyStrategyType = {
    STANDARD: 'STANDARD',
    DYNAMIC: 'DYNAMIC',
...
export type RateStrategyStrategyType = typeof RateStrategyStrategyType[keyof typeof RateStrategyStrategyType];
