...
export interface TrainingModuleAllOfContent {
    'type'?: TrainingModuleAllOfContentType;
    'url'?: string;
}

export const TrainingModuleAllOfContentType = {
    VIDEO: 'VIDEO',
    DOCUMENT: 'DOCUMENT',
...
export type TrainingModuleAllOfContentType = typeof TrainingModuleAllOfContentType[keyof typeof TrainingModuleAllOfContentType];
