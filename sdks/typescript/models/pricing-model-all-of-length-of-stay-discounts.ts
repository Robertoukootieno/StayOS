...
export interface PricingModelAllOfLengthOfStayDiscounts {
    'minimumNights'?: number;
    'discountType'?: PricingModelAllOfLengthOfStayDiscountsDiscountType;
    'discountValue'?: number;
    'description'?: string;
}

export const PricingModelAllOfLengthOfStayDiscountsDiscountType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT',
    FREE_NIGHTS: 'FREE_NIGHTS'
} as const;

export type PricingModelAllOfLengthOfStayDiscountsDiscountType = typeof PricingModelAllOfLengthOfStayDiscountsDiscountType[keyof typeof PricingModelAllOfLengthOfStayDiscountsDiscountType];
