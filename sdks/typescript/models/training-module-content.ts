...
export interface TrainingModuleContent {
    'type'?: TrainingModuleContentType;
    'url'?: string;
}

export const TrainingModuleContentType = {
    VIDEO: 'VIDEO',
    DOCUMENT: 'DOCUMENT',
...
export type TrainingModuleContentType = typeof TrainingModuleContentType[keyof typeof TrainingModuleContentType];
