...
export interface PricingModelSeasonalAdjustmentsInner {
    'name'?: string;
    'startDate'?: string;
    'endDate'?: string;
    'adjustmentType'?: PricingModelSeasonalAdjustmentsInnerAdjustmentType;
    'adjustmentValue'?: number;
    'description'?: string;
}

export const PricingModelSeasonalAdjustmentsInnerAdjustmentType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT'
} as const;

export type PricingModelSeasonalAdjustmentsInnerAdjustmentType = typeof PricingModelSeasonalAdjustmentsInnerAdjustmentType[keyof typeof PricingModelSeasonalAdjustmentsInnerAdjustmentType];
