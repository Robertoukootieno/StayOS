...
// @ts-ignore
import type { GetMaintenanceHistory200ResponseHistoryInner } from './get-maintenance-history200-response-history-inner';

export interface GetMaintenanceHistory200Response {
    'requestId'?: string;
