...
export interface PropertyCertification {
    ...
    'propertyId': string;
    'type': PropertyCertificationType;
    'name'?: string;
    'certificateNumber'?: string;
    'issuingAuthority'?: string;
    'issuedDate': string;
    'expiryDate': string;
    'status'?: PropertyCertificationStatus;
    'documentUrl'?: string;
    'notes'?: string;
    'metadata'?: Model0;
}

export const PropertyCertificationType = {
...
export type PropertyCertificationType = typeof PropertyCertificationType[keyof typeof PropertyCertificationType];
export const PropertyCertificationStatus = {
    ACTIVE: 'ACTIVE',
    EXPIRED: 'EXPIRED',
    SUSPENDED: 'SUSPENDED',
    REVOKED: 'REVOKED'
...
export type PropertyCertificationStatus = typeof PropertyCertificationStatus[keyof typeof PropertyCertificationStatus];
