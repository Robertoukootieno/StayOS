...
export interface FBOrderItemsInner {
    'menuItemId'?: string;
    'name'?: string;
    'quantity'?: number;
    'unitPrice'?: Money;
    'specialInstructions'?: string;
    'status'?: FBOrderItemsInnerStatus;
}

export const FBOrderItemsInnerStatus = {
    PENDING: 'PENDING',
    PREPARING: 'PREPARING',
    READY: 'READY',
    SERVED: 'SERVED'
...
export type FBOrderItemsInnerStatus = typeof FBOrderItemsInnerStatus[keyof typeof FBOrderItemsInnerStatus];
