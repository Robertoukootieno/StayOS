...
export interface CreateComplianceReportRequest {
    'reportType': CreateComplianceReportRequestReportType;
    'startDate': string;
    'endDate': string;
}

export const CreateComplianceReportRequestReportType = {
    GDPR: 'GDPR',
    PCI_DSS: 'PCI_DSS',
    SOC2: 'SOC2',
    CUSTOM: 'CUSTOM'
...
export type CreateComplianceReportRequestReportType = typeof CreateComplianceReportRequestReportType[keyof typeof CreateComplianceReportRequestReportType];
