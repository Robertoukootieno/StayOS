...
export interface SyncChannelRequest {
    'syncType'?: SyncChannelRequestSyncType;
}

export const SyncChannelRequestSyncType = {
    FULL: 'FULL',
...
export type SyncChannelRequestSyncType = typeof SyncChannelRequestSyncType[keyof typeof SyncChannelRequestSyncType];
