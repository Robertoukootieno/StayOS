...
export interface PricingModelFeesInner {
    'name'?: string;
    'type'?: PricingModelFeesInnerType;
    'amount'?: Money;
    'isOptional'?: boolean;
}

export const PricingModelFeesInnerType = {
    PER_STAY: 'PER_STAY',
    PER_NIGHT: 'PER_NIGHT',
    PER_PERSON: 'PER_PERSON'
} as const;

export type PricingModelFeesInnerType = typeof PricingModelFeesInnerType[keyof typeof PricingModelFeesInnerType];
