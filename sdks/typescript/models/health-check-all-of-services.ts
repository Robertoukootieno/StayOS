...
export interface HealthCheckAllOfServices {
    'database'?: HealthCheckAllOfServicesDatabase;
    'cache'?: HealthCheckAllOfServicesCache;
    'messageQueue'?: HealthCheckAllOfServicesMessageQueue;
}

export const HealthCheckAllOfServicesDatabase = {
    UP: 'UP',
    DOWN: 'DOWN'
} as const;

export type HealthCheckAllOfServicesDatabase = typeof HealthCheckAllOfServicesDatabase[keyof typeof HealthCheckAllOfServicesDatabase];
export const HealthCheckAllOfServicesCache = {
    UP: 'UP',
    DOWN: 'DOWN'
} as const;

export type HealthCheckAllOfServicesCache = typeof HealthCheckAllOfServicesCache[keyof typeof HealthCheckAllOfServicesCache];
export const HealthCheckAllOfServicesMessageQueue = {
    UP: 'UP',
    DOWN: 'DOWN'
} as const;

export type HealthCheckAllOfServicesMessageQueue = typeof HealthCheckAllOfServicesMessageQueue[keyof typeof HealthCheckAllOfServicesMessageQueue];
