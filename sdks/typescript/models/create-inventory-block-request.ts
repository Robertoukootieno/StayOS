...
export interface CreateInventoryBlockRequest {
    'propertyId': string;
    'unitTypeId'?: string;
    'startDate': string;
    'endDate': string;
    'quantity': number;
    'reason': CreateInventoryBlockRequestReason;
    'notes'?: string;
}

export const CreateInventoryBlockRequestReason = {
...
export type CreateInventoryBlockRequestReason = typeof CreateInventoryBlockRequestReason[keyof typeof CreateInventoryBlockRequestReason];
