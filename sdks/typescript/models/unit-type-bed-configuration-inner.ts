...
export interface UnitTypeBedConfigurationInner {
    'bedType'?: UnitTypeBedConfigurationInnerBedType;
    'quantity'?: number;
}

export const UnitTypeBedConfigurationInnerBedType = {
    KING: 'KING',
    QUEEN: 'QUEEN',
    DOUBLE: 'DOUBLE',
    TWIN: 'TWIN',
...
export type UnitTypeBedConfigurationInnerBedType = typeof UnitTypeBedConfigurationInnerBedType[keyof typeof UnitTypeBedConfigurationInnerBedType];
