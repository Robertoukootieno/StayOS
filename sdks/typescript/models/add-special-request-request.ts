...
export interface AddSpecialRequestRequest {
    'request': string;
    'category'?: AddSpecialRequestRequestCategory;
}

export const AddSpecialRequestRequestCategory = {
...
export type AddSpecialRequestRequestCategory = typeof AddSpecialRequestRequestCategory[keyof typeof AddSpecialRequestRequestCategory];
