...
// @ts-ignore
import type { InventoryUnitAllOfLinks } from './inventory-unit-all-of-links';
// May contain unused imports in some cases
// @ts-ignore
...
export interface InventoryUnit {
    ...
    'unitType'?: Model0;
    'floor'?: number;
    'physicalStatus'?: InventoryUnitPhysicalStatus;
    'operationalStatus'?: InventoryUnitOperationalStatus;
...
export const InventoryUnitPhysicalStatus = {
...
export type InventoryUnitPhysicalStatus = typeof InventoryUnitPhysicalStatus[keyof typeof InventoryUnitPhysicalStatus];
export const InventoryUnitOperationalStatus = {
    AVAILABLE: 'AVAILABLE',
    OCCUPIED: 'OCCUPIED',
    BLOCKED: 'BLOCKED',
...
export type InventoryUnitOperationalStatus = typeof InventoryUnitOperationalStatus[keyof typeof InventoryUnitOperationalStatus];
