...
// @ts-ignore
import type { GetAuditLogs200ResponseAllOfDataInner } from './get-audit-logs200-response-all-of-data-inner';
// May contain unused imports in some cases
// @ts-ignore
import type { PaginatedResponse } from './paginated-response';
// May contain unused imports in some cases
// @ts-ignore
import type { PaginatedResponseAllOfLinks } from './paginated-response-all-of-links';
// May contain unused imports in some cases
// @ts-ignore
import type { PaginatedResponseAllOfPagination } from './paginated-response-all-of-pagination';

/**
 * @type GetAuditLogs200Response
 */
export type GetAuditLogs200Response = PaginatedResponse;
