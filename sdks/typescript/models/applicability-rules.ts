...
// @ts-ignore
import type { ApplicabilityRulesAllOfAdvanceBookingWindow } from './applicability-rules-all-of-advance-booking-window';
// May contain unused imports in some cases
// @ts-ignore
import type { ApplicabilityRulesAllOfValidDateRange } from './applicability-rules-all-of-valid-date-range';

export interface ApplicabilityRules {
    'validDateRange'?: ApplicabilityRulesAllOfValidDateRange;
    'daysOfWeek'?: Array<ApplicabilityRulesDaysOfWeek>;
    /**
    ...
    'advanceBookingWindow'?: ApplicabilityRulesAllOfAdvanceBookingWindow;
    /**
...
export const ApplicabilityRulesDaysOfWeek = {
    MONDAY: 'MONDAY',
    TUESDAY: 'TUESDAY',
    WEDNESDAY: 'WEDNESDAY',
    THURSDAY: 'THURSDAY',
...
export type ApplicabilityRulesDaysOfWeek = typeof ApplicabilityRulesDaysOfWeek[keyof typeof ApplicabilityRulesDaysOfWeek];
