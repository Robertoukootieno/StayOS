...
// May contain unused imports in some cases
// @ts-ignore
import type { RateStrategy } from './rate-strategy';
// May contain unused imports in some cases
// @ts-ignore
import type { SearchAvailability200ResponseResultsInnerPriceBreakdownInner } from './search-availability200-response-results-inner-price-breakdown-inner';
// May contain unused imports in some cases
// @ts-ignore
import type { UnitType } from './unit-type';

export interface SearchAvailability200ResponseResultsInner {
    'inventoryUnitId'?: string;
    'unitType'?: UnitType;
    'property'?: Property;
    'rateStrategy'?: RateStrategy;
    'totalPrice'?: Money;
    'priceBreakdown'?: Array<SearchAvailability200ResponseResultsInnerPriceBreakdownInner>;
    'availability'?: SearchAvailability200ResponseResultsInnerAvailability;
    'cancellationPolicy'?: CancellationPolicy;
}

export const SearchAvailability200ResponseResultsInnerAvailability = {
    AVAILABLE: 'AVAILABLE',
    LIMITED: 'LIMITED',
    LAST_ROOM: 'LAST_ROOM'
} as const;

export type SearchAvailability200ResponseResultsInnerAvailability = typeof SearchAvailability200ResponseResultsInnerAvailability[keyof typeof SearchAvailability200ResponseResultsInnerAvailability];
