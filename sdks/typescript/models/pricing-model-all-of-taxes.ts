...
export interface PricingModelAllOfTaxes {
    'name'?: string;
    'type'?: PricingModelAllOfTaxesType;
    'rate'?: number;
    /**
...
export const PricingModelAllOfTaxesType = {
    PERCENTAGE: 'PERCENTAGE',
    PER_NIGHT: 'PER_NIGHT',
    PER_PERSON_PER_NIGHT: 'PER_PERSON_PER_NIGHT'
} as const;

export type PricingModelAllOfTaxesType = typeof PricingModelAllOfTaxesType[keyof typeof PricingModelAllOfTaxesType];
