...
export interface HealthCheckServices {
    'database'?: HealthCheckServicesDatabase;
    'cache'?: HealthCheckServicesCache;
    'messageQueue'?: HealthCheckServicesMessageQueue;
}

export const HealthCheckServicesDatabase = {
    UP: 'UP',
    DOWN: 'DOWN'
} as const;

export type HealthCheckServicesDatabase = typeof HealthCheckServicesDatabase[keyof typeof HealthCheckServicesDatabase];
export const HealthCheckServicesCache = {
    UP: 'UP',
    DOWN: 'DOWN'
} as const;

export type HealthCheckServicesCache = typeof HealthCheckServicesCache[keyof typeof HealthCheckServicesCache];
export const HealthCheckServicesMessageQueue = {
    UP: 'UP',
    DOWN: 'DOWN'
} as const;

export type HealthCheckServicesMessageQueue = typeof HealthCheckServicesMessageQueue[keyof typeof HealthCheckServicesMessageQueue];
