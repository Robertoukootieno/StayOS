...
// May contain unused imports in some cases
// @ts-ignore
import type { PropertyPoliciesAllOfChildPolicy } from './property-policies-all-of-child-policy';
// May contain unused imports in some cases
// @ts-ignore
import type { PropertyPoliciesAllOfPetPolicy } from './property-policies-all-of-pet-policy';
...
export interface PropertyPolicies {
     ...
     */
    'checkOutTime'?: string;
    'lateCheckoutFee'?: Model0;
    'cancellationPolicy'?: Model0;
    'childPolicy'?: PropertyPoliciesAllOfChildPolicy;
    'petPolicy'?: PropertyPoliciesAllOfPetPolicy;
    'smokingPolicy'?: PropertyPoliciesSmokingPolicy;
}

export const PropertyPoliciesSmokingPolicy = {
    NON_SMOKING: 'NON_SMOKING',
    SMOKING_ALLOWED: 'SMOKING_ALLOWED',
    DESIGNATED_AREAS: 'DESIGNATED_AREAS'
} as const;

export type PropertyPoliciesSmokingPolicy = typeof PropertyPoliciesSmokingPolicy[keyof typeof PropertyPoliciesSmokingPolicy];
