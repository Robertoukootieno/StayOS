...
export interface PropertyPoliciesAllOfPetPolicy {
    'petsAllowed'?: boolean;
    'petFee'?: Model0;
    'petTypes'?: Array<PropertyPoliciesAllOfPetPolicyPetTypes>;
}

export const PropertyPoliciesAllOfPetPolicyPetTypes = {
    DOG: 'DOG',
    CAT: 'CAT',
    BIRD: 'BIRD',
    OTHER: 'OTHER'
...
export type PropertyPoliciesAllOfPetPolicyPetTypes = typeof PropertyPoliciesAllOfPetPolicyPetTypes[keyof typeof PropertyPoliciesAllOfPetPolicyPetTypes];
