...
export interface KeyCard {
     ...
     */
    'expiresAt'?: string;
    'accessLevel'?: KeyCardAccessLevel;
}

export const KeyCardStatus = {
    ACTIVE: 'ACTIVE',
...
export type KeyCardStatus = typeof KeyCardStatus[keyof typeof KeyCardStatus];
export const KeyCardAccessLevel = {
    ROOM_ONLY: 'ROOM_ONLY',
    ROOM_AND_AMENITIES: 'ROOM_AND_AMENITIES',
    FULL_ACCESS: 'FULL_ACCESS'
} as const;

export type KeyCardAccessLevel = typeof KeyCardAccessLevel[keyof typeof KeyCardAccessLevel];
