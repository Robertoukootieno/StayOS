...
export interface PricingModelAllOfSeasonalAdjustments {
    'name'?: string;
    'startDate'?: string;
    'endDate'?: string;
    'adjustmentType'?: PricingModelAllOfSeasonalAdjustmentsAdjustmentType;
    'adjustmentValue'?: number;
    'description'?: string;
}

export const PricingModelAllOfSeasonalAdjustmentsAdjustmentType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT'
} as const;

export type PricingModelAllOfSeasonalAdjustmentsAdjustmentType = typeof PricingModelAllOfSeasonalAdjustmentsAdjustmentType[keyof typeof PricingModelAllOfSeasonalAdjustmentsAdjustmentType];
