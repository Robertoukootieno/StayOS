...
export interface GetChannelSyncStatus200Response {
    'lastSync'?: string;
    'status'?: GetChannelSyncStatus200ResponseStatus;
    'errors'?: Array<string>;
}

export const GetChannelSyncStatus200ResponseStatus = {
    SYNCED: 'SYNCED',
    SYNCING: 'SYNCING',
    ERROR: 'ERROR',
...
export type GetChannelSyncStatus200ResponseStatus = typeof GetChannelSyncStatus200ResponseStatus[keyof typeof GetChannelSyncStatus200ResponseStatus];
