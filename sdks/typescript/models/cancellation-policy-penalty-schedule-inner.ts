...
export interface CancellationPolicyPenaltyScheduleInner {
    'hoursBeforeCheckIn'?: number;
    'penaltyType'?: CancellationPolicyPenaltyScheduleInnerPenaltyType;
    'penaltyValue'?: number;
    'description'?: string;
}

export const CancellationPolicyPenaltyScheduleInnerPenaltyType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT',
    NIGHTS: 'NIGHTS'
} as const;

export type CancellationPolicyPenaltyScheduleInnerPenaltyType = typeof CancellationPolicyPenaltyScheduleInnerPenaltyType[keyof typeof CancellationPolicyPenaltyScheduleInnerPenaltyType];
