...
// @ts-ignore
import type { ReceivePurchaseOrderRequestReceivedItemsInner } from './receive-purchase-order-request-received-items-inner';

export interface ReceivePurchaseOrderRequest {
    'receivedItems'?: Array<ReceivePurchaseOrderRequestReceivedItemsInner>;
    'receivedBy'?: string;
    'notes'?: string;
}
