...
// May contain unused imports in some cases
// @ts-ignore
import type { SearchAvailability200ResponseResultsInnerPriceBreakdownInnerTaxesInner } from './search-availability200-response-results-inner-price-breakdown-inner-taxes-inner';

export interface SearchAvailability200ResponseResultsInnerPriceBreakdownInner {
    'date'?: string;
    'nightlyRate'?: Money;
