...
export interface ChannelDistributionMarkup {
    'type'?: ChannelDistributionMarkupType;
    'value'?: number;
}

export const ChannelDistributionMarkupType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT'
} as const;

export type ChannelDistributionMarkupType = typeof ChannelDistributionMarkupType[keyof typeof ChannelDistributionMarkupType];
