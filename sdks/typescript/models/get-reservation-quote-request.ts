...
// @ts-ignore
import type { GetReservationQuoteRequestGuestCount } from './get-reservation-quote-request-guest-count';

export interface GetReservationQuoteRequest {
    'propertyId': string;
    'unitTypeId': string;
    'checkInDate': string;
    'checkOutDate': string;
    'guestCount': GetReservationQuoteRequestGuestCount;
