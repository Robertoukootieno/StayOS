...
// @ts-ignore
import type { CancellationPolicyAllOfPenaltySchedule } from './cancellation-policy-all-of-penalty-schedule';

export interface CancellationPolicy {
    'refundability': CancellationPolicyRefundability;
    /**
     * Hours before check-in for free cancellation
     */
    'freeCancellationHours'?: number;
    'penaltySchedule'?: Array<CancellationPolicyAllOfPenaltySchedule>;
}

export const CancellationPolicyRefundability = {
    FULLY_REFUNDABLE: 'FULLY_REFUNDABLE',
    PARTIALLY_REFUNDABLE: 'PARTIALLY_REFUNDABLE',
    NON_REFUNDABLE: 'NON_REFUNDABLE'
} as const;

export type CancellationPolicyRefundability = typeof CancellationPolicyRefundability[keyof typeof CancellationPolicyRefundability];
