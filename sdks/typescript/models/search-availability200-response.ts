...
// @ts-ignore
import type { SearchAvailability200ResponseMetadata } from './search-availability200-response-metadata';
// May contain unused imports in some cases
// @ts-ignore
import type { SearchAvailability200ResponseResultsInner } from './search-availability200-response-results-inner';

export interface SearchAvailability200Response {
    /**
