...
// @ts-ignore
import type { StaffShiftAllOfBreaks } from './staff-shift-all-of-breaks';
...
export type StaffShiftRole = typeof StaffShiftRole[keyof typeof StaffShiftRole];
