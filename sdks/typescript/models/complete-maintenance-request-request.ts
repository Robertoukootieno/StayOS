...
// @ts-ignore
import type { CompleteMaintenanceRequestRequestPartsUsedInner } from './complete-maintenance-request-request-parts-used-inner';

export interface CompleteMaintenanceRequestRequest {
    'notes'?: string;
    'partsUsed'?: Array<CompleteMaintenanceRequestRequestPartsUsedInner>;
}
