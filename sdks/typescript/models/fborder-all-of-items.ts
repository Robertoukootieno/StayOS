...
export interface FBOrderAllOfItems {
    'menuItemId'?: string;
    'name'?: string;
    'quantity'?: number;
    'unitPrice'?: Model0;
    'specialInstructions'?: string;
    'status'?: FBOrderAllOfItemsStatus;
}

export const FBOrderAllOfItemsStatus = {
    PENDING: 'PENDING',
    PREPARING: 'PREPARING',
    READY: 'READY',
    SERVED: 'SERVED'
...
export type FBOrderAllOfItemsStatus = typeof FBOrderAllOfItemsStatus[keyof typeof FBOrderAllOfItemsStatus];
