...
export interface ChannelDistributionCommission {
    'type'?: ChannelDistributionCommissionType;
    'value'?: number;
    'paidBy'?: ChannelDistributionCommissionPaidBy;
}

export const ChannelDistributionCommissionType = {
    PERCENTAGE: 'PERCENTAGE',
    FIXED_AMOUNT: 'FIXED_AMOUNT'
} as const;

export type ChannelDistributionCommissionType = typeof ChannelDistributionCommissionType[keyof typeof ChannelDistributionCommissionType];
export const ChannelDistributionCommissionPaidBy = {
    PROPERTY: 'PROPERTY',
    GUEST: 'GUEST'
} as const;

export type ChannelDistributionCommissionPaidBy = typeof ChannelDistributionCommissionPaidBy[keyof typeof ChannelDistributionCommissionPaidBy];
